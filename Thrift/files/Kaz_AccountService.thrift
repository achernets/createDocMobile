...
service AccountService {
    ...
    Kaz_types.Account createOrUpdateAccount(1: common.AuthTokenBase64 token, 2: Kaz_types.Account account, 3: string securityKey, 4: string password) throws (1: ex.PreconditionException validError, 2: ex.ServerException error);
    ...
    **/
    ...
    /** Создать/изменить аккаунт */
    Kaz_types.Account createOrUpdateAccountExtended(1: common.AuthTokenBase64 token, 2: Kaz_types.Account account, 3: string securityKey, 4: string password, 5: list<common.UserOrGroup> usersToAdd, 6: Kaz_UserManagementService.AccountUserDelegates delegates) throws (1: ex.PreconditionException validError, 2: ex.ServerException error);
