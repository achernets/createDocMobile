/** npm number-to-cyrillic */
/**
 * Convert number to string
 * @param {String|Number} number
 * @param {Object} options
 */
const numberToString = function (number, options) {
  /**
   * Conversion options
   * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
   ...
   * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
   * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
   * @param {boolean} customDecimalNameCasesForEnglish * * * * *
   * @default false  * * * * * * * * * * * * * * * * * * * * * *
   * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
   * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
   * @param {boolean} customCurrencyPrefixForEnglish * * * * * *
   * @default '' * * * * * * * * * * * * * * * * * * * * * * * *
   * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
   */
  var defaultOptions = {
    ...
    currency: 'uah',
    language: 'ua',
    customDecimalNameCasesForEnglish: false,
  ...
  if (options) {
    ...
    if (typeof options.customDecimalNameCasesForEnglish === 'boolean') {
      defaultOptions.customDecimalNameCasesForEnglish = options.customDecimalNameCasesForEnglish;
    }

    if (typeof options.customCurrencyPrefixForEnglish === 'string') {
      defaultOptions.customCurrencyPrefixForEnglish = options.customCurrencyPrefixForEnglish;
    }
  }
  ...
  var textValues = {
    ua: {
      ...
      currency: {
        ...
        rub: {
          currencyNameCases: ['рубль', 'рублі', 'рублів'],
          decimalNameCases: ['копійка', 'копійки', 'копійок'],
          currencyValueCase: 1,
          decimalValueCase: 0,
          shortName: 'руб.'
    ...
    en: {
      ...
      currency: {
        ...
        rub: {
          currencyNameCases: ['ruble', 'rubles', 'rubles'],
          decimalNameCases: ['cent', 'cents', 'cents'],
          currencyValueCase: 1,
          decimalValueCase: 0,
          shortName: 'RUB'
  ...
  if (defaultOptions.customDecimalNameCasesForEnglish) {
    textValues.en.currency.uah.decimalNameCases = ['kopek', 'kopeks', 'kopeks'];
    textValues.en.currency.rub.decimalNameCases = ['kopek', 'kopeks', 'kopeks'];
  }

  if (defaultOptions.customCurrencyPrefixForEnglish) {
    textValues.en.currency.usd.currencyNameCases = [
      defaultOptions.customCurrencyPrefixForEnglish + ' dollar',
      defaultOptions.customCurrencyPrefixForEnglish + ' dollars',
      defaultOptions.customCurrencyPrefixForEnglish + ' dollars'
    ];
  }
   ...
   */
  if (defaultOptions.language === 'en') {
    finalResult = finalResult.split(' - ').join('-');
  ...
  return {
    ...
    // Return calculated shortName for UA and RU languages for USD currency
    shortName: (defaultOptions.language === 'ua' || defaultOptions.language === 'ru') && defaultOptions.currency === 'usd'
      ? currencyValues.currencyNameCases[currencyTextCase]
      : currencyValues.shortName
  };
};
