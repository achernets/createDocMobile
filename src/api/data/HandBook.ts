...
export interface IHandBookArgs {
    ...
    hbContentAdmins?: Array<__ROOT_NAMESPACE__.UserOrGroup>;
    allowEdit?: boolean;
    thriftURL?: string;
    copyValue?: boolean;
...
export class HandBook {
    ...
    public hbContentAdmins?: Array<__ROOT_NAMESPACE__.UserOrGroup>;
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.hbContentAdmins != null) {
            ...
            this.hbContentAdmins.forEach((value_3: __ROOT_NAMESPACE__.UserOrGroup): void => {
