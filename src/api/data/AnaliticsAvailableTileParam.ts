...
export interface IAnaliticsAvailableTileParamArgs {
    ...
    name?: string;
    value?: string;
    items?: Array<__ROOT_NAMESPACE__.FilterItem>;
}
export class AnaliticsAvailableTileParam {
    ...
    public name?: string;
    public value?: string;
    public items?: Array<__ROOT_NAMESPACE__.FilterItem>;
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.items != null) {
            ...
            this.items.forEach((value_1: __ROOT_NAMESPACE__.FilterItem): void => {
            ...
            switch (fieldId) {
                ...
                case 5:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_6: Array<__ROOT_NAMESPACE__.FilterItem> = new Array<__ROOT_NAMESPACE__.FilterItem>();
                        const metadata_1: thrift.TList = input.readListBegin();
                        const size_1: number = metadata_1.size;
                        for (let i_1: number = 0; i_1 < size_1; i_1++) {
                            const value_7: __ROOT_NAMESPACE__.FilterItem = __ROOT_NAMESPACE__.FilterItem.read(input);
