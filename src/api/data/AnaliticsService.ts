    ...
    public static read(input: thrift.TProtocol): ChangeAnaliticsPreparedAvailableTileResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_24: __ROOT_NAMESPACE__.PreconditionException = __ROOT_NAMESPACE__.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_25: __ROOT_NAMESPACE__.ServerException = __ROOT_NAMESPACE__.ServerException.read(input);
    ...
    public static read(input: thrift.TProtocol): GetAnaliticsDashboardPageResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_27: __ROOT_NAMESPACE__.PreconditionException = __ROOT_NAMESPACE__.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_28: __ROOT_NAMESPACE__.ServerException = __ROOT_NAMESPACE__.ServerException.read(input);
    ...
    public static read(input: thrift.TProtocol): ChangeAnaliticsDashboardResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_30: __ROOT_NAMESPACE__.PreconditionException = __ROOT_NAMESPACE__.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_31: __ROOT_NAMESPACE__.ServerException = __ROOT_NAMESPACE__.ServerException.read(input);
...
export class Client {
    ...
    public getAnaliticsAvailableTileList(token: string, filter: __ROOT_NAMESPACE__.KazFilter): Promise<Array<AnaliticsAvailableTile.AnaliticsAvailableTile>> {
    ...
    public getAnaliticsPreparedAvailableTilePage(token: string, filter: __ROOT_NAMESPACE__.KazFilter): Promise<AnaliticsPreparedAvailableTilePage.AnaliticsPreparedAvailableTilePage> {
        const requestId: number = this.incrementSeqId();
    ...
    public getAnaliticsDashboardPage(token: string, filter: __ROOT_NAMESPACE__.KazFilter): Promise<AnaliticsDashboardPage.AnaliticsDashboardPage> {
        const requestId: number = this.incrementSeqId();
    ...
    public getUserAnaliticsDashboardList(token: string, filter: __ROOT_NAMESPACE__.KazFilter): Promise<Array<AnaliticsDashboard.AnaliticsDashboard>> {
        const requestId: number = this.incrementSeqId();
    ...
    public send_getAnaliticsAvailableTileList(token: string, filter: __ROOT_NAMESPACE__.KazFilter, requestId: number): void {
    ...
    public send_getAnaliticsPreparedAvailableTilePage(token: string, filter: __ROOT_NAMESPACE__.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_getAnaliticsDashboardPage(token: string, filter: __ROOT_NAMESPACE__.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_getUserAnaliticsDashboardList(token: string, filter: __ROOT_NAMESPACE__.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
...
export interface IHandler {
    getAnaliticsAvailableTileList(token: string, filter: __ROOT_NAMESPACE__.KazFilter): Array<AnaliticsAvailableTile.AnaliticsAvailableTile> | Promise<Array<AnaliticsAvailableTile.AnaliticsAvailableTile>>;
    getAnaliticsPreparedAvailableTilePage(token: string, filter: __ROOT_NAMESPACE__.KazFilter): AnaliticsPreparedAvailableTilePage.AnaliticsPreparedAvailableTilePage | Promise<AnaliticsPreparedAvailableTilePage.AnaliticsPreparedAvailableTilePage>;
    ...
    getAnaliticsDashboardPage(token: string, filter: __ROOT_NAMESPACE__.KazFilter): AnaliticsDashboardPage.AnaliticsDashboardPage | Promise<AnaliticsDashboardPage.AnaliticsDashboardPage>;
    ...
    getUserAnaliticsDashboardList(token: string, filter: __ROOT_NAMESPACE__.KazFilter): Array<AnaliticsDashboard.AnaliticsDashboard> | Promise<Array<AnaliticsDashboard.AnaliticsDashboard>>;
}
