...
export interface IVoteAnswerParamsArgs {
    ...
    legitimacy?: boolean;
    commentRequirement?: __ROOT_NAMESPACE__.DocPatternStageRequirement;
}
export class VoteAnswerParams {
    ...
    public commentRequirement?: __ROOT_NAMESPACE__.DocPatternStageRequirement;
    ...
    public static read(input: thrift.TProtocol): VoteAnswerParams {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 5:
                    if (fieldType === thrift.Thrift.Type.I32) {
                        const value_5: __ROOT_NAMESPACE__.DocPatternStageRequirement = input.readI32();
