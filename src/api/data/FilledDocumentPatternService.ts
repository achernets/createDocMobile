...
export interface ICreateAndCheckFilledDocumentPatternArgsArgs {
    token: string;
    freezeDocumentPattern: __ROOT_NAMESPACE__.FreezeDocumentPattern;
    stages: Array<__ROOT_NAMESPACE__.DocumentPatternStage>;
    toUpdate: Array<__ROOT_NAMESPACE__.PatternProcessRole>;
}
export class CreateAndCheckFilledDocumentPatternArgs {
    public token: string;
    public freezeDocumentPattern: __ROOT_NAMESPACE__.FreezeDocumentPattern;
    public stages: Array<__ROOT_NAMESPACE__.DocumentPatternStage>;
    public toUpdate: Array<__ROOT_NAMESPACE__.PatternProcessRole>;
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.stages != null) {
            ...
            this.stages.forEach((value_3: __ROOT_NAMESPACE__.DocumentPatternStage): void => {
        ...
        if (this.toUpdate != null) {
            ...
            this.toUpdate.forEach((value_4: __ROOT_NAMESPACE__.PatternProcessRole): void => {
            ...
            switch (fieldId) {
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_6: __ROOT_NAMESPACE__.FreezeDocumentPattern = __ROOT_NAMESPACE__.FreezeDocumentPattern.read(input);
                ...
                case 3:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_7: Array<__ROOT_NAMESPACE__.DocumentPatternStage> = new Array<__ROOT_NAMESPACE__.DocumentPatternStage>();
                        const metadata_1: thrift.TList = input.readListBegin();
                        const size_1: number = metadata_1.size;
                        for (let i_1: number = 0; i_1 < size_1; i_1++) {
                            const value_8: __ROOT_NAMESPACE__.DocumentPatternStage = __ROOT_NAMESPACE__.DocumentPatternStage.read(input);
                ...
                case 4:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_9: Array<__ROOT_NAMESPACE__.PatternProcessRole> = new Array<__ROOT_NAMESPACE__.PatternProcessRole>();
                        const metadata_2: thrift.TList = input.readListBegin();
                        const size_2: number = metadata_2.size;
                        for (let i_2: number = 0; i_2 < size_2; i_2++) {
                            const value_10: __ROOT_NAMESPACE__.PatternProcessRole = __ROOT_NAMESPACE__.PatternProcessRole.read(input);
...
export interface IGetAllFilledDocumentPatternStagesArgsArgs {
    ...
    selector: __ROOT_NAMESPACE__.RuleSelector;
}
export class GetAllFilledDocumentPatternStagesArgs {
    ...
    public selector: __ROOT_NAMESPACE__.RuleSelector;
            ...
            switch (fieldId) {
                ...
                case 4:
                    if (fieldType === thrift.Thrift.Type.I32) {
                        const value_16: __ROOT_NAMESPACE__.RuleSelector = input.readI32();
    ...
    public static read(input: thrift.TProtocol): GetFilledDocumentPatternStageArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 4:
                    if (fieldType === thrift.Thrift.Type.I32) {
                        const value_20: __ROOT_NAMESPACE__.RuleSelector = input.readI32();
                ...
                case 5:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_21: __ROOT_NAMESPACE__.DocumentAccessPolicy = __ROOT_NAMESPACE__.DocumentAccessPolicy.read(input);
    ...
    public static read(input: thrift.TProtocol): GetSetDecisionInfoArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 4:
                    if (fieldType === thrift.Thrift.Type.I32) {
                        const value_25: __ROOT_NAMESPACE__.RuleSelector = input.readI32();
                ...
                case 5:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_26: __ROOT_NAMESPACE__.DocumentAccessPolicy = __ROOT_NAMESPACE__.DocumentAccessPolicy.read(input);
...
export interface IUpdateFilledDocumentPatternStageListArgsArgs {
    token: string;
    fillDocPatternId: string;
    documentPatternStage: Array<__ROOT_NAMESPACE__.DocumentPatternStage>;
    enEditCurrent: boolean;
}
export class UpdateFilledDocumentPatternStageListArgs {
    public token: string;
    public fillDocPatternId: string;
    public documentPatternStage: Array<__ROOT_NAMESPACE__.DocumentPatternStage>;
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.documentPatternStage != null) {
            ...
            this.documentPatternStage.forEach((value_30: __ROOT_NAMESPACE__.DocumentPatternStage): void => {
    ...
    public static read(input: thrift.TProtocol): UpdateFilledDocumentPatternStageListArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 3:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_33: Array<__ROOT_NAMESPACE__.DocumentPatternStage> = new Array<__ROOT_NAMESPACE__.DocumentPatternStage>();
                        const metadata_3: thrift.TList = input.readListBegin();
                        const size_3: number = metadata_3.size;
                        for (let i_3: number = 0; i_3 < size_3; i_3++) {
                            const value_34: __ROOT_NAMESPACE__.DocumentPatternStage = __ROOT_NAMESPACE__.DocumentPatternStage.read(input);
...
export class UpdateFilledDocumentPatternStagesLinkArgs {
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.links != null) {
            ...
            this.links.forEach((value_36: __ROOT_NAMESPACE__.DocumentPatternStagesLink): void => {
    ...
    public static read(input: thrift.TProtocol): UpdateFilledDocumentPatternStagesLinkArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 3:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_39: Array<__ROOT_NAMESPACE__.DocumentPatternStagesLink> = new Array<__ROOT_NAMESPACE__.DocumentPatternStagesLink>();
                        const metadata_4: thrift.TList = input.readListBegin();
                        const size_4: number = metadata_4.size;
                        for (let i_4: number = 0; i_4 < size_4; i_4++) {
                            const value_40: __ROOT_NAMESPACE__.DocumentPatternStagesLink = __ROOT_NAMESPACE__.DocumentPatternStagesLink.read(input);
    ...
    public static read(input: thrift.TProtocol): GetAllFilledDocumentPatternStagesLinkArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 3:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_43: __ROOT_NAMESPACE__.KazFilter = __ROOT_NAMESPACE__.KazFilter.read(input);
...
export class ChangeFilledDocumentPatternStagesArgs {
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.stages != null) {
            output.writeFieldBegin("stages", thrift.Thrift.Type.LIST, 3);
            output.writeListBegin(thrift.Thrift.Type.STRUCT, this.stages.length);
            this.stages.forEach((value_54: __ROOT_NAMESPACE__.DocumentPatternStage): void => {
    ...
    public static read(input: thrift.TProtocol): ChangeFilledDocumentPatternStagesArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 3:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_57: Array<__ROOT_NAMESPACE__.DocumentPatternStage> = new Array<__ROOT_NAMESPACE__.DocumentPatternStage>();
                        const metadata_6: thrift.TList = input.readListBegin();
                        const size_6: number = metadata_6.size;
                        for (let i_6: number = 0; i_6 < size_6; i_6++) {
                            const value_58: __ROOT_NAMESPACE__.DocumentPatternStage = __ROOT_NAMESPACE__.DocumentPatternStage.read(input);
    ...
    public static read(input: thrift.TProtocol): CheckFilledDocumentPatternArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 3:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_61: __ROOT_NAMESPACE__.KazFilter = __ROOT_NAMESPACE__.KazFilter.read(input);
    ...
    public static read(input: thrift.TProtocol): GetFreezeProcessRolesArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 3:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_64: __ROOT_NAMESPACE__.DocumentAccessPolicy = __ROOT_NAMESPACE__.DocumentAccessPolicy.read(input);
                ...
                case 4:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_65: __ROOT_NAMESPACE__.KazFilter = __ROOT_NAMESPACE__.KazFilter.read(input);
...
export interface IChangeFreezeProcessRolesArgsArgs {
    ...
    docId: string;
    policy: __ROOT_NAMESPACE__.DocumentAccessPolicy;
    patternRolesToAdd: Array<__ROOT_NAMESPACE__.PatternProcessRole>;
...
export class ChangeFreezeProcessRolesArgs {
    ...
    public docId: string;
    public policy: __ROOT_NAMESPACE__.DocumentAccessPolicy;
    public patternRolesToAdd: Array<__ROOT_NAMESPACE__.PatternProcessRole>;
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.patternRolesToAdd != null) {
            ...
            this.patternRolesToAdd.forEach((value_66: __ROOT_NAMESPACE__.PatternProcessRole): void => {
    ...
    public static read(input: thrift.TProtocol): ChangeFreezeProcessRolesArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 3:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_70: __ROOT_NAMESPACE__.DocumentAccessPolicy = __ROOT_NAMESPACE__.DocumentAccessPolicy.read(input);
                ...
                case 4:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_71: Array<__ROOT_NAMESPACE__.PatternProcessRole> = new Array<__ROOT_NAMESPACE__.PatternProcessRole>();
                        const metadata_7: thrift.TList = input.readListBegin();
                        const size_7: number = metadata_7.size;
                        for (let i_7: number = 0; i_7 < size_7; i_7++) {
                            const value_72: __ROOT_NAMESPACE__.PatternProcessRole = __ROOT_NAMESPACE__.PatternProcessRole.read(input);
    ...
    public static read(input: thrift.TProtocol): GetFreezeProcessVariablesArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 3:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_77: __ROOT_NAMESPACE__.DocumentAccessPolicy = __ROOT_NAMESPACE__.DocumentAccessPolicy.read(input);
...
export class ChangeFreezePatternVariablesArgs {
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.patternVariablesToAdd != null) {
            ...
            this.patternVariablesToAdd.forEach((value_79: __ROOT_NAMESPACE__.PatternVariable): void => {
    ...
    public static read(input: thrift.TProtocol): ChangeFreezePatternVariablesArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 3:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_83: __ROOT_NAMESPACE__.DocumentAccessPolicy = __ROOT_NAMESPACE__.DocumentAccessPolicy.read(input);
                ...
                case 4:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_84: Array<__ROOT_NAMESPACE__.PatternVariable> = new Array<__ROOT_NAMESPACE__.PatternVariable>();
                        const metadata_9: thrift.TList = input.readListBegin();
                        const size_9: number = metadata_9.size;
                        for (let i_9: number = 0; i_9 < size_9; i_9++) {
                            const value_85: __ROOT_NAMESPACE__.PatternVariable = __ROOT_NAMESPACE__.PatternVariable.read(input);
...
export interface IGetContentItemsArgsArgs {
    token: string;
    docId: string;
    policy: __ROOT_NAMESPACE__.DocumentAccessPolicy;
    filter: __ROOT_NAMESPACE__.KazFilter;
}
export class GetContentItemsArgs {
    public token: string;
    public docId: string;
    public policy: __ROOT_NAMESPACE__.DocumentAccessPolicy;
    public filter: __ROOT_NAMESPACE__.KazFilter;
    constructor(args: IGetContentItemsArgsArgs) {
        if (args != null && args.token != null) {
            this.token = args.token;
        }
        else {
    ...
    public write(output: thrift.TProtocol): void {
        output.writeStructBegin("GetContentItemsArgs");
        if (this.token != null) {
            output.writeFieldBegin("token", thrift.Thrift.Type.STRING, 1);
            output.writeString(this.token);
            output.writeFieldEnd();
    ...
    public static read(input: thrift.TProtocol): GetContentItemsArgs {
        input.readStructBegin();
        let _args: any = {};
        while (true) {
            const ret: thrift.TField = input.readFieldBegin();
            ...
            switch (fieldId) {
                ...
                case 3:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_90: __ROOT_NAMESPACE__.DocumentAccessPolicy = __ROOT_NAMESPACE__.DocumentAccessPolicy.read(input);
                        _args.policy = value_90;
                    }
                    else {
                        input.skip(fieldType);
                    }
                ...
                case 4:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_91: __ROOT_NAMESPACE__.KazFilter = __ROOT_NAMESPACE__.KazFilter.read(input);
                        _args.filter = value_91;
                    }
                    else {
                        input.skip(fieldType);
                    }
        ...
        input.readStructEnd();
        if (_args.token !== undefined && _args.docId !== undefined && _args.policy !== undefined && _args.filter !== undefined) {
            return new GetContentItemsArgs(_args);
        }
        else {
            throw new thrift.Thrift.TProtocolException(thrift.Thrift.TProtocolExceptionType.UNKNOWN, "Unable to read GetContentItemsArgs from input");
        }
    }
}
export interface IGetFilledDocumentPatternResultArgs {
    success?: __ROOT_NAMESPACE__.FreezeDocumentPattern;
...
export class GetFilledDocumentPatternResult {
    public success?: __ROOT_NAMESPACE__.FreezeDocumentPattern;
    ...
    public static read(input: thrift.TProtocol): GetFilledDocumentPatternResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_92: __ROOT_NAMESPACE__.FreezeDocumentPattern = __ROOT_NAMESPACE__.FreezeDocumentPattern.read(input);
    ...
    public static read(input: thrift.TProtocol): CreateAndCheckFilledDocumentPatternResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_95: FreezePatternValidation.FreezePatternValidation = FreezePatternValidation.FreezePatternValidation.read(input);
...
export class GetAllFilledDocumentPatternStagesResult {
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.success != null) {
            ...
            this.success.forEach((value_101: __ROOT_NAMESPACE__.DocumentPatternStage): void => {
                value_101.write(output);
            });
            output.writeListEnd();
            output.writeFieldEnd();
        }
    ...
    public static read(input: thrift.TProtocol): GetAllFilledDocumentPatternStagesResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_102: Array<__ROOT_NAMESPACE__.DocumentPatternStage> = new Array<__ROOT_NAMESPACE__.DocumentPatternStage>();
                        ...
                        for (let i_11: number = 0; i_11 < size_11; i_11++) {
                            const value_103: __ROOT_NAMESPACE__.DocumentPatternStage = __ROOT_NAMESPACE__.DocumentPatternStage.read(input);
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_104: __ROOT_NAMESPACE__.PreconditionException = __ROOT_NAMESPACE__.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_105: __ROOT_NAMESPACE__.ServerException = __ROOT_NAMESPACE__.ServerException.read(input);
    ...
    public static read(input: thrift.TProtocol): GetFilledDocumentPatternStageResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_106: __ROOT_NAMESPACE__.DocumentPatternStage = __ROOT_NAMESPACE__.DocumentPatternStage.read(input);
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_107: __ROOT_NAMESPACE__.PreconditionException = __ROOT_NAMESPACE__.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_108: __ROOT_NAMESPACE__.ServerException = __ROOT_NAMESPACE__.ServerException.read(input);
...
export interface IGetSetDecisionInfoResultArgs {
    success?: __ROOT_NAMESPACE__.DesicionInfo;
    validError?: __ROOT_NAMESPACE__.PreconditionException;
    error?: __ROOT_NAMESPACE__.ServerException;
}
export class GetSetDecisionInfoResult {
    public success?: __ROOT_NAMESPACE__.DesicionInfo;
    public validError?: __ROOT_NAMESPACE__.PreconditionException;
    public error?: __ROOT_NAMESPACE__.ServerException;
    ...
    public static read(input: thrift.TProtocol): GetSetDecisionInfoResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_109: __ROOT_NAMESPACE__.DesicionInfo = __ROOT_NAMESPACE__.DesicionInfo.read(input);
...
export class GetAllChildFilledDocumentPatternStagesResult {
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.success != null) {
            output.writeFieldBegin("success", thrift.Thrift.Type.LIST, 0);
            output.writeListBegin(thrift.Thrift.Type.STRUCT, this.success.length);
            this.success.forEach((value_112: __ROOT_NAMESPACE__.DocumentPatternStage): void => {
    ...
    public static read(input: thrift.TProtocol): GetAllChildFilledDocumentPatternStagesResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_113: Array<__ROOT_NAMESPACE__.DocumentPatternStage> = new Array<__ROOT_NAMESPACE__.DocumentPatternStage>();
                        ...
                        for (let i_12: number = 0; i_12 < size_12; i_12++) {
                            const value_114: __ROOT_NAMESPACE__.DocumentPatternStage = __ROOT_NAMESPACE__.DocumentPatternStage.read(input);
                            value_113.push(value_114);
                        }
                        input.readListEnd();
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_115: __ROOT_NAMESPACE__.PreconditionException = __ROOT_NAMESPACE__.PreconditionException.read(input);
                        _args.validError = value_115;
                    }
                    else {
                        input.skip(fieldType);
                    }
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_116: __ROOT_NAMESPACE__.ServerException = __ROOT_NAMESPACE__.ServerException.read(input);
                        _args.error = value_116;
                    }
                    else {
                        input.skip(fieldType);
                    }
...
export class UpdateFilledDocumentPatternStageListResult {
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.success != null) {
            output.writeFieldBegin("success", thrift.Thrift.Type.LIST, 0);
            output.writeListBegin(thrift.Thrift.Type.STRUCT, this.success.length);
            this.success.forEach((value_117: __ROOT_NAMESPACE__.DocumentPatternStage): void => {
                value_117.write(output);
            });
            output.writeListEnd();
            output.writeFieldEnd();
        }
    ...
    public static read(input: thrift.TProtocol): UpdateFilledDocumentPatternStageListResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_118: Array<__ROOT_NAMESPACE__.DocumentPatternStage> = new Array<__ROOT_NAMESPACE__.DocumentPatternStage>();
                        ...
                        for (let i_13: number = 0; i_13 < size_13; i_13++) {
                            const value_119: __ROOT_NAMESPACE__.DocumentPatternStage = __ROOT_NAMESPACE__.DocumentPatternStage.read(input);
                            value_118.push(value_119);
                        }
                        input.readListEnd();
...
export class UpdateFilledDocumentPatternStagesLinkResult {
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.success != null) {
            output.writeFieldBegin("success", thrift.Thrift.Type.LIST, 0);
            output.writeListBegin(thrift.Thrift.Type.STRUCT, this.success.length);
            this.success.forEach((value_122: __ROOT_NAMESPACE__.DocumentPatternStagesLink): void => {
    ...
    public static read(input: thrift.TProtocol): UpdateFilledDocumentPatternStagesLinkResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_123: Array<__ROOT_NAMESPACE__.DocumentPatternStagesLink> = new Array<__ROOT_NAMESPACE__.DocumentPatternStagesLink>();
                        ...
                        for (let i_14: number = 0; i_14 < size_14; i_14++) {
                            const value_124: __ROOT_NAMESPACE__.DocumentPatternStagesLink = __ROOT_NAMESPACE__.DocumentPatternStagesLink.read(input);
...
export class GetAllFilledDocumentPatternStagesLinkResult {
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.success != null) {
            output.writeFieldBegin("success", thrift.Thrift.Type.LIST, 0);
            output.writeListBegin(thrift.Thrift.Type.STRUCT, this.success.length);
            this.success.forEach((value_127: __ROOT_NAMESPACE__.DocumentPatternStagesLink): void => {
    ...
    public static read(input: thrift.TProtocol): GetAllFilledDocumentPatternStagesLinkResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_128: Array<__ROOT_NAMESPACE__.DocumentPatternStagesLink> = new Array<__ROOT_NAMESPACE__.DocumentPatternStagesLink>();
                        ...
                        for (let i_15: number = 0; i_15 < size_15; i_15++) {
                            const value_129: __ROOT_NAMESPACE__.DocumentPatternStagesLink = __ROOT_NAMESPACE__.DocumentPatternStagesLink.read(input);
...
export interface IGetAllFilledDocumentPatternStageExecutorsResultArgs {
    success?: Array<__ROOT_NAMESPACE__.DocumentPatternStagesExecutor>;
    validError?: __ROOT_NAMESPACE__.PreconditionException;
    error?: __ROOT_NAMESPACE__.ServerException;
}
export class GetAllFilledDocumentPatternStageExecutorsResult {
    public success?: Array<__ROOT_NAMESPACE__.DocumentPatternStagesExecutor>;
    public validError?: __ROOT_NAMESPACE__.PreconditionException;
    public error?: __ROOT_NAMESPACE__.ServerException;
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.success != null) {
            output.writeFieldBegin("success", thrift.Thrift.Type.LIST, 0);
            output.writeListBegin(thrift.Thrift.Type.STRUCT, this.success.length);
            this.success.forEach((value_132: __ROOT_NAMESPACE__.DocumentPatternStagesExecutor): void => {
    ...
    public static read(input: thrift.TProtocol): GetAllFilledDocumentPatternStageExecutorsResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_133: Array<__ROOT_NAMESPACE__.DocumentPatternStagesExecutor> = new Array<__ROOT_NAMESPACE__.DocumentPatternStagesExecutor>();
                        ...
                        for (let i_16: number = 0; i_16 < size_16; i_16++) {
                            const value_134: __ROOT_NAMESPACE__.DocumentPatternStagesExecutor = __ROOT_NAMESPACE__.DocumentPatternStagesExecutor.read(input);
                            value_133.push(value_134);
                        }
                        input.readListEnd();
...
export interface IGetFilledDocumentPatternStagesExecutorsResultArgs {
    success?: Map<string, Array<__ROOT_NAMESPACE__.DocumentPatternStagesExecutor>>;
    validError?: __ROOT_NAMESPACE__.PreconditionException;
    error?: __ROOT_NAMESPACE__.ServerException;
}
export class GetFilledDocumentPatternStagesExecutorsResult {
    public success?: Map<string, Array<__ROOT_NAMESPACE__.DocumentPatternStagesExecutor>>;
    public validError?: __ROOT_NAMESPACE__.PreconditionException;
    public error?: __ROOT_NAMESPACE__.ServerException;
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.success != null) {
            ...
            this.success.forEach((value_137: Array<__ROOT_NAMESPACE__.DocumentPatternStagesExecutor>, key_1: string): void => {
                output.writeString(key_1);
                output.writeListBegin(thrift.Thrift.Type.STRUCT, value_137.length);
                value_137.forEach((value_138: __ROOT_NAMESPACE__.DocumentPatternStagesExecutor): void => {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.MAP) {
                        const value_139: Map<string, Array<__ROOT_NAMESPACE__.DocumentPatternStagesExecutor>> = new Map<string, Array<__ROOT_NAMESPACE__.DocumentPatternStagesExecutor>>();
                        ...
                        for (let i_17: number = 0; i_17 < size_17; i_17++) {
                            ...
                            const value_140: Array<__ROOT_NAMESPACE__.DocumentPatternStagesExecutor> = new Array<__ROOT_NAMESPACE__.DocumentPatternStagesExecutor>();
                            ...
                            for (let i_18: number = 0; i_18 < size_18; i_18++) {
                                const value_141: __ROOT_NAMESPACE__.DocumentPatternStagesExecutor = __ROOT_NAMESPACE__.DocumentPatternStagesExecutor.read(input);
                                value_140.push(value_141);
                            }
                            input.readListEnd();
                            value_139.set(key_2, value_140);
                        }
                        input.readMapEnd();
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_142: __ROOT_NAMESPACE__.PreconditionException = __ROOT_NAMESPACE__.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_143: __ROOT_NAMESPACE__.ServerException = __ROOT_NAMESPACE__.ServerException.read(input);
    ...
    public static read(input: thrift.TProtocol): ChangeFilledDocumentPatternStagesResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.BOOL) {
                        const value_144: boolean = input.readBool();
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_145: __ROOT_NAMESPACE__.PreconditionException = __ROOT_NAMESPACE__.PreconditionException.read(input);
                        _args.validError = value_145;
                    }
                    else {
                        input.skip(fieldType);
                    }
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_146: __ROOT_NAMESPACE__.ServerException = __ROOT_NAMESPACE__.ServerException.read(input);
                        _args.error = value_146;
                    }
                    else {
                        input.skip(fieldType);
                    }
...
export class CheckFilledDocumentPatternResult {
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.success != null) {
            output.writeFieldBegin("success", thrift.Thrift.Type.LIST, 0);
            output.writeListBegin(thrift.Thrift.Type.STRUCT, this.success.length);
            this.success.forEach((value_147: __ROOT_NAMESPACE__.PreconditionException): void => {
                value_147.write(output);
            });
            output.writeListEnd();
            output.writeFieldEnd();
        }
    ...
    public static read(input: thrift.TProtocol): CheckFilledDocumentPatternResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_148: Array<__ROOT_NAMESPACE__.PreconditionException> = new Array<__ROOT_NAMESPACE__.PreconditionException>();
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_150: __ROOT_NAMESPACE__.PreconditionException = __ROOT_NAMESPACE__.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_151: __ROOT_NAMESPACE__.ServerException = __ROOT_NAMESPACE__.ServerException.read(input);
...
export class GetFreezeProcessRolesResult {
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.success != null) {
            output.writeFieldBegin("success", thrift.Thrift.Type.LIST, 0);
            output.writeListBegin(thrift.Thrift.Type.STRUCT, this.success.length);
            this.success.forEach((value_152: __ROOT_NAMESPACE__.PatternProcessRole): void => {
    ...
    public static read(input: thrift.TProtocol): GetFreezeProcessRolesResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_153: Array<__ROOT_NAMESPACE__.PatternProcessRole> = new Array<__ROOT_NAMESPACE__.PatternProcessRole>();
                        ...
                        for (let i_20: number = 0; i_20 < size_20; i_20++) {
                            const value_154: __ROOT_NAMESPACE__.PatternProcessRole = __ROOT_NAMESPACE__.PatternProcessRole.read(input);
...
export class ChangeFreezeProcessRolesResult {
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.success != null) {
            output.writeFieldBegin("success", thrift.Thrift.Type.LIST, 0);
            output.writeListBegin(thrift.Thrift.Type.STRUCT, this.success.length);
            this.success.forEach((value_157: __ROOT_NAMESPACE__.PatternProcessRole): void => {
                value_157.write(output);
            });
            output.writeListEnd();
            output.writeFieldEnd();
        }
    ...
    public static read(input: thrift.TProtocol): ChangeFreezeProcessRolesResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_158: Array<__ROOT_NAMESPACE__.PatternProcessRole> = new Array<__ROOT_NAMESPACE__.PatternProcessRole>();
                        ...
                        for (let i_21: number = 0; i_21 < size_21; i_21++) {
                            const value_159: __ROOT_NAMESPACE__.PatternProcessRole = __ROOT_NAMESPACE__.PatternProcessRole.read(input);
                            value_158.push(value_159);
                        }
                        input.readListEnd();
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_160: __ROOT_NAMESPACE__.PreconditionException = __ROOT_NAMESPACE__.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_161: __ROOT_NAMESPACE__.ServerException = __ROOT_NAMESPACE__.ServerException.read(input);
...
export class GetFreezeProcessVariablesResult {
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.success != null) {
            output.writeFieldBegin("success", thrift.Thrift.Type.LIST, 0);
            output.writeListBegin(thrift.Thrift.Type.STRUCT, this.success.length);
            this.success.forEach((value_162: __ROOT_NAMESPACE__.PatternVariable): void => {
                value_162.write(output);
            });
            output.writeListEnd();
            output.writeFieldEnd();
        }
    ...
    public static read(input: thrift.TProtocol): GetFreezeProcessVariablesResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_163: Array<__ROOT_NAMESPACE__.PatternVariable> = new Array<__ROOT_NAMESPACE__.PatternVariable>();
                        ...
                        for (let i_22: number = 0; i_22 < size_22; i_22++) {
                            const value_164: __ROOT_NAMESPACE__.PatternVariable = __ROOT_NAMESPACE__.PatternVariable.read(input);
                            value_163.push(value_164);
                        }
                        input.readListEnd();
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_165: __ROOT_NAMESPACE__.PreconditionException = __ROOT_NAMESPACE__.PreconditionException.read(input);
                        _args.validError = value_165;
                    }
                    else {
                        input.skip(fieldType);
                    }
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_166: __ROOT_NAMESPACE__.ServerException = __ROOT_NAMESPACE__.ServerException.read(input);
                        _args.error = value_166;
                    }
                    else {
                        input.skip(fieldType);
                    }
...
export class ChangeFreezePatternVariablesResult {
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.success != null) {
            output.writeFieldBegin("success", thrift.Thrift.Type.LIST, 0);
            output.writeListBegin(thrift.Thrift.Type.STRUCT, this.success.length);
            this.success.forEach((value_167: __ROOT_NAMESPACE__.PatternVariable): void => {
                value_167.write(output);
            });
            output.writeListEnd();
            output.writeFieldEnd();
        }
    ...
    public static read(input: thrift.TProtocol): ChangeFreezePatternVariablesResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_168: Array<__ROOT_NAMESPACE__.PatternVariable> = new Array<__ROOT_NAMESPACE__.PatternVariable>();
                        ...
                        for (let i_23: number = 0; i_23 < size_23; i_23++) {
                            const value_169: __ROOT_NAMESPACE__.PatternVariable = __ROOT_NAMESPACE__.PatternVariable.read(input);
                            value_168.push(value_169);
                        }
                        input.readListEnd();
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_170: __ROOT_NAMESPACE__.PreconditionException = __ROOT_NAMESPACE__.PreconditionException.read(input);
                        _args.validError = value_170;
                    }
                    else {
                        input.skip(fieldType);
                    }
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_171: __ROOT_NAMESPACE__.ServerException = __ROOT_NAMESPACE__.ServerException.read(input);
                        _args.error = value_171;
                    }
                    else {
                        input.skip(fieldType);
                    }
...
export interface IGetContentItemsResultArgs {
    success?: Array<__ROOT_NAMESPACE__.ContentItem>;
    validError?: __ROOT_NAMESPACE__.PreconditionException;
    error?: __ROOT_NAMESPACE__.ServerException;
}
export class GetContentItemsResult {
    public success?: Array<__ROOT_NAMESPACE__.ContentItem>;
    public validError?: __ROOT_NAMESPACE__.PreconditionException;
    public error?: __ROOT_NAMESPACE__.ServerException;
    constructor(args?: IGetContentItemsResultArgs) {
        if (args != null && args.success != null) {
            this.success = args.success;
        }
        if (args != null && args.validError != null) {
    ...
    public write(output: thrift.TProtocol): void {
        output.writeStructBegin("GetContentItemsResult");
        if (this.success != null) {
            output.writeFieldBegin("success", thrift.Thrift.Type.LIST, 0);
            output.writeListBegin(thrift.Thrift.Type.STRUCT, this.success.length);
            this.success.forEach((value_172: __ROOT_NAMESPACE__.ContentItem): void => {
                value_172.write(output);
            });
            output.writeListEnd();
            output.writeFieldEnd();
        }
    ...
    public static read(input: thrift.TProtocol): GetContentItemsResult {
        input.readStructBegin();
        let _args: any = {};
        while (true) {
            const ret: thrift.TField = input.readFieldBegin();
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_173: Array<__ROOT_NAMESPACE__.ContentItem> = new Array<__ROOT_NAMESPACE__.ContentItem>();
                        ...
                        for (let i_24: number = 0; i_24 < size_24; i_24++) {
                            const value_174: __ROOT_NAMESPACE__.ContentItem = __ROOT_NAMESPACE__.ContentItem.read(input);
                            value_173.push(value_174);
                        }
                        input.readListEnd();
        ...
        input.readStructEnd();
        return new GetContentItemsResult(_args);
    }
}
export class Client {
    ...
    public getFilledDocumentPattern(token: string, filledDocumentPatternId: string): Promise<__ROOT_NAMESPACE__.FreezeDocumentPattern> {
        const requestId: number = this.incrementSeqId();
        return new Promise<__ROOT_NAMESPACE__.FreezeDocumentPattern>((resolve, reject): void => {
    ...
    public createAndCheckFilledDocumentPattern(token: string, freezeDocumentPattern: __ROOT_NAMESPACE__.FreezeDocumentPattern, stages: Array<__ROOT_NAMESPACE__.DocumentPatternStage>, toUpdate: Array<__ROOT_NAMESPACE__.PatternProcessRole>): Promise<FreezePatternValidation.FreezePatternValidation> {
        const requestId: number = this.incrementSeqId();
    ...
    public getAllFilledDocumentPatternStages(token: string, fillDocPatternId: string, filter: __ROOT_NAMESPACE__.KazFilter, selector: __ROOT_NAMESPACE__.RuleSelector): Promise<Array<__ROOT_NAMESPACE__.DocumentPatternStage>> {
        const requestId: number = this.incrementSeqId();
    ...
    public getFilledDocumentPatternStage(token: string, fillDocPatternId: string, stageId: string, selector: __ROOT_NAMESPACE__.RuleSelector, policy: __ROOT_NAMESPACE__.DocumentAccessPolicy): Promise<__ROOT_NAMESPACE__.DocumentPatternStage> {
        const requestId: number = this.incrementSeqId();
    ...
    public getSetDecisionInfo(token: string, fillDocPatternId: string, freezeLinkId: string, selector: __ROOT_NAMESPACE__.RuleSelector, policy: __ROOT_NAMESPACE__.DocumentAccessPolicy): Promise<__ROOT_NAMESPACE__.DesicionInfo> {
        const requestId: number = this.incrementSeqId();
        return new Promise<__ROOT_NAMESPACE__.DesicionInfo>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
                if (error != null) {
                    reject(error);
    ...
    public getAllChildFilledDocumentPatternStages(token: string, fillDocPatternId: string, stageId: string): Promise<Array<__ROOT_NAMESPACE__.DocumentPatternStage>> {
        const requestId: number = this.incrementSeqId();
        return new Promise<Array<__ROOT_NAMESPACE__.DocumentPatternStage>>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
    ...
    public updateFilledDocumentPatternStageList(token: string, fillDocPatternId: string, documentPatternStage: Array<__ROOT_NAMESPACE__.DocumentPatternStage>, enEditCurrent: boolean): Promise<Array<__ROOT_NAMESPACE__.DocumentPatternStage>> {
        const requestId: number = this.incrementSeqId();
        return new Promise<Array<__ROOT_NAMESPACE__.DocumentPatternStage>>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
    ...
    public updateFilledDocumentPatternStagesLink(token: string, fillDocPatternId: string, links: Array<__ROOT_NAMESPACE__.DocumentPatternStagesLink>): Promise<Array<__ROOT_NAMESPACE__.DocumentPatternStagesLink>> {
        const requestId: number = this.incrementSeqId();
    ...
    public getAllFilledDocumentPatternStagesLink(token: string, fillDocPatternId: string, filter: __ROOT_NAMESPACE__.KazFilter): Promise<Array<__ROOT_NAMESPACE__.DocumentPatternStagesLink>> {
        const requestId: number = this.incrementSeqId();
        return new Promise<Array<__ROOT_NAMESPACE__.DocumentPatternStagesLink>>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
    ...
    public getAllFilledDocumentPatternStageExecutors(token: string, fillDocPatternId: string, stageId: string, filter: __ROOT_NAMESPACE__.KazFilter): Promise<Array<__ROOT_NAMESPACE__.DocumentPatternStagesExecutor>> {
        const requestId: number = this.incrementSeqId();
        return new Promise<Array<__ROOT_NAMESPACE__.DocumentPatternStagesExecutor>>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
                if (error != null) {
                    reject(error);
    ...
    public getFilledDocumentPatternStagesExecutors(token: string, fillDocPatternId: string, stageIds: Array<string>, filter: __ROOT_NAMESPACE__.KazFilter): Promise<Map<string, Array<__ROOT_NAMESPACE__.DocumentPatternStagesExecutor>>> {
        const requestId: number = this.incrementSeqId();
        return new Promise<Map<string, Array<__ROOT_NAMESPACE__.DocumentPatternStagesExecutor>>>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
                if (error != null) {
                    reject(error);
    ...
    public changeFilledDocumentPatternStages(token: string, fillDocPatternId: string, stages: Array<__ROOT_NAMESPACE__.DocumentPatternStage>): Promise<boolean> {
        const requestId: number = this.incrementSeqId();
        return new Promise<boolean>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
    ...
    public checkFilledDocumentPattern(token: string, fillDocPatternId: string, filter: __ROOT_NAMESPACE__.KazFilter): Promise<Array<__ROOT_NAMESPACE__.PreconditionException>> {
        const requestId: number = this.incrementSeqId();
    ...
    public getFreezeProcessRoles(token: string, docId: string, policy: __ROOT_NAMESPACE__.DocumentAccessPolicy, filter: __ROOT_NAMESPACE__.KazFilter): Promise<Array<__ROOT_NAMESPACE__.PatternProcessRole>> {
        const requestId: number = this.incrementSeqId();
    ...
    public changeFreezeProcessRoles(token: string, docId: string, policy: __ROOT_NAMESPACE__.DocumentAccessPolicy, patternRolesToAdd: Array<__ROOT_NAMESPACE__.PatternProcessRole>, keyIdToRemove: Set<string>): Promise<Array<__ROOT_NAMESPACE__.PatternProcessRole>> {
        const requestId: number = this.incrementSeqId();
        return new Promise<Array<__ROOT_NAMESPACE__.PatternProcessRole>>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
    ...
    public getFreezeProcessVariables(token: string, docId: string, policy: __ROOT_NAMESPACE__.DocumentAccessPolicy, filter: __ROOT_NAMESPACE__.KazFilter): Promise<Array<__ROOT_NAMESPACE__.PatternVariable>> {
        const requestId: number = this.incrementSeqId();
    ...
    public changeFreezePatternVariables(token: string, docId: string, policy: __ROOT_NAMESPACE__.DocumentAccessPolicy, patternVariablesToAdd: Array<__ROOT_NAMESPACE__.PatternVariable>, keyIdToRemove: Set<string>): Promise<Array<__ROOT_NAMESPACE__.PatternVariable>> {
        const requestId: number = this.incrementSeqId();
        return new Promise<Array<__ROOT_NAMESPACE__.PatternVariable>>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
    ...
    public getContentItems(token: string, docId: string, policy: __ROOT_NAMESPACE__.DocumentAccessPolicy, filter: __ROOT_NAMESPACE__.KazFilter): Promise<Array<__ROOT_NAMESPACE__.ContentItem>> {
        const requestId: number = this.incrementSeqId();
        return new Promise<Array<__ROOT_NAMESPACE__.ContentItem>>((resolve, reject): void => {
            ...
            this.send_getContentItems(token, docId, policy, filter, requestId);
        });
    }
    ...
    public send_createAndCheckFilledDocumentPattern(token: string, freezeDocumentPattern: __ROOT_NAMESPACE__.FreezeDocumentPattern, stages: Array<__ROOT_NAMESPACE__.DocumentPatternStage>, toUpdate: Array<__ROOT_NAMESPACE__.PatternProcessRole>, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_getAllFilledDocumentPatternStages(token: string, fillDocPatternId: string, filter: __ROOT_NAMESPACE__.KazFilter, selector: __ROOT_NAMESPACE__.RuleSelector, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_getFilledDocumentPatternStage(token: string, fillDocPatternId: string, stageId: string, selector: __ROOT_NAMESPACE__.RuleSelector, policy: __ROOT_NAMESPACE__.DocumentAccessPolicy, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_getSetDecisionInfo(token: string, fillDocPatternId: string, freezeLinkId: string, selector: __ROOT_NAMESPACE__.RuleSelector, policy: __ROOT_NAMESPACE__.DocumentAccessPolicy, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_updateFilledDocumentPatternStageList(token: string, fillDocPatternId: string, documentPatternStage: Array<__ROOT_NAMESPACE__.DocumentPatternStage>, enEditCurrent: boolean, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_updateFilledDocumentPatternStagesLink(token: string, fillDocPatternId: string, links: Array<__ROOT_NAMESPACE__.DocumentPatternStagesLink>, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_getAllFilledDocumentPatternStagesLink(token: string, fillDocPatternId: string, filter: __ROOT_NAMESPACE__.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_getAllFilledDocumentPatternStageExecutors(token: string, fillDocPatternId: string, stageId: string, filter: __ROOT_NAMESPACE__.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_getFilledDocumentPatternStagesExecutors(token: string, fillDocPatternId: string, stageIds: Array<string>, filter: __ROOT_NAMESPACE__.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_changeFilledDocumentPatternStages(token: string, fillDocPatternId: string, stages: Array<__ROOT_NAMESPACE__.DocumentPatternStage>, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_checkFilledDocumentPattern(token: string, fillDocPatternId: string, filter: __ROOT_NAMESPACE__.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_getFreezeProcessRoles(token: string, docId: string, policy: __ROOT_NAMESPACE__.DocumentAccessPolicy, filter: __ROOT_NAMESPACE__.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_changeFreezeProcessRoles(token: string, docId: string, policy: __ROOT_NAMESPACE__.DocumentAccessPolicy, patternRolesToAdd: Array<__ROOT_NAMESPACE__.PatternProcessRole>, keyIdToRemove: Set<string>, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_getFreezeProcessVariables(token: string, docId: string, policy: __ROOT_NAMESPACE__.DocumentAccessPolicy, filter: __ROOT_NAMESPACE__.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_changeFreezePatternVariables(token: string, docId: string, policy: __ROOT_NAMESPACE__.DocumentAccessPolicy, patternVariablesToAdd: Array<__ROOT_NAMESPACE__.PatternVariable>, keyIdToRemove: Set<string>, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_getContentItems(token: string, docId: string, policy: __ROOT_NAMESPACE__.DocumentAccessPolicy, filter: __ROOT_NAMESPACE__.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
        output.writeMessageBegin("getContentItems", thrift.Thrift.MessageType.CALL, requestId);
        const args: GetContentItemsArgs = new GetContentItemsArgs({ token, docId, policy, filter });
        args.write(output);
        output.writeMessageEnd();
        this.output.flush();
        return;
    ...
    public recv_getContentItems(input: thrift.TProtocol, mtype: thrift.Thrift.MessageType, requestId: number): void {
        const noop = (): any => null;
        const callback = this._reqs[requestId] || noop;
        if (mtype === thrift.Thrift.MessageType.EXCEPTION) {
            const x: thrift.Thrift.TApplicationException = new thrift.Thrift.TApplicationException();
            ...
            const result: GetContentItemsResult = GetContentItemsResult.read(input);
            input.readMessageEnd();
            if (result.validError != null) {
                return callback(result.validError);
            }
                ...
                if (result.success != null) {
                    ...
                    return callback(new thrift.Thrift.TApplicationException(thrift.Thrift.TApplicationExceptionType.UNKNOWN, "getContentItems failed: unknown result"));
                }
            }
        }
    }
...
export interface IHandler {
    getFilledDocumentPattern(token: string, filledDocumentPatternId: string): __ROOT_NAMESPACE__.FreezeDocumentPattern | Promise<__ROOT_NAMESPACE__.FreezeDocumentPattern>;
    createAndCheckFilledDocumentPattern(token: string, freezeDocumentPattern: __ROOT_NAMESPACE__.FreezeDocumentPattern, stages: Array<__ROOT_NAMESPACE__.DocumentPatternStage>, toUpdate: Array<__ROOT_NAMESPACE__.PatternProcessRole>): FreezePatternValidation.FreezePatternValidation | Promise<FreezePatternValidation.FreezePatternValidation>;
    deleteFilledDocumentPattern(token: string, filledDocumentPatternId: string): boolean | Promise<boolean>;
    getAllFilledDocumentPatternStages(token: string, fillDocPatternId: string, filter: __ROOT_NAMESPACE__.KazFilter, selector: __ROOT_NAMESPACE__.RuleSelector): Array<__ROOT_NAMESPACE__.DocumentPatternStage> | Promise<Array<__ROOT_NAMESPACE__.DocumentPatternStage>>;
    getFilledDocumentPatternStage(token: string, fillDocPatternId: string, stageId: string, selector: __ROOT_NAMESPACE__.RuleSelector, policy: __ROOT_NAMESPACE__.DocumentAccessPolicy): __ROOT_NAMESPACE__.DocumentPatternStage | Promise<__ROOT_NAMESPACE__.DocumentPatternStage>;
    getSetDecisionInfo(token: string, fillDocPatternId: string, freezeLinkId: string, selector: __ROOT_NAMESPACE__.RuleSelector, policy: __ROOT_NAMESPACE__.DocumentAccessPolicy): __ROOT_NAMESPACE__.DesicionInfo | Promise<__ROOT_NAMESPACE__.DesicionInfo>;
    getAllChildFilledDocumentPatternStages(token: string, fillDocPatternId: string, stageId: string): Array<__ROOT_NAMESPACE__.DocumentPatternStage> | Promise<Array<__ROOT_NAMESPACE__.DocumentPatternStage>>;
    updateFilledDocumentPatternStageList(token: string, fillDocPatternId: string, documentPatternStage: Array<__ROOT_NAMESPACE__.DocumentPatternStage>, enEditCurrent: boolean): Array<__ROOT_NAMESPACE__.DocumentPatternStage> | Promise<Array<__ROOT_NAMESPACE__.DocumentPatternStage>>;
    updateFilledDocumentPatternStagesLink(token: string, fillDocPatternId: string, links: Array<__ROOT_NAMESPACE__.DocumentPatternStagesLink>): Array<__ROOT_NAMESPACE__.DocumentPatternStagesLink> | Promise<Array<__ROOT_NAMESPACE__.DocumentPatternStagesLink>>;
    getAllFilledDocumentPatternStagesLink(token: string, fillDocPatternId: string, filter: __ROOT_NAMESPACE__.KazFilter): Array<__ROOT_NAMESPACE__.DocumentPatternStagesLink> | Promise<Array<__ROOT_NAMESPACE__.DocumentPatternStagesLink>>;
    getAllFilledDocumentPatternStageExecutors(token: string, fillDocPatternId: string, stageId: string, filter: __ROOT_NAMESPACE__.KazFilter): Array<__ROOT_NAMESPACE__.DocumentPatternStagesExecutor> | Promise<Array<__ROOT_NAMESPACE__.DocumentPatternStagesExecutor>>;
    getFilledDocumentPatternStagesExecutors(token: string, fillDocPatternId: string, stageIds: Array<string>, filter: __ROOT_NAMESPACE__.KazFilter): Map<string, Array<__ROOT_NAMESPACE__.DocumentPatternStagesExecutor>> | Promise<Map<string, Array<__ROOT_NAMESPACE__.DocumentPatternStagesExecutor>>>;
    changeFilledDocumentPatternStages(token: string, fillDocPatternId: string, stages: Array<__ROOT_NAMESPACE__.DocumentPatternStage>): boolean | Promise<boolean>;
    checkFilledDocumentPattern(token: string, fillDocPatternId: string, filter: __ROOT_NAMESPACE__.KazFilter): Array<__ROOT_NAMESPACE__.PreconditionException> | Promise<Array<__ROOT_NAMESPACE__.PreconditionException>>;
    getFreezeProcessRoles(token: string, docId: string, policy: __ROOT_NAMESPACE__.DocumentAccessPolicy, filter: __ROOT_NAMESPACE__.KazFilter): Array<__ROOT_NAMESPACE__.PatternProcessRole> | Promise<Array<__ROOT_NAMESPACE__.PatternProcessRole>>;
    changeFreezeProcessRoles(token: string, docId: string, policy: __ROOT_NAMESPACE__.DocumentAccessPolicy, patternRolesToAdd: Array<__ROOT_NAMESPACE__.PatternProcessRole>, keyIdToRemove: Set<string>): Array<__ROOT_NAMESPACE__.PatternProcessRole> | Promise<Array<__ROOT_NAMESPACE__.PatternProcessRole>>;
    getFreezeProcessVariables(token: string, docId: string, policy: __ROOT_NAMESPACE__.DocumentAccessPolicy, filter: __ROOT_NAMESPACE__.KazFilter): Array<__ROOT_NAMESPACE__.PatternVariable> | Promise<Array<__ROOT_NAMESPACE__.PatternVariable>>;
    changeFreezePatternVariables(token: string, docId: string, policy: __ROOT_NAMESPACE__.DocumentAccessPolicy, patternVariablesToAdd: Array<__ROOT_NAMESPACE__.PatternVariable>, keyIdToRemove: Set<string>): Array<__ROOT_NAMESPACE__.PatternVariable> | Promise<Array<__ROOT_NAMESPACE__.PatternVariable>>;
    getContentItems(token: string, docId: string, policy: __ROOT_NAMESPACE__.DocumentAccessPolicy, filter: __ROOT_NAMESPACE__.KazFilter): Array<__ROOT_NAMESPACE__.ContentItem> | Promise<Array<__ROOT_NAMESPACE__.ContentItem>>;
}
export class Processor {
    ...
    public process(input: thrift.TProtocol, output: thrift.TProtocol): void {
        ...
        switch (methodName) {
            ...
            case "process_getContentItems": {
                this.process_getContentItems(requestId, input, output);
                return;
            }
            default: {
    ...
    public process_getFilledDocumentPattern(requestId: number, input: thrift.TProtocol, output: thrift.TProtocol): void {
        new Promise<__ROOT_NAMESPACE__.FreezeDocumentPattern>((resolve, reject): void => {
            try {
        ...
        }).then((data: __ROOT_NAMESPACE__.FreezeDocumentPattern): void => {
    ...
    public process_getSetDecisionInfo(requestId: number, input: thrift.TProtocol, output: thrift.TProtocol): void {
        new Promise<__ROOT_NAMESPACE__.DesicionInfo>((resolve, reject): void => {
            try {
        ...
        }).then((data: __ROOT_NAMESPACE__.DesicionInfo): void => {
    ...
    public process_getAllFilledDocumentPatternStageExecutors(requestId: number, input: thrift.TProtocol, output: thrift.TProtocol): void {
        new Promise<Array<__ROOT_NAMESPACE__.DocumentPatternStagesExecutor>>((resolve, reject): void => {
            try {
        ...
        }).then((data: Array<__ROOT_NAMESPACE__.DocumentPatternStagesExecutor>): void => {
    ...
    public process_getFilledDocumentPatternStagesExecutors(requestId: number, input: thrift.TProtocol, output: thrift.TProtocol): void {
        new Promise<Map<string, Array<__ROOT_NAMESPACE__.DocumentPatternStagesExecutor>>>((resolve, reject): void => {
            try {
        ...
        }).then((data: Map<string, Array<__ROOT_NAMESPACE__.DocumentPatternStagesExecutor>>): void => {
    ...
    public process_getContentItems(requestId: number, input: thrift.TProtocol, output: thrift.TProtocol): void {
        new Promise<Array<__ROOT_NAMESPACE__.ContentItem>>((resolve, reject): void => {
            try {
                const args: GetContentItemsArgs = GetContentItemsArgs.read(input);
                input.readMessageEnd();
                resolve(this._handler.getContentItems(args.token, args.docId, args.policy, args.filter));
            }
            catch (err) {
                reject(err);
            }
        }).then((data: Array<__ROOT_NAMESPACE__.ContentItem>): void => {
            const result: GetContentItemsResult = new GetContentItemsResult({ success: data });
            output.writeMessageBegin("getContentItems", thrift.Thrift.MessageType.REPLY, requestId);
            result.write(output);
            output.writeMessageEnd();
            output.flush();
            return;
            ...
            if (err instanceof __ROOT_NAMESPACE__.PreconditionException) {
                const result: GetContentItemsResult = new GetContentItemsResult({ validError: err });
                output.writeMessageBegin("getContentItems", thrift.Thrift.MessageType.REPLY, requestId);
                result.write(output);
                output.writeMessageEnd();
                output.flush();
                ...
                const result: GetContentItemsResult = new GetContentItemsResult({ error: err });
                output.writeMessageBegin("getContentItems", thrift.Thrift.MessageType.REPLY, requestId);
                result.write(output);
                output.writeMessageEnd();
                output.flush();
                ...
                const result: thrift.Thrift.TApplicationException = new thrift.Thrift.TApplicationException(thrift.Thrift.TApplicationExceptionType.UNKNOWN, err.message);
                output.writeMessageBegin("getContentItems", thrift.Thrift.MessageType.EXCEPTION, requestId);
                result.write(output);
                output.writeMessageEnd();
                output.flush();
                return;
