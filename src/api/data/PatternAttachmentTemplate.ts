...
export interface IPatternAttachmentTemplateArgs {
    ...
    addFunctionId?: __ROOT_NAMESPACE__.CompositeId;
}
export class PatternAttachmentTemplate {
    ...
    public addFunctionId?: __ROOT_NAMESPACE__.CompositeId;
            ...
            switch (fieldId) {
                ...
                case 12:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_12: __ROOT_NAMESPACE__.CompositeId = __ROOT_NAMESPACE__.CompositeId.read(input);
