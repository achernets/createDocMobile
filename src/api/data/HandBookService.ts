    ...
    public static read(input: thrift.TProtocol): CreateOrUpdateHandBookArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_9: __ROOT_NAMESPACE__.HandBook = __ROOT_NAMESPACE__.HandBook.read(input);
...
export class CreateOrUpdateHBRowsArgs {
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.rows != null) {
            ...
            this.rows.forEach((value_12: __ROOT_NAMESPACE__.HBRow): void => {
            ...
            switch (fieldId) {
                ...
                case 3:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_15: Array<__ROOT_NAMESPACE__.HBRow> = new Array<__ROOT_NAMESPACE__.HBRow>();
                        const metadata_1: thrift.TList = input.readListBegin();
                        const size_1: number = metadata_1.size;
                        for (let i_1: number = 0; i_1 < size_1; i_1++) {
                            const value_16: __ROOT_NAMESPACE__.HBRow = __ROOT_NAMESPACE__.HBRow.read(input);
...
export class GetAllHandBooksResult {
    public success?: Array<__ROOT_NAMESPACE__.HandBook>;
...
export interface IGetHandBookByIdResultArgs {
    success?: __ROOT_NAMESPACE__.HandBook;
    validError?: __ROOT_NAMESPACE__.PreconditionException;
    error?: __ROOT_NAMESPACE__.ServerException;
}
export class GetHandBookByIdResult {
    public success?: __ROOT_NAMESPACE__.HandBook;
    public validError?: __ROOT_NAMESPACE__.PreconditionException;
    public error?: __ROOT_NAMESPACE__.ServerException;
...
export interface IRefreshHandBookStructureResultArgs {
    success?: Map<string, Array<__ROOT_NAMESPACE__.HBColumn>>;
    validError?: __ROOT_NAMESPACE__.PreconditionException;
    error?: __ROOT_NAMESPACE__.ServerException;
}
export class RefreshHandBookStructureResult {
    public success?: Map<string, Array<__ROOT_NAMESPACE__.HBColumn>>;
    public validError?: __ROOT_NAMESPACE__.PreconditionException;
    public error?: __ROOT_NAMESPACE__.ServerException;
...
export interface IGetAllHandBookRowsResultArgs {
    success?: Array<__ROOT_NAMESPACE__.HBRow>;
    validError?: __ROOT_NAMESPACE__.PreconditionException;
    error?: __ROOT_NAMESPACE__.ServerException;
}
export class GetAllHandBookRowsResult {
    public success?: Array<__ROOT_NAMESPACE__.HBRow>;
    public validError?: __ROOT_NAMESPACE__.PreconditionException;
    public error?: __ROOT_NAMESPACE__.ServerException;
...
export interface IGetHandBookValuesResultArgs {
    success?: Array<__ROOT_NAMESPACE__.HBValue>;
    validError?: __ROOT_NAMESPACE__.PreconditionException;
    error?: __ROOT_NAMESPACE__.ServerException;
}
export class GetHandBookValuesResult {
    public success?: Array<__ROOT_NAMESPACE__.HBValue>;
    public validError?: __ROOT_NAMESPACE__.PreconditionException;
    public error?: __ROOT_NAMESPACE__.ServerException;
...
export class Client {
    ...
    public getAllHandBooks(token: string, filter: __ROOT_NAMESPACE__.KazFilter): Promise<Array<__ROOT_NAMESPACE__.HandBook>> {
        const requestId: number = this.incrementSeqId();
        return new Promise<Array<__ROOT_NAMESPACE__.HandBook>>((resolve, reject): void => {
    ...
    public getCountAllHandBooks(token: string, filter: __ROOT_NAMESPACE__.KazFilter): Promise<number> {
        const requestId: number = this.incrementSeqId();
    ...
    public getHandBookById(token: string, id: string, withDeletedColumns: boolean): Promise<__ROOT_NAMESPACE__.HandBook> {
        const requestId: number = this.incrementSeqId();
        return new Promise<__ROOT_NAMESPACE__.HandBook>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
                if (error != null) {
                    reject(error);
    ...
    public createOrUpdateHandBook(token: string, handBook: __ROOT_NAMESPACE__.HandBook): Promise<__ROOT_NAMESPACE__.HandBook> {
        const requestId: number = this.incrementSeqId();
        return new Promise<__ROOT_NAMESPACE__.HandBook>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
    ...
    public refreshHandBookStructure(token: string, id: string): Promise<Map<string, Array<__ROOT_NAMESPACE__.HBColumn>>> {
        const requestId: number = this.incrementSeqId();
        return new Promise<Map<string, Array<__ROOT_NAMESPACE__.HBColumn>>>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
                if (error != null) {
                    reject(error);
    ...
    public createOrUpdateHBRows(token: string, hbId: string, rows: Array<__ROOT_NAMESPACE__.HBRow>): Promise<void> {
        const requestId: number = this.incrementSeqId();
    ...
    public getAllHandBookRows(token: string, hbId: string, filter: __ROOT_NAMESPACE__.KazFilter): Promise<Array<__ROOT_NAMESPACE__.HBRow>> {
        const requestId: number = this.incrementSeqId();
        return new Promise<Array<__ROOT_NAMESPACE__.HBRow>>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
                if (error != null) {
                    reject(error);
    ...
    public getAllHandBookRowsCount(token: string, hbId: string, filter: __ROOT_NAMESPACE__.KazFilter): Promise<Int64> {
        const requestId: number = this.incrementSeqId();
    ...
    public getHandBookValues(token: string, filter: __ROOT_NAMESPACE__.KazFilter): Promise<Array<__ROOT_NAMESPACE__.HBValue>> {
        const requestId: number = this.incrementSeqId();
        return new Promise<Array<__ROOT_NAMESPACE__.HBValue>>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
                if (error != null) {
                    reject(error);
    ...
    public send_getCountAllHandBooks(token: string, filter: __ROOT_NAMESPACE__.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_createOrUpdateHandBook(token: string, handBook: __ROOT_NAMESPACE__.HandBook, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_createOrUpdateHBRows(token: string, hbId: string, rows: Array<__ROOT_NAMESPACE__.HBRow>, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_getAllHandBookRows(token: string, hbId: string, filter: __ROOT_NAMESPACE__.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_getAllHandBookRowsCount(token: string, hbId: string, filter: __ROOT_NAMESPACE__.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_getHandBookValues(token: string, filter: __ROOT_NAMESPACE__.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
...
export interface IHandler {
    ...
    getCountAllHandBooks(token: string, filter: __ROOT_NAMESPACE__.KazFilter): number | Promise<number>;
    getHandBookById(token: string, id: string, withDeletedColumns: boolean): __ROOT_NAMESPACE__.HandBook | Promise<__ROOT_NAMESPACE__.HandBook>;
    createOrUpdateHandBook(token: string, handBook: __ROOT_NAMESPACE__.HandBook): __ROOT_NAMESPACE__.HandBook | Promise<__ROOT_NAMESPACE__.HandBook>;
    refreshHandBookStructure(token: string, id: string): Map<string, Array<__ROOT_NAMESPACE__.HBColumn>> | Promise<Map<string, Array<__ROOT_NAMESPACE__.HBColumn>>>;
    createOrUpdateHBRows(token: string, hbId: string, rows: Array<__ROOT_NAMESPACE__.HBRow>): void | Promise<void>;
    getAllHandBookRows(token: string, hbId: string, filter: __ROOT_NAMESPACE__.KazFilter): Array<__ROOT_NAMESPACE__.HBRow> | Promise<Array<__ROOT_NAMESPACE__.HBRow>>;
    getAllHandBookRowsCount(token: string, hbId: string, filter: __ROOT_NAMESPACE__.KazFilter): Int64 | Promise<Int64>;
...
export class Processor {
    ...
    public process_getAllHandBooks(requestId: number, input: thrift.TProtocol, output: thrift.TProtocol): void {
        new Promise<Array<__ROOT_NAMESPACE__.HandBook>>((resolve, reject): void => {
            try {
        ...
        }).then((data: Array<__ROOT_NAMESPACE__.HandBook>): void => {
    ...
    public process_getHandBookById(requestId: number, input: thrift.TProtocol, output: thrift.TProtocol): void {
        new Promise<__ROOT_NAMESPACE__.HandBook>((resolve, reject): void => {
            try {
        ...
        }).then((data: __ROOT_NAMESPACE__.HandBook): void => {
    ...
    public process_refreshHandBookStructure(requestId: number, input: thrift.TProtocol, output: thrift.TProtocol): void {
        new Promise<Map<string, Array<__ROOT_NAMESPACE__.HBColumn>>>((resolve, reject): void => {
            try {
        ...
        }).then((data: Map<string, Array<__ROOT_NAMESPACE__.HBColumn>>): void => {
    ...
    public process_getAllHandBookRows(requestId: number, input: thrift.TProtocol, output: thrift.TProtocol): void {
        new Promise<Array<__ROOT_NAMESPACE__.HBRow>>((resolve, reject): void => {
            try {
        ...
        }).then((data: Array<__ROOT_NAMESPACE__.HBRow>): void => {
    ...
    public process_getHandBookValues(requestId: number, input: thrift.TProtocol, output: thrift.TProtocol): void {
        new Promise<Array<__ROOT_NAMESPACE__.HBValue>>((resolve, reject): void => {
            try {
        ...
        }).then((data: Array<__ROOT_NAMESPACE__.HBValue>): void => {
