...
export interface IAnaliticsDashboardArgs {
    ...
    denyList?: Array<__ROOT_NAMESPACE__.UserOrGroup>;
    name?: string;
...
export class AnaliticsDashboard {
    ...
    public denyList?: Array<__ROOT_NAMESPACE__.UserOrGroup>;
    public name?: string;
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.allowList != null) {
            ...
            this.allowList.forEach((value_2: __ROOT_NAMESPACE__.UserOrGroup): void => {
        ...
        if (this.denyList != null) {
            ...
            this.denyList.forEach((value_3: __ROOT_NAMESPACE__.UserOrGroup): void => {
    ...
    public static read(input: thrift.TProtocol): AnaliticsDashboard {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 5:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_11: Array<__ROOT_NAMESPACE__.UserOrGroup> = new Array<__ROOT_NAMESPACE__.UserOrGroup>();
