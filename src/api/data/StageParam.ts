...
export interface IStageParamArgs {
    ...
    scriptId?: __ROOT_NAMESPACE__.CompositeId;
    req?: boolean;
    displayName?: string;
...
export class StageParam {
    ...
    public scriptId?: __ROOT_NAMESPACE__.CompositeId;
    public req?: boolean;
            ...
            switch (fieldId) {
                ...
                case 7:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_15: __ROOT_NAMESPACE__.CompositeId = __ROOT_NAMESPACE__.CompositeId.read(input);
