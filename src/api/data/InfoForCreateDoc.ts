...
export interface IInfoForCreateDocArgs {
    ...
    scGrifs?: Array<__ROOT_NAMESPACE__.SecurityClassification>;
    templates?: Array<PatternAttachmentTemplate.PatternAttachmentTemplate>;
    holders?: Array<__ROOT_NAMESPACE__.ContentHolder>;
...
export class InfoForCreateDoc {
    ...
    public scGrifs?: Array<__ROOT_NAMESPACE__.SecurityClassification>;
    public templates?: Array<PatternAttachmentTemplate.PatternAttachmentTemplate>;
    public holders?: Array<__ROOT_NAMESPACE__.ContentHolder>;
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.stages != null) {
            ...
            this.stages.forEach((value_1: __ROOT_NAMESPACE__.DocumentPatternStage): void => {
        ...
        if (this.scGrifs != null) {
            ...
            this.scGrifs.forEach((value_2: __ROOT_NAMESPACE__.SecurityClassification): void => {
        ...
        if (this.holders != null) {
            ...
            this.holders.forEach((value_4: __ROOT_NAMESPACE__.ContentHolder): void => {
            ...
            switch (fieldId) {
                case 1:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_5: Array<__ROOT_NAMESPACE__.DocumentPatternStage> = new Array<__ROOT_NAMESPACE__.DocumentPatternStage>();
                        const metadata_1: thrift.TList = input.readListBegin();
                        const size_1: number = metadata_1.size;
                        for (let i_1: number = 0; i_1 < size_1; i_1++) {
                            const value_6: __ROOT_NAMESPACE__.DocumentPatternStage = __ROOT_NAMESPACE__.DocumentPatternStage.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_7: Array<__ROOT_NAMESPACE__.SecurityClassification> = new Array<__ROOT_NAMESPACE__.SecurityClassification>();
                        const metadata_2: thrift.TList = input.readListBegin();
                        const size_2: number = metadata_2.size;
                        for (let i_2: number = 0; i_2 < size_2; i_2++) {
                            const value_8: __ROOT_NAMESPACE__.SecurityClassification = __ROOT_NAMESPACE__.SecurityClassification.read(input);
                ...
                case 4:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_11: Array<__ROOT_NAMESPACE__.ContentHolder> = new Array<__ROOT_NAMESPACE__.ContentHolder>();
                        const metadata_4: thrift.TList = input.readListBegin();
                        const size_4: number = metadata_4.size;
                        for (let i_4: number = 0; i_4 < size_4; i_4++) {
                            const value_12: __ROOT_NAMESPACE__.ContentHolder = __ROOT_NAMESPACE__.ContentHolder.read(input);
                ...
                case 5:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_13: __ROOT_NAMESPACE__.DocPermissions = __ROOT_NAMESPACE__.DocPermissions.read(input);
