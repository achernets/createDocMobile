...
export interface IResponseMobileRegistrationArgsArgs {
    token: string;
    device: __ROOT_NAMESPACE__.Device;
    code: string;
}
export class ResponseMobileRegistrationArgs {
    public token: string;
    public device: __ROOT_NAMESPACE__.Device;
    public code: string;
    ...
    public static read(input: thrift.TProtocol): ResponseMobileRegistrationArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_4: __ROOT_NAMESPACE__.Device = __ROOT_NAMESPACE__.Device.read(input);
...
export interface IGetAllMobileDevicesResultArgs {
    success?: Array<__ROOT_NAMESPACE__.Device>;
...
export class GetAllMobileDevicesResult {
    public success?: Array<__ROOT_NAMESPACE__.Device>;
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.success != null) {
            ...
            this.success.forEach((value_9: __ROOT_NAMESPACE__.Device): void => {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_10: Array<__ROOT_NAMESPACE__.Device> = new Array<__ROOT_NAMESPACE__.Device>();
                        const metadata_1: thrift.TList = input.readListBegin();
                        const size_1: number = metadata_1.size;
                        for (let i_1: number = 0; i_1 < size_1; i_1++) {
                            const value_11: __ROOT_NAMESPACE__.Device = __ROOT_NAMESPACE__.Device.read(input);
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_12: __ROOT_NAMESPACE__.PreconditionException = __ROOT_NAMESPACE__.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_13: __ROOT_NAMESPACE__.ServerException = __ROOT_NAMESPACE__.ServerException.read(input);
...
export interface IResponseMobileRegistrationResultArgs {
    success?: __ROOT_NAMESPACE__.Device;
    validError?: __ROOT_NAMESPACE__.PreconditionException;
    error?: __ROOT_NAMESPACE__.ServerException;
}
export class ResponseMobileRegistrationResult {
    public success?: __ROOT_NAMESPACE__.Device;
    public validError?: __ROOT_NAMESPACE__.PreconditionException;
    public error?: __ROOT_NAMESPACE__.ServerException;
    ...
    public static read(input: thrift.TProtocol): ResponseMobileRegistrationResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_14: __ROOT_NAMESPACE__.Device = __ROOT_NAMESPACE__.Device.read(input);
...
export class Client {
    ...
    public getAllMobileDevices(token: string, filter: __ROOT_NAMESPACE__.KazFilter): Promise<Array<__ROOT_NAMESPACE__.Device>> {
        const requestId: number = this.incrementSeqId();
        return new Promise<Array<__ROOT_NAMESPACE__.Device>>((resolve, reject): void => {
    ...
    public responseMobileRegistration(token: string, device: __ROOT_NAMESPACE__.Device, code: string): Promise<__ROOT_NAMESPACE__.Device> {
        const requestId: number = this.incrementSeqId();
        return new Promise<__ROOT_NAMESPACE__.Device>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
                if (error != null) {
                    reject(error);
    ...
    public send_getAllMobileDevices(token: string, filter: __ROOT_NAMESPACE__.KazFilter, requestId: number): void {
    ...
    public send_responseMobileRegistration(token: string, device: __ROOT_NAMESPACE__.Device, code: string, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
...
export interface IHandler {
    getAllMobileDevices(token: string, filter: __ROOT_NAMESPACE__.KazFilter): Array<__ROOT_NAMESPACE__.Device> | Promise<Array<__ROOT_NAMESPACE__.Device>>;
    responseMobileRegistration(token: string, device: __ROOT_NAMESPACE__.Device, code: string): __ROOT_NAMESPACE__.Device | Promise<__ROOT_NAMESPACE__.Device>;
...
export class Processor {
    ...
    public process_getAllMobileDevices(requestId: number, input: thrift.TProtocol, output: thrift.TProtocol): void {
        new Promise<Array<__ROOT_NAMESPACE__.Device>>((resolve, reject): void => {
            try {
        ...
        }).then((data: Array<__ROOT_NAMESPACE__.Device>): void => {
    ...
    public process_responseMobileRegistration(requestId: number, input: thrift.TProtocol, output: thrift.TProtocol): void {
        new Promise<__ROOT_NAMESPACE__.Device>((resolve, reject): void => {
            try {
        ...
        }).then((data: __ROOT_NAMESPACE__.Device): void => {
