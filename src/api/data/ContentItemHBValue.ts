...
export interface IContentItemHBValueArgs {
    row?: __ROOT_NAMESPACE__.HBRow;
    column?: __ROOT_NAMESPACE__.HBColumn;
    keyColumn?: __ROOT_NAMESPACE__.HBColumn;
}
export class ContentItemHBValue {
    public row?: __ROOT_NAMESPACE__.HBRow;
    public column?: __ROOT_NAMESPACE__.HBColumn;
    public keyColumn?: __ROOT_NAMESPACE__.HBColumn;
            ...
            switch (fieldId) {
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_1: __ROOT_NAMESPACE__.HBRow = __ROOT_NAMESPACE__.HBRow.read(input);
                        _args.row = value_1;
                    }
                    else {
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_2: __ROOT_NAMESPACE__.HBColumn = __ROOT_NAMESPACE__.HBColumn.read(input);
                ...
                case 4:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_3: __ROOT_NAMESPACE__.HBColumn = __ROOT_NAMESPACE__.HBColumn.read(input);
