...
export interface IDocumentCommentArgs {
    ...
    rootCreator?: __ROOT_NAMESPACE__.UserOrGroup;
...
export class DocumentComment {
    ...
    public rootCreator?: __ROOT_NAMESPACE__.UserOrGroup;
    ...
    public static read(input: thrift.TProtocol): DocumentComment {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 16:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_16: __ROOT_NAMESPACE__.UserOrGroup = __ROOT_NAMESPACE__.UserOrGroup.read(input);
