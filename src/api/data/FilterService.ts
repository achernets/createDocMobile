...
export class AddDocFiltersToUserGroupsArgs {
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.userOrGroups != null) {
            ...
            this.userOrGroups.forEach((value_16: __ROOT_NAMESPACE__.UserOrGroup): void => {
    ...
    public static read(input: thrift.TProtocol): AddDocFiltersToUserGroupsArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 3:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_20: Array<__ROOT_NAMESPACE__.UserOrGroup> = new Array<__ROOT_NAMESPACE__.UserOrGroup>();
                        const metadata_3: thrift.TList = input.readListBegin();
                        const size_3: number = metadata_3.size;
                        for (let i_3: number = 0; i_3 < size_3; i_3++) {
                            const value_21: __ROOT_NAMESPACE__.UserOrGroup = __ROOT_NAMESPACE__.UserOrGroup.read(input);
...
export class RemoveDocFiltersFromUserGroupsArgs {
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.userOrGroups != null) {
            output.writeFieldBegin("userOrGroups", thrift.Thrift.Type.LIST, 3);
            output.writeListBegin(thrift.Thrift.Type.STRUCT, this.userOrGroups.length);
            this.userOrGroups.forEach((value_23: __ROOT_NAMESPACE__.UserOrGroup): void => {
    ...
    public static read(input: thrift.TProtocol): RemoveDocFiltersFromUserGroupsArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 3:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_27: Array<__ROOT_NAMESPACE__.UserOrGroup> = new Array<__ROOT_NAMESPACE__.UserOrGroup>();
                        const metadata_5: thrift.TList = input.readListBegin();
                        const size_5: number = metadata_5.size;
                        for (let i_5: number = 0; i_5 < size_5; i_5++) {
                            const value_28: __ROOT_NAMESPACE__.UserOrGroup = __ROOT_NAMESPACE__.UserOrGroup.read(input);
            ...
            switch (fieldId) {
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.I32) {
                        const value_30: __ROOT_NAMESPACE__.UserOrGroupType = input.readI32();
                        _args.type = value_30;
                    }
                    else {
                        input.skip(fieldType);
    ...
    public static read(input: thrift.TProtocol): GetCountAllDeclaredColumnArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_55: __ROOT_NAMESPACE__.KazFilter = __ROOT_NAMESPACE__.KazFilter.read(input);
    ...
    public static read(input: thrift.TProtocol): GetAllDeclaredColumnArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_57: __ROOT_NAMESPACE__.KazFilter = __ROOT_NAMESPACE__.KazFilter.read(input);
...
export interface IChangeDeclaredColumnsArgsArgs {
    token: string;
    toUpdate: Array<__ROOT_NAMESPACE__.DocColumn>;
    toRemove: Array<string>;
}
export class ChangeDeclaredColumnsArgs {
    public token: string;
    public toUpdate: Array<__ROOT_NAMESPACE__.DocColumn>;
    public toRemove: Array<string>;
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.toUpdate != null) {
            output.writeFieldBegin("toUpdate", thrift.Thrift.Type.LIST, 2);
            output.writeListBegin(thrift.Thrift.Type.STRUCT, this.toUpdate.length);
            this.toUpdate.forEach((value_58: __ROOT_NAMESPACE__.DocColumn): void => {
    ...
    public static read(input: thrift.TProtocol): ChangeDeclaredColumnsArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_61: Array<__ROOT_NAMESPACE__.DocColumn> = new Array<__ROOT_NAMESPACE__.DocColumn>();
                        const metadata_9: thrift.TList = input.readListBegin();
                        const size_9: number = metadata_9.size;
                        for (let i_9: number = 0; i_9 < size_9; i_9++) {
                            const value_62: __ROOT_NAMESPACE__.DocColumn = __ROOT_NAMESPACE__.DocColumn.read(input);
...
export class ChangeUserPreferencesColumnArgs {
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.toUpdate != null) {
            output.writeFieldBegin("toUpdate", thrift.Thrift.Type.LIST, 2);
            output.writeListBegin(thrift.Thrift.Type.STRUCT, this.toUpdate.length);
            this.toUpdate.forEach((value_65: __ROOT_NAMESPACE__.DocColumn): void => {
    ...
    public static read(input: thrift.TProtocol): ChangeUserPreferencesColumnArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_68: Array<__ROOT_NAMESPACE__.DocColumn> = new Array<__ROOT_NAMESPACE__.DocColumn>();
                        ...
                        for (let i_11: number = 0; i_11 < size_11; i_11++) {
                            const value_69: __ROOT_NAMESPACE__.DocColumn = __ROOT_NAMESPACE__.DocColumn.read(input);
    ...
    public static read(input: thrift.TProtocol): GetAllAggregateColumnsForDocumentsArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_77: __ROOT_NAMESPACE__.KazFilter = __ROOT_NAMESPACE__.KazFilter.read(input);
...
export class ChangeCustomDocFilterColumnsArgs {
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.toSave != null) {
            ...
            this.toSave.forEach((value_82: __ROOT_NAMESPACE__.DocColumn): void => {
    ...
    public static read(input: thrift.TProtocol): ChangeCustomDocFilterColumnsArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 4:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_86: Array<__ROOT_NAMESPACE__.DocColumn> = new Array<__ROOT_NAMESPACE__.DocColumn>();
                        ...
                        for (let i_13: number = 0; i_13 < size_13; i_13++) {
                            const value_87: __ROOT_NAMESPACE__.DocColumn = __ROOT_NAMESPACE__.DocColumn.read(input);
    ...
    public static read(input: thrift.TProtocol): GetAllColumnsForCustomDocFilterWithSortingFieldArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 3:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_90: __ROOT_NAMESPACE__.KazFilter = __ROOT_NAMESPACE__.KazFilter.read(input);
...
export class GetAllUserOrGroupsByDocFilterIdResult {
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.success != null) {
            output.writeFieldBegin("success", thrift.Thrift.Type.LIST, 0);
            output.writeListBegin(thrift.Thrift.Type.STRUCT, this.success.length);
            this.success.forEach((value_123: __ROOT_NAMESPACE__.UserOrGroup): void => {
    ...
    public static read(input: thrift.TProtocol): GetAllUserOrGroupsByDocFilterIdResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_124: Array<__ROOT_NAMESPACE__.UserOrGroup> = new Array<__ROOT_NAMESPACE__.UserOrGroup>();
                        ...
                        for (let i_16: number = 0; i_16 < size_16; i_16++) {
                            const value_125: __ROOT_NAMESPACE__.UserOrGroup = __ROOT_NAMESPACE__.UserOrGroup.read(input);
    ...
    public static read(input: thrift.TProtocol): ImportDocFiltersResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_134: __ROOT_NAMESPACE__.PreconditionException = __ROOT_NAMESPACE__.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_135: __ROOT_NAMESPACE__.ServerException = __ROOT_NAMESPACE__.ServerException.read(input);
    ...
    public static read(input: thrift.TProtocol): GetDocFilterUserDefineListResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_139: __ROOT_NAMESPACE__.PreconditionException = __ROOT_NAMESPACE__.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_140: __ROOT_NAMESPACE__.ServerException = __ROOT_NAMESPACE__.ServerException.read(input);
    ...
    public static read(input: thrift.TProtocol): CheckCustomDocFiltersResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_147: __ROOT_NAMESPACE__.PreconditionException = __ROOT_NAMESPACE__.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_148: __ROOT_NAMESPACE__.ServerException = __ROOT_NAMESPACE__.ServerException.read(input);
...
export class GetAllDeclaredColumnResult {
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.success != null) {
            output.writeFieldBegin("success", thrift.Thrift.Type.LIST, 0);
            output.writeListBegin(thrift.Thrift.Type.STRUCT, this.success.length);
            this.success.forEach((value_152: __ROOT_NAMESPACE__.DocColumn): void => {
    ...
    public static read(input: thrift.TProtocol): GetAllDeclaredColumnResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_153: Array<__ROOT_NAMESPACE__.DocColumn> = new Array<__ROOT_NAMESPACE__.DocColumn>();
                        ...
                        for (let i_20: number = 0; i_20 < size_20; i_20++) {
                            const value_154: __ROOT_NAMESPACE__.DocColumn = __ROOT_NAMESPACE__.DocColumn.read(input);
...
export class ChangeUserPreferencesColumnResult {
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.success != null) {
            output.writeFieldBegin("success", thrift.Thrift.Type.LIST, 0);
            output.writeListBegin(thrift.Thrift.Type.STRUCT, this.success.length);
            this.success.forEach((value_160: __ROOT_NAMESPACE__.DocColumn): void => {
    ...
    public static read(input: thrift.TProtocol): ChangeUserPreferencesColumnResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_161: Array<__ROOT_NAMESPACE__.DocColumn> = new Array<__ROOT_NAMESPACE__.DocColumn>();
                        ...
                        for (let i_21: number = 0; i_21 < size_21; i_21++) {
                            const value_162: __ROOT_NAMESPACE__.DocColumn = __ROOT_NAMESPACE__.DocColumn.read(input);
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_163: __ROOT_NAMESPACE__.PreconditionException = __ROOT_NAMESPACE__.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_164: __ROOT_NAMESPACE__.ServerException = __ROOT_NAMESPACE__.ServerException.read(input);
...
export class GetAllUserPreferencesColumnResult {
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.success != null) {
            output.writeFieldBegin("success", thrift.Thrift.Type.LIST, 0);
            output.writeListBegin(thrift.Thrift.Type.STRUCT, this.success.length);
            this.success.forEach((value_165: __ROOT_NAMESPACE__.DocColumn): void => {
    ...
    public static read(input: thrift.TProtocol): GetAllUserPreferencesColumnResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_166: Array<__ROOT_NAMESPACE__.DocColumn> = new Array<__ROOT_NAMESPACE__.DocColumn>();
                        ...
                        for (let i_22: number = 0; i_22 < size_22; i_22++) {
                            const value_167: __ROOT_NAMESPACE__.DocColumn = __ROOT_NAMESPACE__.DocColumn.read(input);
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_168: __ROOT_NAMESPACE__.PreconditionException = __ROOT_NAMESPACE__.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_169: __ROOT_NAMESPACE__.ServerException = __ROOT_NAMESPACE__.ServerException.read(input);
...
export class GetAllAggregateColumnsForDocumentsResult {
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.success != null) {
            output.writeFieldBegin("success", thrift.Thrift.Type.LIST, 0);
            output.writeListBegin(thrift.Thrift.Type.STRUCT, this.success.length);
            this.success.forEach((value_170: __ROOT_NAMESPACE__.DocColumn): void => {
    ...
    public static read(input: thrift.TProtocol): GetAllAggregateColumnsForDocumentsResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_171: Array<__ROOT_NAMESPACE__.DocColumn> = new Array<__ROOT_NAMESPACE__.DocColumn>();
                        ...
                        for (let i_23: number = 0; i_23 < size_23; i_23++) {
                            const value_172: __ROOT_NAMESPACE__.DocColumn = __ROOT_NAMESPACE__.DocColumn.read(input);
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_173: __ROOT_NAMESPACE__.PreconditionException = __ROOT_NAMESPACE__.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_174: __ROOT_NAMESPACE__.ServerException = __ROOT_NAMESPACE__.ServerException.read(input);
...
export class GetAllColumnsForCustomDocFilterResult {
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.success != null) {
            output.writeFieldBegin("success", thrift.Thrift.Type.LIST, 0);
            output.writeListBegin(thrift.Thrift.Type.STRUCT, this.success.length);
            this.success.forEach((value_175: __ROOT_NAMESPACE__.DocColumn): void => {
    ...
    public static read(input: thrift.TProtocol): GetAllColumnsForCustomDocFilterResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_176: Array<__ROOT_NAMESPACE__.DocColumn> = new Array<__ROOT_NAMESPACE__.DocColumn>();
                        ...
                        for (let i_24: number = 0; i_24 < size_24; i_24++) {
                            const value_177: __ROOT_NAMESPACE__.DocColumn = __ROOT_NAMESPACE__.DocColumn.read(input);
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_178: __ROOT_NAMESPACE__.PreconditionException = __ROOT_NAMESPACE__.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_179: __ROOT_NAMESPACE__.ServerException = __ROOT_NAMESPACE__.ServerException.read(input);
    ...
    public static read(input: thrift.TProtocol): ChangeCustomDocFilterColumnsResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_181: __ROOT_NAMESPACE__.PreconditionException = __ROOT_NAMESPACE__.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_182: __ROOT_NAMESPACE__.ServerException = __ROOT_NAMESPACE__.ServerException.read(input);
    ...
    public static read(input: thrift.TProtocol): GetAllColumnsForCustomDocFilterWithSortingFieldResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_184: __ROOT_NAMESPACE__.PreconditionException = __ROOT_NAMESPACE__.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_185: __ROOT_NAMESPACE__.ServerException = __ROOT_NAMESPACE__.ServerException.read(input);
    ...
    public static read(input: thrift.TProtocol): ChangeCustomDocFilterColumnsAndDefaultSortingFieldResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_187: __ROOT_NAMESPACE__.PreconditionException = __ROOT_NAMESPACE__.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_188: __ROOT_NAMESPACE__.ServerException = __ROOT_NAMESPACE__.ServerException.read(input);
...
export class Client {
    ...
    public getAllCustomDocFilters(token: string, filter: __ROOT_NAMESPACE__.KazFilter, personal: boolean): Promise<Array<DocFilter.DocFilter>> {
    ...
    public addDocFiltersToUserGroups(token: string, docFilterIds: Array<string>, userOrGroups: Array<__ROOT_NAMESPACE__.UserOrGroup>): Promise<boolean> {
        const requestId: number = this.incrementSeqId();
        return new Promise<boolean>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
    ...
    public removeDocFiltersFromUserGroups(token: string, docFilterIds: Array<string>, userOrGroups: Array<__ROOT_NAMESPACE__.UserOrGroup>): Promise<boolean> {
        const requestId: number = this.incrementSeqId();
        return new Promise<boolean>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
    ...
    public getAllDocFiltersByUserOrGroup(token: string, type: __ROOT_NAMESPACE__.UserOrGroupType, userOrGroupId: string, filter: __ROOT_NAMESPACE__.KazFilter): Promise<Array<DocFilter.DocFilter>> {
        const requestId: number = this.incrementSeqId();
        return new Promise<Array<DocFilter.DocFilter>>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
    ...
    public getAllUserOrGroupsByDocFilterId(token: string, docFilterId: string, filter: __ROOT_NAMESPACE__.KazFilter): Promise<Array<__ROOT_NAMESPACE__.UserOrGroup>> {
        const requestId: number = this.incrementSeqId();
    ...
    public getDocFilterUserDefineList(token: string, filter: __ROOT_NAMESPACE__.KazFilter): Promise<Array<DocFilter.DocFilter>> {
        const requestId: number = this.incrementSeqId();
        return new Promise<Array<DocFilter.DocFilter>>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
    ...
    public checkCustomDocFilters(token: string, filter: __ROOT_NAMESPACE__.KazFilter): Promise<Array<string>> {
        const requestId: number = this.incrementSeqId();
    ...
    public getCountAllDeclaredColumn(token: string, filter: __ROOT_NAMESPACE__.KazFilter): Promise<Int64> {
        const requestId: number = this.incrementSeqId();
    ...
    public getAllDeclaredColumn(token: string, filter: __ROOT_NAMESPACE__.KazFilter): Promise<Array<__ROOT_NAMESPACE__.DocColumn>> {
        const requestId: number = this.incrementSeqId();
    ...
    public changeDeclaredColumns(token: string, toUpdate: Array<__ROOT_NAMESPACE__.DocColumn>, toRemove: Array<string>): Promise<boolean> {
        const requestId: number = this.incrementSeqId();
        return new Promise<boolean>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
    ...
    public changeUserPreferencesColumn(token: string, toUpdate: Array<__ROOT_NAMESPACE__.DocColumn>, toRemove: Array<string>, forRegistry: boolean): Promise<Array<__ROOT_NAMESPACE__.DocColumn>> {
        const requestId: number = this.incrementSeqId();
        return new Promise<Array<__ROOT_NAMESPACE__.DocColumn>>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
    ...
    public getAllUserPreferencesColumn(token: string, registryId: string, filter: __ROOT_NAMESPACE__.KazFilter): Promise<Array<__ROOT_NAMESPACE__.DocColumn>> {
        const requestId: number = this.incrementSeqId();
        return new Promise<Array<__ROOT_NAMESPACE__.DocColumn>>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
    ...
    public getAllAggregateColumnsForDocuments(token: string, filter: __ROOT_NAMESPACE__.KazFilter, registryId: string): Promise<Array<__ROOT_NAMESPACE__.DocColumn>> {
        const requestId: number = this.incrementSeqId();
        return new Promise<Array<__ROOT_NAMESPACE__.DocColumn>>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
    ...
    public getAllColumnsForCustomDocFilter(token: string, customDocFilterId: string, filter: __ROOT_NAMESPACE__.KazFilter): Promise<Array<__ROOT_NAMESPACE__.DocColumn>> {
        const requestId: number = this.incrementSeqId();
        return new Promise<Array<__ROOT_NAMESPACE__.DocColumn>>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
    ...
    public changeCustomDocFilterColumns(token: string, customDocFilterId: string, useDefaultColumns: boolean, toSave: Array<__ROOT_NAMESPACE__.DocColumn>): Promise<boolean> {
        const requestId: number = this.incrementSeqId();
        return new Promise<boolean>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
    ...
    public getAllColumnsForCustomDocFilterWithSortingField(token: string, customDocFilterId: string, filter: __ROOT_NAMESPACE__.KazFilter): Promise<DocFiltersWithSortColumn.DocFiltersWithSortColumn> {
        const requestId: number = this.incrementSeqId();
    ...
    public send_getAllCustomDocFilters(token: string, filter: __ROOT_NAMESPACE__.KazFilter, personal: boolean, requestId: number): void {
    ...
    public send_addDocFiltersToUserGroups(token: string, docFilterIds: Array<string>, userOrGroups: Array<__ROOT_NAMESPACE__.UserOrGroup>, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_removeDocFiltersFromUserGroups(token: string, docFilterIds: Array<string>, userOrGroups: Array<__ROOT_NAMESPACE__.UserOrGroup>, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_getAllDocFiltersByUserOrGroup(token: string, type: __ROOT_NAMESPACE__.UserOrGroupType, userOrGroupId: string, filter: __ROOT_NAMESPACE__.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_getAllUserOrGroupsByDocFilterId(token: string, docFilterId: string, filter: __ROOT_NAMESPACE__.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_getDocFilterUserDefineList(token: string, filter: __ROOT_NAMESPACE__.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_checkCustomDocFilters(token: string, filter: __ROOT_NAMESPACE__.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_getCountAllDeclaredColumn(token: string, filter: __ROOT_NAMESPACE__.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_getAllDeclaredColumn(token: string, filter: __ROOT_NAMESPACE__.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_changeDeclaredColumns(token: string, toUpdate: Array<__ROOT_NAMESPACE__.DocColumn>, toRemove: Array<string>, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_changeUserPreferencesColumn(token: string, toUpdate: Array<__ROOT_NAMESPACE__.DocColumn>, toRemove: Array<string>, forRegistry: boolean, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_getAllUserPreferencesColumn(token: string, registryId: string, filter: __ROOT_NAMESPACE__.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_getAllAggregateColumnsForDocuments(token: string, filter: __ROOT_NAMESPACE__.KazFilter, registryId: string, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_getAllColumnsForCustomDocFilter(token: string, customDocFilterId: string, filter: __ROOT_NAMESPACE__.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_changeCustomDocFilterColumns(token: string, customDocFilterId: string, useDefaultColumns: boolean, toSave: Array<__ROOT_NAMESPACE__.DocColumn>, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_getAllColumnsForCustomDocFilterWithSortingField(token: string, customDocFilterId: string, filter: __ROOT_NAMESPACE__.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
...
export interface IHandler {
    getAllCustomDocFilters(token: string, filter: __ROOT_NAMESPACE__.KazFilter, personal: boolean): Array<DocFilter.DocFilter> | Promise<Array<DocFilter.DocFilter>>;
    ...
    addDocFiltersToUserGroups(token: string, docFilterIds: Array<string>, userOrGroups: Array<__ROOT_NAMESPACE__.UserOrGroup>): boolean | Promise<boolean>;
    removeDocFiltersFromUserGroups(token: string, docFilterIds: Array<string>, userOrGroups: Array<__ROOT_NAMESPACE__.UserOrGroup>): boolean | Promise<boolean>;
    getAllDocFiltersByUserOrGroup(token: string, type: __ROOT_NAMESPACE__.UserOrGroupType, userOrGroupId: string, filter: __ROOT_NAMESPACE__.KazFilter): Array<DocFilter.DocFilter> | Promise<Array<DocFilter.DocFilter>>;
    getAllUserOrGroupsByDocFilterId(token: string, docFilterId: string, filter: __ROOT_NAMESPACE__.KazFilter): Array<__ROOT_NAMESPACE__.UserOrGroup> | Promise<Array<__ROOT_NAMESPACE__.UserOrGroup>>;
    ...
    getDocFilterUserDefineList(token: string, filter: __ROOT_NAMESPACE__.KazFilter): Array<DocFilter.DocFilter> | Promise<Array<DocFilter.DocFilter>>;
    changeDocFilterUserDefine(token: string, toUpdate: Array<DocFilter.DocFilter>, toRemove: Array<string>): boolean | Promise<boolean>;
    checkCustomDocFilters(token: string, filter: __ROOT_NAMESPACE__.KazFilter): Array<string> | Promise<Array<string>>;
    getCountAllDeclaredColumn(token: string, filter: __ROOT_NAMESPACE__.KazFilter): Int64 | Promise<Int64>;
    getAllDeclaredColumn(token: string, filter: __ROOT_NAMESPACE__.KazFilter): Array<__ROOT_NAMESPACE__.DocColumn> | Promise<Array<__ROOT_NAMESPACE__.DocColumn>>;
    changeDeclaredColumns(token: string, toUpdate: Array<__ROOT_NAMESPACE__.DocColumn>, toRemove: Array<string>): boolean | Promise<boolean>;
    changeUserPreferencesColumn(token: string, toUpdate: Array<__ROOT_NAMESPACE__.DocColumn>, toRemove: Array<string>, forRegistry: boolean): Array<__ROOT_NAMESPACE__.DocColumn> | Promise<Array<__ROOT_NAMESPACE__.DocColumn>>;
    getAllUserPreferencesColumn(token: string, registryId: string, filter: __ROOT_NAMESPACE__.KazFilter): Array<__ROOT_NAMESPACE__.DocColumn> | Promise<Array<__ROOT_NAMESPACE__.DocColumn>>;
    getAllAggregateColumnsForDocuments(token: string, filter: __ROOT_NAMESPACE__.KazFilter, registryId: string): Array<__ROOT_NAMESPACE__.DocColumn> | Promise<Array<__ROOT_NAMESPACE__.DocColumn>>;
    getAllColumnsForCustomDocFilter(token: string, customDocFilterId: string, filter: __ROOT_NAMESPACE__.KazFilter): Array<__ROOT_NAMESPACE__.DocColumn> | Promise<Array<__ROOT_NAMESPACE__.DocColumn>>;
    changeCustomDocFilterColumns(token: string, customDocFilterId: string, useDefaultColumns: boolean, toSave: Array<__ROOT_NAMESPACE__.DocColumn>): boolean | Promise<boolean>;
    getAllColumnsForCustomDocFilterWithSortingField(token: string, customDocFilterId: string, filter: __ROOT_NAMESPACE__.KazFilter): DocFiltersWithSortColumn.DocFiltersWithSortColumn | Promise<DocFiltersWithSortColumn.DocFiltersWithSortColumn>;
