...
export interface IRegistryArgs {
    ...
    viewRule?: string;
    userOrGrList?: Array<__ROOT_NAMESPACE__.UserOrGroup>;
    ...
    columns?: Array<__ROOT_NAMESPACE__.DocColumn>;
...
export class Registry {
    ...
    public userOrGrList?: Array<__ROOT_NAMESPACE__.UserOrGroup>;
    ...
    public columns?: Array<__ROOT_NAMESPACE__.DocColumn>;
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.userOrGrList != null) {
            ...
            this.userOrGrList.forEach((value_1: __ROOT_NAMESPACE__.UserOrGroup): void => {
        ...
        if (this.accountList != null) {
            ...
            this.accountList.forEach((value_2: __ROOT_NAMESPACE__.Account): void => {
        ...
        if (this.columns != null) {
            ...
            this.columns.forEach((value_5: __ROOT_NAMESPACE__.DocColumn): void => {
            ...
            switch (fieldId) {
                ...
                case 5:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_10: Array<__ROOT_NAMESPACE__.UserOrGroup> = new Array<__ROOT_NAMESPACE__.UserOrGroup>();
                ...
                case 6:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_12: Array<__ROOT_NAMESPACE__.Account> = new Array<__ROOT_NAMESPACE__.Account>();
                ...
                case 12:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_21: Array<__ROOT_NAMESPACE__.DocColumn> = new Array<__ROOT_NAMESPACE__.DocColumn>();
                        const metadata_5: thrift.TList = input.readListBegin();
                        const size_5: number = metadata_5.size;
                        for (let i_5: number = 0; i_5 < size_5; i_5++) {
                            const value_22: __ROOT_NAMESPACE__.DocColumn = __ROOT_NAMESPACE__.DocColumn.read(input);
