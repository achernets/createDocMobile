...
export interface IDocumentPatternStagesLinkArgs {
    ...
    movePriority?: number;
    informUsers?: Array<__ROOT_NAMESPACE__.UserOrGroup>;
    accessRule?: AccessRule.AccessRule;
    allowForCurUser?: boolean;
    useByDefault?: boolean;
    resolution?: __ROOT_NAMESPACE__.DocPatternStageRequirement;
    signature?: __ROOT_NAMESPACE__.DocPatternStageRequirement;
    autoExecute?: boolean;
    jiraPeriod?: string;
    comment?: string;
    ...
    attachmentRequirement?: __ROOT_NAMESPACE__.DocPatternStageRequirement;
...
export class DocumentPatternStagesLink {
    ...
    public informUsers?: Array<__ROOT_NAMESPACE__.UserOrGroup>;
    public accessRule?: AccessRule.AccessRule;
    public allowForCurUser?: boolean;
    public useByDefault?: boolean;
    public resolution?: __ROOT_NAMESPACE__.DocPatternStageRequirement;
    public signature?: __ROOT_NAMESPACE__.DocPatternStageRequirement;
    ...
    public attachmentRequirement?: __ROOT_NAMESPACE__.DocPatternStageRequirement;
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.informUsers != null) {
            ...
            this.informUsers.forEach((value_1: __ROOT_NAMESPACE__.UserOrGroup): void => {
            ...
            switch (fieldId) {
                ...
                case 10:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_13: Array<__ROOT_NAMESPACE__.UserOrGroup> = new Array<__ROOT_NAMESPACE__.UserOrGroup>();
                        const metadata_1: thrift.TList = input.readListBegin();
                        const size_1: number = metadata_1.size;
                        for (let i_1: number = 0; i_1 < size_1; i_1++) {
                            const value_14: __ROOT_NAMESPACE__.UserOrGroup = __ROOT_NAMESPACE__.UserOrGroup.read(input);
                ...
                case 14:
                    if (fieldType === thrift.Thrift.Type.I32) {
                        const value_18: __ROOT_NAMESPACE__.DocPatternStageRequirement = input.readI32();
                ...
                case 15:
                    if (fieldType === thrift.Thrift.Type.I32) {
                        const value_19: __ROOT_NAMESPACE__.DocPatternStageRequirement = input.readI32();
                ...
                case 22:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_26: __ROOT_NAMESPACE__.CompositeId = __ROOT_NAMESPACE__.CompositeId.read(input);
                ...
                case 27:
                    if (fieldType === thrift.Thrift.Type.I32) {
                        const value_31: __ROOT_NAMESPACE__.DocPatternStageRequirement = input.readI32();
