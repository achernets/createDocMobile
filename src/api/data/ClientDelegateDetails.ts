...
export interface IClientDelegateDetailsArgs {
    ...
    docPatternGroup?: __ROOT_NAMESPACE__.DocumentPatternGroup;
    docPattern?: __ROOT_NAMESPACE__.DocumentPattern;
    actionTypes?: Set<__ROOT_NAMESPACE__.DocPatternStageActionType>;
...
export class ClientDelegateDetails {
    ...
    public docPatternGroup?: __ROOT_NAMESPACE__.DocumentPatternGroup;
    public docPattern?: __ROOT_NAMESPACE__.DocumentPattern;
    public actionTypes?: Set<__ROOT_NAMESPACE__.DocPatternStageActionType>;
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.actionTypes != null) {
            ...
            this.actionTypes.forEach((value_1: __ROOT_NAMESPACE__.DocPatternStageActionType): void => {
    ...
    public static read(input: thrift.TProtocol): ClientDelegateDetails {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 5:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_6: __ROOT_NAMESPACE__.DocumentPatternGroup = __ROOT_NAMESPACE__.DocumentPatternGroup.read(input);
                ...
                case 6:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_7: __ROOT_NAMESPACE__.DocumentPattern = __ROOT_NAMESPACE__.DocumentPattern.read(input);
                ...
                case 7:
                    if (fieldType === thrift.Thrift.Type.SET) {
                        const value_8: Set<__ROOT_NAMESPACE__.DocPatternStageActionType> = new Set<__ROOT_NAMESPACE__.DocPatternStageActionType>();
                        const metadata_1: thrift.TSet = input.readSetBegin();
                        const size_1: number = metadata_1.size;
                        for (let i_1: number = 0; i_1 < size_1; i_1++) {
                            const value_9: __ROOT_NAMESPACE__.DocPatternStageActionType = input.readI32();
                            value_8.add(value_9);
                        }
                        input.readSetEnd();
