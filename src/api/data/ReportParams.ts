            ...
            switch (fieldId) {
                ...
                case 7:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_8: __ROOT_NAMESPACE__.HandBook = __ROOT_NAMESPACE__.HandBook.read(input);
                ...
                case 10:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_11: __ROOT_NAMESPACE__.HBRow = __ROOT_NAMESPACE__.HBRow.read(input);
                        _args.row = value_11;
                    }
                    else {
                        input.skip(fieldType);
                ...
                case 12:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_13: __ROOT_NAMESPACE__.Department = __ROOT_NAMESPACE__.Department.read(input);
