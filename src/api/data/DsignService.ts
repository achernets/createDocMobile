...
export interface ISingAnyDataArgsArgs {
    token: string;
    keyInfoList: Array<__ROOT_NAMESPACE__.SignKeyInfo>;
    dataToSignList: Array<__ROOT_NAMESPACE__.SignData>;
}
export class SingAnyDataArgs {
    public token: string;
    public keyInfoList: Array<__ROOT_NAMESPACE__.SignKeyInfo>;
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.keyInfoList != null) {
            ...
            this.keyInfoList.forEach((value_41: __ROOT_NAMESPACE__.SignKeyInfo): void => {
        ...
        if (this.dataToSignList != null) {
            ...
            this.dataToSignList.forEach((value_42: __ROOT_NAMESPACE__.SignData): void => {
    ...
    public static read(input: thrift.TProtocol): SingAnyDataArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_44: Array<__ROOT_NAMESPACE__.SignKeyInfo> = new Array<__ROOT_NAMESPACE__.SignKeyInfo>();
                        const metadata_3: thrift.TList = input.readListBegin();
                        const size_3: number = metadata_3.size;
                        for (let i_3: number = 0; i_3 < size_3; i_3++) {
                            const value_45: __ROOT_NAMESPACE__.SignKeyInfo = __ROOT_NAMESPACE__.SignKeyInfo.read(input);
                ...
                case 3:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_46: Array<__ROOT_NAMESPACE__.SignData> = new Array<__ROOT_NAMESPACE__.SignData>();
                        const metadata_4: thrift.TList = input.readListBegin();
                        const size_4: number = metadata_4.size;
                        for (let i_4: number = 0; i_4 < size_4; i_4++) {
                            const value_47: __ROOT_NAMESPACE__.SignData = __ROOT_NAMESPACE__.SignData.read(input);
...
export class SignInExternalServiceArgs {
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.dataToSignList != null) {
            output.writeFieldBegin("dataToSignList", thrift.Thrift.Type.LIST, 3);
            output.writeListBegin(thrift.Thrift.Type.STRUCT, this.dataToSignList.length);
            this.dataToSignList.forEach((value_48: __ROOT_NAMESPACE__.SignData): void => {
    ...
    public static read(input: thrift.TProtocol): SignInExternalServiceArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 3:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_51: Array<__ROOT_NAMESPACE__.SignData> = new Array<__ROOT_NAMESPACE__.SignData>();
                        const metadata_5: thrift.TList = input.readListBegin();
                        const size_5: number = metadata_5.size;
                        for (let i_5: number = 0; i_5 < size_5; i_5++) {
                            const value_52: __ROOT_NAMESPACE__.SignData = __ROOT_NAMESPACE__.SignData.read(input);
...
export interface IExtractPublicKeyInfoArgsArgs {
    token: string;
    keyInfo: __ROOT_NAMESPACE__.SignKeyInfo;
}
export class ExtractPublicKeyInfoArgs {
    public token: string;
    public keyInfo: __ROOT_NAMESPACE__.SignKeyInfo;
    ...
    public static read(input: thrift.TProtocol): ExtractPublicKeyInfoArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_57: __ROOT_NAMESPACE__.SignKeyInfo = __ROOT_NAMESPACE__.SignKeyInfo.read(input);
    ...
    public static read(input: thrift.TProtocol): AddToCurrentBulkSignJobArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 3:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_71: __ROOT_NAMESPACE__.DocumentAccessPolicy = __ROOT_NAMESPACE__.DocumentAccessPolicy.read(input);
...
export class SignBulkJobArgs {
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.keyInfoList != null) {
            output.writeFieldBegin("keyInfoList", thrift.Thrift.Type.LIST, 2);
            output.writeListBegin(thrift.Thrift.Type.STRUCT, this.keyInfoList.length);
            this.keyInfoList.forEach((value_73: __ROOT_NAMESPACE__.SignKeyInfo): void => {
    ...
    public static read(input: thrift.TProtocol): SignBulkJobArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_75: Array<__ROOT_NAMESPACE__.SignKeyInfo> = new Array<__ROOT_NAMESPACE__.SignKeyInfo>();
                        const metadata_6: thrift.TList = input.readListBegin();
                        const size_6: number = metadata_6.size;
                        for (let i_6: number = 0; i_6 < size_6; i_6++) {
                            const value_76: __ROOT_NAMESPACE__.SignKeyInfo = __ROOT_NAMESPACE__.SignKeyInfo.read(input);
    ...
    public static read(input: thrift.TProtocol): GetTimeStampTokenResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_85: __ROOT_NAMESPACE__.PreconditionException = __ROOT_NAMESPACE__.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_86: __ROOT_NAMESPACE__.ServerException = __ROOT_NAMESPACE__.ServerException.read(input);
...
export interface IGetCertificateInfoResultArgs {
    success?: Array<__ROOT_NAMESPACE__.CertificateInfo>;
    validError?: __ROOT_NAMESPACE__.PreconditionException;
    error?: __ROOT_NAMESPACE__.ServerException;
}
export class GetCertificateInfoResult {
    public success?: Array<__ROOT_NAMESPACE__.CertificateInfo>;
    public validError?: __ROOT_NAMESPACE__.PreconditionException;
    public error?: __ROOT_NAMESPACE__.ServerException;
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.success != null) {
            output.writeFieldBegin("success", thrift.Thrift.Type.LIST, 0);
            output.writeListBegin(thrift.Thrift.Type.STRUCT, this.success.length);
            this.success.forEach((value_98: __ROOT_NAMESPACE__.CertificateInfo): void => {
    ...
    public static read(input: thrift.TProtocol): GetCertificateInfoResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_99: Array<__ROOT_NAMESPACE__.CertificateInfo> = new Array<__ROOT_NAMESPACE__.CertificateInfo>();
                        const metadata_8: thrift.TList = input.readListBegin();
                        const size_8: number = metadata_8.size;
                        for (let i_8: number = 0; i_8 < size_8; i_8++) {
                            const value_100: __ROOT_NAMESPACE__.CertificateInfo = __ROOT_NAMESPACE__.CertificateInfo.read(input);
...
export interface IGetCertificateInfoListByUserResultArgs {
    success?: Array<__ROOT_NAMESPACE__.UserKeyData>;
    validError?: __ROOT_NAMESPACE__.PreconditionException;
    error?: __ROOT_NAMESPACE__.ServerException;
}
export class GetCertificateInfoListByUserResult {
    public success?: Array<__ROOT_NAMESPACE__.UserKeyData>;
    public validError?: __ROOT_NAMESPACE__.PreconditionException;
    public error?: __ROOT_NAMESPACE__.ServerException;
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.success != null) {
            output.writeFieldBegin("success", thrift.Thrift.Type.LIST, 0);
            output.writeListBegin(thrift.Thrift.Type.STRUCT, this.success.length);
            this.success.forEach((value_103: __ROOT_NAMESPACE__.UserKeyData): void => {
    ...
    public static read(input: thrift.TProtocol): GetCertificateInfoListByUserResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_104: Array<__ROOT_NAMESPACE__.UserKeyData> = new Array<__ROOT_NAMESPACE__.UserKeyData>();
                        const metadata_9: thrift.TList = input.readListBegin();
                        const size_9: number = metadata_9.size;
                        for (let i_9: number = 0; i_9 < size_9; i_9++) {
                            const value_105: __ROOT_NAMESPACE__.UserKeyData = __ROOT_NAMESPACE__.UserKeyData.read(input);
...
export interface IGetSignInfoByCertificateResultArgs {
    success?: __ROOT_NAMESPACE__.CertificateInfo;
    validError?: __ROOT_NAMESPACE__.PreconditionException;
    error?: __ROOT_NAMESPACE__.ServerException;
}
export class GetSignInfoByCertificateResult {
    public success?: __ROOT_NAMESPACE__.CertificateInfo;
    public validError?: __ROOT_NAMESPACE__.PreconditionException;
    public error?: __ROOT_NAMESPACE__.ServerException;
    ...
    public static read(input: thrift.TProtocol): GetSignInfoByCertificateResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_108: __ROOT_NAMESPACE__.CertificateInfo = __ROOT_NAMESPACE__.CertificateInfo.read(input);
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_109: __ROOT_NAMESPACE__.PreconditionException = __ROOT_NAMESPACE__.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_110: __ROOT_NAMESPACE__.ServerException = __ROOT_NAMESPACE__.ServerException.read(input);
    ...
    public static read(input: thrift.TProtocol): GetSignInfoResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_112: __ROOT_NAMESPACE__.PreconditionException = __ROOT_NAMESPACE__.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_113: __ROOT_NAMESPACE__.ServerException = __ROOT_NAMESPACE__.ServerException.read(input);
...
export interface ISingAnyDataResultArgs {
    success?: Array<__ROOT_NAMESPACE__.SignData>;
    validError?: __ROOT_NAMESPACE__.PreconditionException;
    error?: __ROOT_NAMESPACE__.ServerException;
}
export class SingAnyDataResult {
    public success?: Array<__ROOT_NAMESPACE__.SignData>;
    public validError?: __ROOT_NAMESPACE__.PreconditionException;
    public error?: __ROOT_NAMESPACE__.ServerException;
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.success != null) {
            output.writeFieldBegin("success", thrift.Thrift.Type.LIST, 0);
            output.writeListBegin(thrift.Thrift.Type.STRUCT, this.success.length);
            this.success.forEach((value_134: __ROOT_NAMESPACE__.SignData): void => {
    ...
    public static read(input: thrift.TProtocol): SingAnyDataResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_135: Array<__ROOT_NAMESPACE__.SignData> = new Array<__ROOT_NAMESPACE__.SignData>();
                        ...
                        for (let i_12: number = 0; i_12 < size_12; i_12++) {
                            const value_136: __ROOT_NAMESPACE__.SignData = __ROOT_NAMESPACE__.SignData.read(input);
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_137: __ROOT_NAMESPACE__.PreconditionException = __ROOT_NAMESPACE__.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_138: __ROOT_NAMESPACE__.ServerException = __ROOT_NAMESPACE__.ServerException.read(input);
    ...
    public static read(input: thrift.TProtocol): SignInExternalServiceResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_140: __ROOT_NAMESPACE__.PreconditionException = __ROOT_NAMESPACE__.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_141: __ROOT_NAMESPACE__.ServerException = __ROOT_NAMESPACE__.ServerException.read(input);
    ...
    public static read(input: thrift.TProtocol): CheckSignStatusInExternalServiceResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_143: __ROOT_NAMESPACE__.PreconditionException = __ROOT_NAMESPACE__.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_144: __ROOT_NAMESPACE__.ServerException = __ROOT_NAMESPACE__.ServerException.read(input);
    ...
    public static read(input: thrift.TProtocol): ExtractPublicKeyInfoResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_145: __ROOT_NAMESPACE__.CertificateInfo = __ROOT_NAMESPACE__.CertificateInfo.read(input);
    ...
    public static read(input: thrift.TProtocol): GetCurrentBulkSignJobResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_154: __ROOT_NAMESPACE__.PreconditionException = __ROOT_NAMESPACE__.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_155: __ROOT_NAMESPACE__.ServerException = __ROOT_NAMESPACE__.ServerException.read(input);
    ...
    public static read(input: thrift.TProtocol): GetFullBulkSignJobResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_157: __ROOT_NAMESPACE__.PreconditionException = __ROOT_NAMESPACE__.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_158: __ROOT_NAMESPACE__.ServerException = __ROOT_NAMESPACE__.ServerException.read(input);
    ...
    public static read(input: thrift.TProtocol): CancelBulkJobResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_169: __ROOT_NAMESPACE__.PreconditionException = __ROOT_NAMESPACE__.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_170: __ROOT_NAMESPACE__.ServerException = __ROOT_NAMESPACE__.ServerException.read(input);
...
export class Client {
    ...
    public getAllDigitalSigns(token: string, documentId: string, filter: __ROOT_NAMESPACE__.KazFilter): Promise<Array<DigitalSign.DigitalSign>> {
        const requestId: number = this.incrementSeqId();
    ...
    public getCertificateInfo(token: string, digitalSignId: string): Promise<Array<__ROOT_NAMESPACE__.CertificateInfo>> {
        const requestId: number = this.incrementSeqId();
        return new Promise<Array<__ROOT_NAMESPACE__.CertificateInfo>>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
                if (error != null) {
                    reject(error);
    ...
    public getCertificateInfoListByUser(token: string, userId: string): Promise<Array<__ROOT_NAMESPACE__.UserKeyData>> {
        const requestId: number = this.incrementSeqId();
        return new Promise<Array<__ROOT_NAMESPACE__.UserKeyData>>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
                if (error != null) {
                    reject(error);
    ...
    public getSignInfoByCertificate(token: string, data: string): Promise<__ROOT_NAMESPACE__.CertificateInfo> {
        const requestId: number = this.incrementSeqId();
        return new Promise<__ROOT_NAMESPACE__.CertificateInfo>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
                if (error != null) {
                    reject(error);
    ...
    public getAllPrivateKeys(token: string, filter: __ROOT_NAMESPACE__.KazFilter): Promise<Array<PrivateKeyInfo.PrivateKeyInfo>> {
        const requestId: number = this.incrementSeqId();
    ...
    public getCountPrivateKeys(token: string, filter: __ROOT_NAMESPACE__.KazFilter): Promise<number> {
        const requestId: number = this.incrementSeqId();
    ...
    public singAnyData(token: string, keyInfoList: Array<__ROOT_NAMESPACE__.SignKeyInfo>, dataToSignList: Array<__ROOT_NAMESPACE__.SignData>): Promise<Array<__ROOT_NAMESPACE__.SignData>> {
        const requestId: number = this.incrementSeqId();
        return new Promise<Array<__ROOT_NAMESPACE__.SignData>>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
                if (error != null) {
                    reject(error);
    ...
    public signInExternalService(token: string, serviceKey: string, dataToSignList: Array<__ROOT_NAMESPACE__.SignData>): Promise<ExtSignOperation.ExtSignOperation> {
        const requestId: number = this.incrementSeqId();
    ...
    public extractPublicKeyInfo(token: string, keyInfo: __ROOT_NAMESPACE__.SignKeyInfo): Promise<__ROOT_NAMESPACE__.CertificateInfo> {
        const requestId: number = this.incrementSeqId();
        return new Promise<__ROOT_NAMESPACE__.CertificateInfo>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
    ...
    public getAllExternalSignServiceInfos(token: string, filter: __ROOT_NAMESPACE__.KazFilter): Promise<Array<ExtSignServer.ExtSignServer>> {
        const requestId: number = this.incrementSeqId();
    ...
    public getFullBulkSignJob(token: string, bulkId: string, filter: __ROOT_NAMESPACE__.KazFilter): Promise<BulkSignJob.BulkSignJob> {
        const requestId: number = this.incrementSeqId();
        return new Promise<BulkSignJob.BulkSignJob>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
    ...
    public addToCurrentBulkSignJob(token: string, bulkId: string, accessPolicy: __ROOT_NAMESPACE__.DocumentAccessPolicy, attId: string): Promise<BulkSignInfo.BulkSignInfo> {
        const requestId: number = this.incrementSeqId();
        return new Promise<BulkSignInfo.BulkSignInfo>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
    ...
    public signBulkJob(token: string, keyInfoList: Array<__ROOT_NAMESPACE__.SignKeyInfo>, bulkId: string, setAutoDecision: boolean): Promise<BulkSignJob.BulkSignJob> {
        const requestId: number = this.incrementSeqId();
        return new Promise<BulkSignJob.BulkSignJob>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
    ...
    public send_getAllDigitalSigns(token: string, documentId: string, filter: __ROOT_NAMESPACE__.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_getAllPrivateKeys(token: string, filter: __ROOT_NAMESPACE__.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_getCountPrivateKeys(token: string, filter: __ROOT_NAMESPACE__.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_singAnyData(token: string, keyInfoList: Array<__ROOT_NAMESPACE__.SignKeyInfo>, dataToSignList: Array<__ROOT_NAMESPACE__.SignData>, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_signInExternalService(token: string, serviceKey: string, dataToSignList: Array<__ROOT_NAMESPACE__.SignData>, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_extractPublicKeyInfo(token: string, keyInfo: __ROOT_NAMESPACE__.SignKeyInfo, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_getAllExternalSignServiceInfos(token: string, filter: __ROOT_NAMESPACE__.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_getFullBulkSignJob(token: string, bulkId: string, filter: __ROOT_NAMESPACE__.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_addToCurrentBulkSignJob(token: string, bulkId: string, accessPolicy: __ROOT_NAMESPACE__.DocumentAccessPolicy, attId: string, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_signBulkJob(token: string, keyInfoList: Array<__ROOT_NAMESPACE__.SignKeyInfo>, bulkId: string, setAutoDecision: boolean, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
...
export interface IHandler {
    ...
    getAllDigitalSigns(token: string, documentId: string, filter: __ROOT_NAMESPACE__.KazFilter): Array<DigitalSign.DigitalSign> | Promise<Array<DigitalSign.DigitalSign>>;
    getCertificateInfo(token: string, digitalSignId: string): Array<__ROOT_NAMESPACE__.CertificateInfo> | Promise<Array<__ROOT_NAMESPACE__.CertificateInfo>>;
    getCertificateInfoListByUser(token: string, userId: string): Array<__ROOT_NAMESPACE__.UserKeyData> | Promise<Array<__ROOT_NAMESPACE__.UserKeyData>>;
    getSignInfoByCertificate(token: string, data: string): __ROOT_NAMESPACE__.CertificateInfo | Promise<__ROOT_NAMESPACE__.CertificateInfo>;
    getSignInfo(digitalSignId: string): SignInfo.SignInfo | Promise<SignInfo.SignInfo>;
    getAllPrivateKeys(token: string, filter: __ROOT_NAMESPACE__.KazFilter): Array<PrivateKeyInfo.PrivateKeyInfo> | Promise<Array<PrivateKeyInfo.PrivateKeyInfo>>;
    getCountPrivateKeys(token: string, filter: __ROOT_NAMESPACE__.KazFilter): number | Promise<number>;
    ...
    singAnyData(token: string, keyInfoList: Array<__ROOT_NAMESPACE__.SignKeyInfo>, dataToSignList: Array<__ROOT_NAMESPACE__.SignData>): Array<__ROOT_NAMESPACE__.SignData> | Promise<Array<__ROOT_NAMESPACE__.SignData>>;
    signInExternalService(token: string, serviceKey: string, dataToSignList: Array<__ROOT_NAMESPACE__.SignData>): ExtSignOperation.ExtSignOperation | Promise<ExtSignOperation.ExtSignOperation>;
    ...
    extractPublicKeyInfo(token: string, keyInfo: __ROOT_NAMESPACE__.SignKeyInfo): __ROOT_NAMESPACE__.CertificateInfo | Promise<__ROOT_NAMESPACE__.CertificateInfo>;
    getAllExternalSignServiceInfos(token: string, filter: __ROOT_NAMESPACE__.KazFilter): Array<ExtSignServer.ExtSignServer> | Promise<Array<ExtSignServer.ExtSignServer>>;
    getCurrentBulkSignJob(token: string): BulkSignJob.BulkSignJob | Promise<BulkSignJob.BulkSignJob>;
    getFullBulkSignJob(token: string, bulkId: string, filter: __ROOT_NAMESPACE__.KazFilter): BulkSignJob.BulkSignJob | Promise<BulkSignJob.BulkSignJob>;
    ...
    addToCurrentBulkSignJob(token: string, bulkId: string, accessPolicy: __ROOT_NAMESPACE__.DocumentAccessPolicy, attId: string): BulkSignInfo.BulkSignInfo | Promise<BulkSignInfo.BulkSignInfo>;
    signBulkJob(token: string, keyInfoList: Array<__ROOT_NAMESPACE__.SignKeyInfo>, bulkId: string, setAutoDecision: boolean): BulkSignJob.BulkSignJob | Promise<BulkSignJob.BulkSignJob>;
...
export class Processor {
    ...
    public process_getCertificateInfo(requestId: number, input: thrift.TProtocol, output: thrift.TProtocol): void {
        new Promise<Array<__ROOT_NAMESPACE__.CertificateInfo>>((resolve, reject): void => {
            try {
        ...
        }).then((data: Array<__ROOT_NAMESPACE__.CertificateInfo>): void => {
    ...
    public process_getCertificateInfoListByUser(requestId: number, input: thrift.TProtocol, output: thrift.TProtocol): void {
        new Promise<Array<__ROOT_NAMESPACE__.UserKeyData>>((resolve, reject): void => {
            try {
        ...
        }).then((data: Array<__ROOT_NAMESPACE__.UserKeyData>): void => {
    ...
    public process_getSignInfoByCertificate(requestId: number, input: thrift.TProtocol, output: thrift.TProtocol): void {
        new Promise<__ROOT_NAMESPACE__.CertificateInfo>((resolve, reject): void => {
            try {
        ...
        }).then((data: __ROOT_NAMESPACE__.CertificateInfo): void => {
    ...
    public process_singAnyData(requestId: number, input: thrift.TProtocol, output: thrift.TProtocol): void {
        new Promise<Array<__ROOT_NAMESPACE__.SignData>>((resolve, reject): void => {
            try {
        ...
        }).then((data: Array<__ROOT_NAMESPACE__.SignData>): void => {
