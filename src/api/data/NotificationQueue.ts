...
export interface INotificationQueueArgs {
    ...
    type?: __ROOT_NAMESPACE__.NotificationType;
...
export class NotificationQueue {
    ...
    public type?: __ROOT_NAMESPACE__.NotificationType;
            ...
            switch (fieldId) {
                ...
                case 3:
                    if (fieldType === thrift.Thrift.Type.I32) {
                        const value_5: __ROOT_NAMESPACE__.NotificationType = input.readI32();
                        _args.type = value_5;
                    }
                    else {
                        input.skip(fieldType);
