...
export interface IHistoryDataArgs {
    ...
    authorOriginal?: __ROOT_NAMESPACE__.UserOrGroup;
    docNumber?: string;
    docSysNumber?: string;
    attachmentId?: string;
    ...
    author?: __ROOT_NAMESPACE__.UserOrGroup;
...
export class HistoryData {
    ...
    public authorOriginal?: __ROOT_NAMESPACE__.UserOrGroup;
    ...
    public author?: __ROOT_NAMESPACE__.UserOrGroup;
    ...
    public static read(input: thrift.TProtocol): HistoryData {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 19:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_26: __ROOT_NAMESPACE__.UserOrGroup = __ROOT_NAMESPACE__.UserOrGroup.read(input);
