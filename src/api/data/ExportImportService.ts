...
export class Client {
    ...
    public getAllImportData(token: string, filter: __ROOT_NAMESPACE__.KazFilter): Promise<Array<ImportData.ImportData>> {
        const requestId: number = this.incrementSeqId();
    ...
    public getCountImportData(token: string, filter: __ROOT_NAMESPACE__.KazFilter): Promise<Int64> {
        const requestId: number = this.incrementSeqId();
    ...
    public send_getAllImportData(token: string, filter: __ROOT_NAMESPACE__.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_getCountImportData(token: string, filter: __ROOT_NAMESPACE__.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
...
export interface IHandler {
    ...
    getAllImportData(token: string, filter: __ROOT_NAMESPACE__.KazFilter): Array<ImportData.ImportData> | Promise<Array<ImportData.ImportData>>;
    getCountImportData(token: string, filter: __ROOT_NAMESPACE__.KazFilter): Int64 | Promise<Int64>;
