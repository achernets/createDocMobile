...
export class CreateOrUpdateReportArgs {
    public token: string;
    public reportTemplate: core.ReportTemplate;
    ...
    public static read(input: thrift.TProtocol): CreateOrUpdateReportArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_12: core.ReportTemplate = core.ReportTemplate.read(input);
...
export interface IConfigReportUsagesArgsArgs {
    ...
    toAddUserGroups: Array<core.UserOrGroup>;
    toRemoveUserGroups: Array<core.UserOrGroup>;
}
export class ConfigReportUsagesArgs {
    ...
    public toAddUserGroups: Array<core.UserOrGroup>;
    public toRemoveUserGroups: Array<core.UserOrGroup>;
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.toAddUserGroups != null) {
            ...
            this.toAddUserGroups.forEach((value_21: core.UserOrGroup): void => {
        ...
        if (this.toRemoveUserGroups != null) {
            ...
            this.toRemoveUserGroups.forEach((value_22: core.UserOrGroup): void => {
    ...
    public static read(input: thrift.TProtocol): ConfigReportUsagesArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 5:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_30: Array<core.UserOrGroup> = new Array<core.UserOrGroup>();
                        const metadata_4: thrift.TList = input.readListBegin();
                        const size_4: number = metadata_4.size;
                        for (let i_4: number = 0; i_4 < size_4; i_4++) {
                            const value_31: core.UserOrGroup = core.UserOrGroup.read(input);
                ...
                case 6:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_32: Array<core.UserOrGroup> = new Array<core.UserOrGroup>();
...
export class GenerateDigitalDocumentArgs {
    public token: string;
    public reportType: core.ReportType;
            ...
            switch (fieldId) {
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.I32) {
                        const value_35: core.ReportType = input.readI32();
    ...
    public static read(input: thrift.TProtocol): GenerateReportArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.I32) {
                        const value_40: core.ReportType = input.readI32();
                ...
                case 6:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_45: core.DocumentAccessPolicy = core.DocumentAccessPolicy.read(input);
    ...
    public static read(input: thrift.TProtocol): GenerateReportByFilterArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.I32) {
                        const value_47: core.ReportType = input.readI32();
                ...
                case 4:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_49: core.KazFilter = core.KazFilter.read(input);
    ...
    public static read(input: thrift.TProtocol): AttachReportToDocArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.I32) {
                        const value_53: core.ReportType = input.readI32();
                ...
                case 6:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_58: core.DocumentAccessPolicy = core.DocumentAccessPolicy.read(input);
    ...
    public static read(input: thrift.TProtocol): GenerateReportURLArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.I32) {
                        const value_61: core.ReportType = input.readI32();
                ...
                case 6:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_66: core.DocumentAccessPolicy = core.DocumentAccessPolicy.read(input);
    ...
    public static read(input: thrift.TProtocol): ExportDocumentsToXlsxArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_68: core.DocumentAccessPolicy = core.DocumentAccessPolicy.read(input);
                ...
                case 3:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_69: core.KazFilter = core.KazFilter.read(input);
...
export interface IChangePDFPostDecoratorArgsArgs {
    token: string;
    pdfPostDecorator: core.PDFPostDecorator;
}
export class ChangePDFPostDecoratorArgs {
    public token: string;
    public pdfPostDecorator: core.PDFPostDecorator;
    ...
    public static read(input: thrift.TProtocol): ChangePDFPostDecoratorArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_82: core.PDFPostDecorator = core.PDFPostDecorator.read(input);
    ...
    public static read(input: thrift.TProtocol): GetAllReportGroupsResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_86: core.PreconditionException = core.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_87: core.ServerException = core.ServerException.read(input);
...
export interface IGetAllReportTemplatesResultArgs {
    success?: Array<core.ReportTemplate>;
    validError?: core.PreconditionException;
    error?: core.ServerException;
}
export class GetAllReportTemplatesResult {
    public success?: Array<core.ReportTemplate>;
    public validError?: core.PreconditionException;
    public error?: core.ServerException;
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.success != null) {
            ...
            this.success.forEach((value_88: core.ReportTemplate): void => {
    ...
    public static read(input: thrift.TProtocol): GetAllReportTemplatesResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_89: Array<core.ReportTemplate> = new Array<core.ReportTemplate>();
                        ...
                        for (let i_10: number = 0; i_10 < size_10; i_10++) {
                            const value_90: core.ReportTemplate = core.ReportTemplate.read(input);
    ...
    public static read(input: thrift.TProtocol): GetAllReportTemplateLinksResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_99: core.PreconditionException = core.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_100: core.ServerException = core.ServerException.read(input);
...
export interface ICreateOrUpdateReportResultArgs {
    success?: core.ReportTemplate;
    validError?: core.PreconditionException;
    error?: core.ServerException;
}
export class CreateOrUpdateReportResult {
    public success?: core.ReportTemplate;
    public validError?: core.PreconditionException;
    public error?: core.ServerException;
    ...
    public static read(input: thrift.TProtocol): CreateOrUpdateReportResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_101: core.ReportTemplate = core.ReportTemplate.read(input);
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_102: core.PreconditionException = core.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_103: core.ServerException = core.ServerException.read(input);
    ...
    public static read(input: thrift.TProtocol): DownloadReportTemplateResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_105: core.PreconditionException = core.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_106: core.ServerException = core.ServerException.read(input);
    ...
    public static read(input: thrift.TProtocol): GetReportTemplateResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_131: core.ReportTemplate = core.ReportTemplate.read(input);
    ...
    public static read(input: thrift.TProtocol): ExportKnowledgeDocsToXlsxResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_135: core.PreconditionException = core.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_136: core.ServerException = core.ServerException.read(input);
...
export interface IGetPDFPostDecoratorPageResultArgs {
    success?: core.PDFPostDecoratorPage;
    validError?: core.PreconditionException;
    error?: core.ServerException;
}
export class GetPDFPostDecoratorPageResult {
    public success?: core.PDFPostDecoratorPage;
    public validError?: core.PreconditionException;
    public error?: core.ServerException;
    ...
    public static read(input: thrift.TProtocol): GetPDFPostDecoratorPageResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_140: core.PDFPostDecoratorPage = core.PDFPostDecoratorPage.read(input);
...
export interface IChangePDFPostDecoratorResultArgs {
    success?: core.PDFPostDecorator;
    validError?: core.PreconditionException;
    error?: core.ServerException;
}
export class ChangePDFPostDecoratorResult {
    public success?: core.PDFPostDecorator;
    public validError?: core.PreconditionException;
    public error?: core.ServerException;
    ...
    public static read(input: thrift.TProtocol): ChangePDFPostDecoratorResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_143: core.PDFPostDecorator = core.PDFPostDecorator.read(input);
...
export class Client {
    ...
    public getAllReportGroups(token: string, filter: core.KazFilter): Promise<Array<string>> {
    ...
    public getAllReportTemplates(token: string, docPatternId: string, filter: core.KazFilter): Promise<Array<core.ReportTemplate>> {
        const requestId: number = this.incrementSeqId();
        return new Promise<Array<core.ReportTemplate>>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
                if (error != null) {
                    reject(error);
    ...
    public getCountAllReportTemplates(token: string, docPatternId: string, filter: core.KazFilter): Promise<number> {
        const requestId: number = this.incrementSeqId();
    ...
    public getAllReportTemplateLinks(token: string, filter: core.KazFilter): Promise<Array<ReportTemplateLink.ReportTemplateLink>> {
        const requestId: number = this.incrementSeqId();
    ...
    public createOrUpdateReport(token: string, reportTemplate: core.ReportTemplate, xmlFile: Buffer): Promise<core.ReportTemplate> {
        const requestId: number = this.incrementSeqId();
        return new Promise<core.ReportTemplate>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
                if (error != null) {
                    reject(error);
    ...
    public configReportUsages(token: string, templateIds: Array<string>, toAddDocPatternIds: Array<string>, toRemoveDocPatternIds: Array<string>, toAddUserGroups: Array<core.UserOrGroup>, toRemoveUserGroups: Array<core.UserOrGroup>): Promise<boolean> {
        const requestId: number = this.incrementSeqId();
        return new Promise<boolean>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
    ...
    public generateDigitalDocument(token: string, reportType: core.ReportType, digitalViewId: string, docId: string): Promise<Buffer> {
        const requestId: number = this.incrementSeqId();
        return new Promise<Buffer>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
    ...
    public generateReport(token: string, reportType: core.ReportType, templateId: string, adParams: Array<ReportFilledParam.ReportFilledParam>, docId: string, accessPolicy: core.DocumentAccessPolicy): Promise<Buffer> {
        const requestId: number = this.incrementSeqId();
        return new Promise<Buffer>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
    ...
    public generateReportByFilter(token: string, reportType: core.ReportType, templateId: string, filter: core.KazFilter, forAllUsers: boolean): Promise<Buffer> {
        const requestId: number = this.incrementSeqId();
        return new Promise<Buffer>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
    ...
    public attachReportToDoc(token: string, reportType: core.ReportType, templateId: string, adParams: Array<ReportFilledParam.ReportFilledParam>, docId: string, accessPolicy: core.DocumentAccessPolicy): Promise<string> {
        const requestId: number = this.incrementSeqId();
    ...
    public generateReportURL(token: string, reportType: core.ReportType, templateId: string, adParams: Array<ReportFilledParam.ReportFilledParam>, docId: string, accessPolicy: core.DocumentAccessPolicy): Promise<string> {
        const requestId: number = this.incrementSeqId();
        return new Promise<string>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
    ...
    public exportDocumentsToXlsx(token: string, accessPolicy: core.DocumentAccessPolicy, filter: core.KazFilter, leftFilterId: string): Promise<Buffer> {
        const requestId: number = this.incrementSeqId();
        return new Promise<Buffer>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
    ...
    public getReportTemplate(token: string, templateId: string): Promise<core.ReportTemplate> {
        const requestId: number = this.incrementSeqId();
        return new Promise<core.ReportTemplate>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
    ...
    public exportKnowledgeDocsToXlsx(token: string, nodeTreeId: string, filter: core.KazFilter): Promise<Buffer> {
        const requestId: number = this.incrementSeqId();
        return new Promise<Buffer>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
    ...
    public exportUsersToXlsx(token: string, groupId: string, filter: core.KazFilter): Promise<Buffer> {
        const requestId: number = this.incrementSeqId();
        return new Promise<Buffer>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
    ...
    public getPDFPostDecoratorPage(token: string, filter: core.KazFilter): Promise<core.PDFPostDecoratorPage> {
        const requestId: number = this.incrementSeqId();
        return new Promise<core.PDFPostDecoratorPage>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
                if (error != null) {
                    reject(error);
    ...
    public changePDFPostDecorator(token: string, pdfPostDecorator: core.PDFPostDecorator): Promise<core.PDFPostDecorator> {
        const requestId: number = this.incrementSeqId();
        return new Promise<core.PDFPostDecorator>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
                if (error != null) {
                    reject(error);
    ...
    public send_getAllReportGroups(token: string, filter: core.KazFilter, requestId: number): void {
    ...
    public send_getAllReportTemplates(token: string, docPatternId: string, filter: core.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_getCountAllReportTemplates(token: string, docPatternId: string, filter: core.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_getAllReportTemplateLinks(token: string, filter: core.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_createOrUpdateReport(token: string, reportTemplate: core.ReportTemplate, xmlFile: Buffer, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_configReportUsages(token: string, templateIds: Array<string>, toAddDocPatternIds: Array<string>, toRemoveDocPatternIds: Array<string>, toAddUserGroups: Array<core.UserOrGroup>, toRemoveUserGroups: Array<core.UserOrGroup>, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_generateDigitalDocument(token: string, reportType: core.ReportType, digitalViewId: string, docId: string, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_generateReport(token: string, reportType: core.ReportType, templateId: string, adParams: Array<ReportFilledParam.ReportFilledParam>, docId: string, accessPolicy: core.DocumentAccessPolicy, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_generateReportByFilter(token: string, reportType: core.ReportType, templateId: string, filter: core.KazFilter, forAllUsers: boolean, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_attachReportToDoc(token: string, reportType: core.ReportType, templateId: string, adParams: Array<ReportFilledParam.ReportFilledParam>, docId: string, accessPolicy: core.DocumentAccessPolicy, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_generateReportURL(token: string, reportType: core.ReportType, templateId: string, adParams: Array<ReportFilledParam.ReportFilledParam>, docId: string, accessPolicy: core.DocumentAccessPolicy, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_exportDocumentsToXlsx(token: string, accessPolicy: core.DocumentAccessPolicy, filter: core.KazFilter, leftFilterId: string, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_exportKnowledgeDocsToXlsx(token: string, nodeTreeId: string, filter: core.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_exportUsersToXlsx(token: string, groupId: string, filter: core.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_getPDFPostDecoratorPage(token: string, filter: core.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_changePDFPostDecorator(token: string, pdfPostDecorator: core.PDFPostDecorator, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
...
export interface IHandler {
    getAllReportGroups(token: string, filter: core.KazFilter): Array<string> | Promise<Array<string>>;
    getAllReportTemplates(token: string, docPatternId: string, filter: core.KazFilter): Array<core.ReportTemplate> | Promise<Array<core.ReportTemplate>>;
    getCountAllReportTemplates(token: string, docPatternId: string, filter: core.KazFilter): number | Promise<number>;
    getAllReportTemplateLinks(token: string, filter: core.KazFilter): Array<ReportTemplateLink.ReportTemplateLink> | Promise<Array<ReportTemplateLink.ReportTemplateLink>>;
    createOrUpdateReport(token: string, reportTemplate: core.ReportTemplate, xmlFile: Buffer): core.ReportTemplate | Promise<core.ReportTemplate>;
    ...
    configReportUsages(token: string, templateIds: Array<string>, toAddDocPatternIds: Array<string>, toRemoveDocPatternIds: Array<string>, toAddUserGroups: Array<core.UserOrGroup>, toRemoveUserGroups: Array<core.UserOrGroup>): boolean | Promise<boolean>;
    generateDigitalDocument(token: string, reportType: core.ReportType, digitalViewId: string, docId: string): Buffer | Promise<Buffer>;
    generateReport(token: string, reportType: core.ReportType, templateId: string, adParams: Array<ReportFilledParam.ReportFilledParam>, docId: string, accessPolicy: core.DocumentAccessPolicy): Buffer | Promise<Buffer>;
    generateReportByFilter(token: string, reportType: core.ReportType, templateId: string, filter: core.KazFilter, forAllUsers: boolean): Buffer | Promise<Buffer>;
    attachReportToDoc(token: string, reportType: core.ReportType, templateId: string, adParams: Array<ReportFilledParam.ReportFilledParam>, docId: string, accessPolicy: core.DocumentAccessPolicy): string | Promise<string>;
    generateReportURL(token: string, reportType: core.ReportType, templateId: string, adParams: Array<ReportFilledParam.ReportFilledParam>, docId: string, accessPolicy: core.DocumentAccessPolicy): string | Promise<string>;
    exportDocumentsToXlsx(token: string, accessPolicy: core.DocumentAccessPolicy, filter: core.KazFilter, leftFilterId: string): Buffer | Promise<Buffer>;
    getReportTemplate(token: string, templateId: string): core.ReportTemplate | Promise<core.ReportTemplate>;
    exportKnowledgeDocsToXlsx(token: string, nodeTreeId: string, filter: core.KazFilter): Buffer | Promise<Buffer>;
    exportUsersToXlsx(token: string, groupId: string, filter: core.KazFilter): Buffer | Promise<Buffer>;
    getPDFPostDecoratorPage(token: string, filter: core.KazFilter): core.PDFPostDecoratorPage | Promise<core.PDFPostDecoratorPage>;
    changePDFPostDecorator(token: string, pdfPostDecorator: core.PDFPostDecorator): core.PDFPostDecorator | Promise<core.PDFPostDecorator>;
}
export class Processor {
    ...
    public process_getAllReportTemplates(requestId: number, input: thrift.TProtocol, output: thrift.TProtocol): void {
        new Promise<Array<core.ReportTemplate>>((resolve, reject): void => {
            try {
        ...
        }).then((data: Array<core.ReportTemplate>): void => {
    ...
    public process_createOrUpdateReport(requestId: number, input: thrift.TProtocol, output: thrift.TProtocol): void {
        new Promise<core.ReportTemplate>((resolve, reject): void => {
            try {
        ...
        }).then((data: core.ReportTemplate): void => {
    ...
    public process_getPDFPostDecoratorPage(requestId: number, input: thrift.TProtocol, output: thrift.TProtocol): void {
        new Promise<core.PDFPostDecoratorPage>((resolve, reject): void => {
            try {
        ...
        }).then((data: core.PDFPostDecoratorPage): void => {
    ...
    public process_changePDFPostDecorator(requestId: number, input: thrift.TProtocol, output: thrift.TProtocol): void {
        new Promise<core.PDFPostDecorator>((resolve, reject): void => {
            try {
        ...
        }).then((data: core.PDFPostDecorator): void => {
