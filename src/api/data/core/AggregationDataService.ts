...
export interface IGetDocumentDataArgsArgs {
    token: string;
    documentId: string;
    requiredData: Set<core.AggregationRequiredType>;
...
export class GetDocumentDataArgs {
    ...
    public requiredData: Set<core.AggregationRequiredType>;
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.requiredData != null) {
            ...
            this.requiredData.forEach((value_1: core.AggregationRequiredType): void => {
            ...
            switch (fieldId) {
                ...
                case 3:
                    if (fieldType === thrift.Thrift.Type.SET) {
                        const value_4: Set<core.AggregationRequiredType> = new Set<core.AggregationRequiredType>();
                        const metadata_1: thrift.TSet = input.readSetBegin();
                        const size_1: number = metadata_1.size;
                        for (let i_1: number = 0; i_1 < size_1; i_1++) {
                            const value_5: core.AggregationRequiredType = input.readI32();
                            value_4.add(value_5);
                        }
                        input.readSetEnd();
                ...
                case 4:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_6: core.DocumentAccessPolicy = core.DocumentAccessPolicy.read(input);
...
export class GetRegistryByIdArgs {
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.requiredData != null) {
            output.writeFieldBegin("requiredData", thrift.Thrift.Type.SET, 3);
            output.writeSetBegin(thrift.Thrift.Type.I32, this.requiredData.size);
            this.requiredData.forEach((value_15: core.AggregationRequiredType): void => {
    ...
    public static read(input: thrift.TProtocol): GetRegistryByIdArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 3:
                    if (fieldType === thrift.Thrift.Type.SET) {
                        const value_18: Set<core.AggregationRequiredType> = new Set<core.AggregationRequiredType>();
                        const metadata_2: thrift.TSet = input.readSetBegin();
                        const size_2: number = metadata_2.size;
                        for (let i_2: number = 0; i_2 < size_2; i_2++) {
                            const value_19: core.AggregationRequiredType = input.readI32();
...
export class CreateOrUpdateRegistryArgs {
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.userOrGroupList != null) {
            ...
            this.userOrGroupList.forEach((value_22: core.UserOrGroup): void => {
        ...
        if (this.accountList != null) {
            ...
            this.accountList.forEach((value_23: core.Account): void => {
            ...
            switch (fieldId) {
                ...
                case 3:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_26: Array<core.UserOrGroup> = new Array<core.UserOrGroup>();
                        const metadata_3: thrift.TList = input.readListBegin();
                        const size_3: number = metadata_3.size;
                        for (let i_3: number = 0; i_3 < size_3; i_3++) {
                            const value_27: core.UserOrGroup = core.UserOrGroup.read(input);
                ...
                case 4:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_28: Array<core.Account> = new Array<core.Account>();
                        const metadata_4: thrift.TList = input.readListBegin();
                        const size_4: number = metadata_4.size;
                        for (let i_4: number = 0; i_4 < size_4; i_4++) {
                            const value_29: core.Account = core.Account.read(input);
    ...
    public static read(input: thrift.TProtocol): GetCountAllRegistriesResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_44: core.PreconditionException = core.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_45: core.ServerException = core.ServerException.read(input);
    ...
    public static read(input: thrift.TProtocol): GetRegistryByIdResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_47: core.PreconditionException = core.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_48: core.ServerException = core.ServerException.read(input);
    ...
    public static read(input: thrift.TProtocol): CompareJiraTimeResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_56: core.PreconditionException = core.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_57: core.ServerException = core.ServerException.read(input);
...
export class Client {
    ...
    public getDocumentData(token: string, documentId: string, requiredData: Set<core.AggregationRequiredType>, policy: core.DocumentAccessPolicy, decrypt: boolean, executorsPortion: number): Promise<AggregationDocumentData.AggregationDocumentData> {
    ...
    public getAllRegistries(token: string, filter: core.KazFilter, forAdmin: boolean): Promise<Array<Registry.Registry>> {
        const requestId: number = this.incrementSeqId();
    ...
    public getCountAllRegistries(token: string, filter: core.KazFilter, forAdmin: boolean): Promise<number> {
        const requestId: number = this.incrementSeqId();
    ...
    public getRegistryById(token: string, id: string, requiredData: Set<core.AggregationRequiredType>): Promise<Registry.Registry> {
        const requestId: number = this.incrementSeqId();
    ...
    public createOrUpdateRegistry(token: string, registry: Registry.Registry, userOrGroupList: Array<core.UserOrGroup>, accountList: Array<core.Account>): Promise<Registry.Registry> {
        const requestId: number = this.incrementSeqId();
        return new Promise<Registry.Registry>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
    ...
    public send_getDocumentData(token: string, documentId: string, requiredData: Set<core.AggregationRequiredType>, policy: core.DocumentAccessPolicy, decrypt: boolean, executorsPortion: number, requestId: number): void {
    ...
    public send_getAllRegistries(token: string, filter: core.KazFilter, forAdmin: boolean, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_getCountAllRegistries(token: string, filter: core.KazFilter, forAdmin: boolean, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_getRegistryById(token: string, id: string, requiredData: Set<core.AggregationRequiredType>, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_createOrUpdateRegistry(token: string, registry: Registry.Registry, userOrGroupList: Array<core.UserOrGroup>, accountList: Array<core.Account>, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
...
export interface IHandler {
    getDocumentData(token: string, documentId: string, requiredData: Set<core.AggregationRequiredType>, policy: core.DocumentAccessPolicy, decrypt: boolean, executorsPortion: number): AggregationDocumentData.AggregationDocumentData | Promise<AggregationDocumentData.AggregationDocumentData>;
    getAllRegistries(token: string, filter: core.KazFilter, forAdmin: boolean): Array<Registry.Registry> | Promise<Array<Registry.Registry>>;
    getCountAllRegistries(token: string, filter: core.KazFilter, forAdmin: boolean): number | Promise<number>;
    getRegistryById(token: string, id: string, requiredData: Set<core.AggregationRequiredType>): Registry.Registry | Promise<Registry.Registry>;
    removeRegistry(token: string, registryId: string): boolean | Promise<boolean>;
    createOrUpdateRegistry(token: string, registry: Registry.Registry, userOrGroupList: Array<core.UserOrGroup>, accountList: Array<core.Account>): Registry.Registry | Promise<Registry.Registry>;
