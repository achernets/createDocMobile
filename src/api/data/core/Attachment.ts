            ...
            switch (fieldId) {
                ...
                case 10:
                    if (fieldType === thrift.Thrift.Type.I32) {
                        const value_14: core.AttachmentStatus = input.readI32();
                ...
                case 23:
                    if (fieldType === thrift.Thrift.Type.I32) {
                        const value_27: core.FileType = input.readI32();
                ...
                case 25:
                    if (fieldType === thrift.Thrift.Type.I32) {
                        const value_29: core.AttachmentEditMode = input.readI32();
                ...
                case 28:
                    if (fieldType === thrift.Thrift.Type.I32) {
                        const value_31: core.AttachmentExtStatus = input.readI32();
                ...
                case 35:
                    if (fieldType === thrift.Thrift.Type.I32) {
                        const value_40: core.AttachmentUploadStatus = input.readI32();
                ...
                case 36:
                    if (fieldType === thrift.Thrift.Type.I32) {
                        const value_41: core.AttachmentProcessingStatus = input.readI32();
