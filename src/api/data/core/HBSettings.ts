...
export interface IHBSettingsArgs {
    ...
    hbValue?: core.ContentItemHBValue;
}
export class HBSettings {
    public handBook?: core.HandBook;
    public hbValue?: core.ContentItemHBValue;
            ...
            switch (fieldId) {
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_1: core.HandBook = core.HandBook.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_2: core.ContentItemHBValue = core.ContentItemHBValue.read(input);
