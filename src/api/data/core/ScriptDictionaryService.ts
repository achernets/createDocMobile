    ...
    public static read(input: thrift.TProtocol): GetScriptDictionaryByIdArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_4: core.CompositeId = core.CompositeId.read(input);
                        _args.id = value_4;
                    }
                    else {
                        input.skip(fieldType);
    ...
    public static read(input: thrift.TProtocol): RemoveScriptDictionaryArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_11: core.CompositeId = core.CompositeId.read(input);
                        _args.id = value_11;
                    }
                    else {
                        input.skip(fieldType);
    ...
    public static read(input: thrift.TProtocol): ValidationResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_26: core.PreconditionException = core.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_27: core.ServerException = core.ServerException.read(input);
    ...
    public static read(input: thrift.TProtocol): RemoveScriptDictionaryResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_29: core.PreconditionException = core.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_30: core.ServerException = core.ServerException.read(input);
...
export class Client {
    ...
    public getAllScriptDictionaries(token: string, filter: core.KazFilter): Promise<Array<ScriptDictionary.ScriptDictionary>> {
    ...
    public getScriptDictionaryById(token: string, id: core.CompositeId, withContext: boolean): Promise<ScriptDictionary.ScriptDictionary> {
        const requestId: number = this.incrementSeqId();
    ...
    public removeScriptDictionary(token: string, id: core.CompositeId): Promise<boolean> {
        const requestId: number = this.incrementSeqId();
    ...
    public send_getAllScriptDictionaries(token: string, filter: core.KazFilter, requestId: number): void {
    ...
    public send_getScriptDictionaryById(token: string, id: core.CompositeId, withContext: boolean, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_removeScriptDictionary(token: string, id: core.CompositeId, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
...
export interface IHandler {
    getAllScriptDictionaries(token: string, filter: core.KazFilter): Array<ScriptDictionary.ScriptDictionary> | Promise<Array<ScriptDictionary.ScriptDictionary>>;
    getScriptDictionaryById(token: string, id: core.CompositeId, withContext: boolean): ScriptDictionary.ScriptDictionary | Promise<ScriptDictionary.ScriptDictionary>;
    ...
    removeScriptDictionary(token: string, id: core.CompositeId): boolean | Promise<boolean>;
}
