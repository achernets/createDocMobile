...
export interface ICreateOrUpdateOrgStructureArgsArgs {
    token: string;
    orgStructure: core.OrgStructure;
}
export class CreateOrUpdateOrgStructureArgs {
    public token: string;
    public orgStructure: core.OrgStructure;
    ...
    public static read(input: thrift.TProtocol): CreateOrUpdateOrgStructureArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_4: core.OrgStructure = core.OrgStructure.read(input);
    ...
    public static read(input: thrift.TProtocol): CreateOrUpdateDepartmentArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_16: core.Department = core.Department.read(input);
...
export interface IRemoveDepartmentArgsArgs {
    token: string;
    departmentId: string;
    removeType: core.RemoveActionType;
}
export class RemoveDepartmentArgs {
    public token: string;
    public departmentId: string;
    public removeType: core.RemoveActionType;
            ...
            switch (fieldId) {
                ...
                case 3:
                    if (fieldType === thrift.Thrift.Type.I32) {
                        const value_19: core.RemoveActionType = input.readI32();
...
export interface IChangeUserDepartmentsArgsArgs {
    token: string;
    userId: string;
    toAdd: Array<core.Department>;
    toRemove: Array<string>;
}
export class ChangeUserDepartmentsArgs {
    public token: string;
    public userId: string;
    public toAdd: Array<core.Department>;
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.toAdd != null) {
            ...
            this.toAdd.forEach((value_24: core.Department): void => {
            ...
            switch (fieldId) {
                ...
                case 3:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_28: Array<core.Department> = new Array<core.Department>();
                        const metadata_1: thrift.TList = input.readListBegin();
                        const size_1: number = metadata_1.size;
                        for (let i_1: number = 0; i_1 < size_1; i_1++) {
                            const value_29: core.Department = core.Department.read(input);
...
export class GetAllOrgStructureResult {
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.success != null) {
            ...
            this.success.forEach((value_36: core.OrgStructure): void => {
    ...
    public static read(input: thrift.TProtocol): GetAllOrgStructureResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_37: Array<core.OrgStructure> = new Array<core.OrgStructure>();
                        const metadata_3: thrift.TList = input.readListBegin();
                        const size_3: number = metadata_3.size;
                        for (let i_3: number = 0; i_3 < size_3; i_3++) {
                            const value_38: core.OrgStructure = core.OrgStructure.read(input);
...
export interface ICreateOrUpdateOrgStructureResultArgs {
    success?: core.OrgStructure;
    validError?: core.PreconditionException;
    error?: core.ServerException;
}
export class CreateOrUpdateOrgStructureResult {
    public success?: core.OrgStructure;
    public validError?: core.PreconditionException;
    public error?: core.ServerException;
    ...
    public static read(input: thrift.TProtocol): CreateOrUpdateOrgStructureResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_41: core.OrgStructure = core.OrgStructure.read(input);
...
export interface IGetAllDepartmentsResultArgs {
    success?: Array<core.Department>;
    validError?: core.PreconditionException;
    error?: core.ServerException;
}
export class GetAllDepartmentsResult {
    public success?: Array<core.Department>;
    public validError?: core.PreconditionException;
    public error?: core.ServerException;
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.success != null) {
            output.writeFieldBegin("success", thrift.Thrift.Type.LIST, 0);
            output.writeListBegin(thrift.Thrift.Type.STRUCT, this.success.length);
            this.success.forEach((value_47: core.Department): void => {
    ...
    public static read(input: thrift.TProtocol): GetAllDepartmentsResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_48: Array<core.Department> = new Array<core.Department>();
                        const metadata_4: thrift.TList = input.readListBegin();
                        const size_4: number = metadata_4.size;
                        for (let i_4: number = 0; i_4 < size_4; i_4++) {
                            const value_49: core.Department = core.Department.read(input);
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_50: core.PreconditionException = core.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_51: core.ServerException = core.ServerException.read(input);
...
export class GetUsersByDepartmentResult {
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.success != null) {
            output.writeFieldBegin("success", thrift.Thrift.Type.LIST, 0);
            output.writeListBegin(thrift.Thrift.Type.STRUCT, this.success.length);
            this.success.forEach((value_52: core.UserOrGroup): void => {
    ...
    public static read(input: thrift.TProtocol): GetUsersByDepartmentResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_53: Array<core.UserOrGroup> = new Array<core.UserOrGroup>();
                        const metadata_5: thrift.TList = input.readListBegin();
                        const size_5: number = metadata_5.size;
                        for (let i_5: number = 0; i_5 < size_5; i_5++) {
                            const value_54: core.UserOrGroup = core.UserOrGroup.read(input);
...
export interface ICreateOrUpdateDepartmentResultArgs {
    success?: core.Department;
    validError?: core.PreconditionException;
    error?: core.ServerException;
}
export class CreateOrUpdateDepartmentResult {
    public success?: core.Department;
    public validError?: core.PreconditionException;
    public error?: core.ServerException;
    ...
    public static read(input: thrift.TProtocol): CreateOrUpdateDepartmentResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_60: core.Department = core.Department.read(input);
...
export class GetAllDepartmentsForUserResult {
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.success != null) {
            output.writeFieldBegin("success", thrift.Thrift.Type.LIST, 0);
            output.writeListBegin(thrift.Thrift.Type.STRUCT, this.success.length);
            this.success.forEach((value_66: core.Department): void => {
    ...
    public static read(input: thrift.TProtocol): GetAllDepartmentsForUserResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_67: Array<core.Department> = new Array<core.Department>();
                        const metadata_6: thrift.TList = input.readListBegin();
                        const size_6: number = metadata_6.size;
                        for (let i_6: number = 0; i_6 < size_6; i_6++) {
                            const value_68: core.Department = core.Department.read(input);
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_69: core.PreconditionException = core.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_70: core.ServerException = core.ServerException.read(input);
...
export class ChangeUserDepartmentsResult {
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.success != null) {
            output.writeFieldBegin("success", thrift.Thrift.Type.LIST, 0);
            output.writeListBegin(thrift.Thrift.Type.STRUCT, this.success.length);
            this.success.forEach((value_71: core.Department): void => {
    ...
    public static read(input: thrift.TProtocol): ChangeUserDepartmentsResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_72: Array<core.Department> = new Array<core.Department>();
                        const metadata_7: thrift.TList = input.readListBegin();
                        const size_7: number = metadata_7.size;
                        for (let i_7: number = 0; i_7 < size_7; i_7++) {
                            const value_73: core.Department = core.Department.read(input);
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_74: core.PreconditionException = core.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_75: core.ServerException = core.ServerException.read(input);
    ...
    public static read(input: thrift.TProtocol): MoveDepartmentResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_77: core.PreconditionException = core.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_78: core.ServerException = core.ServerException.read(input);
...
export class Client {
    ...
    public getAllOrgStructure(token: string, filter: core.KazFilter): Promise<Array<core.OrgStructure>> {
        const requestId: number = this.incrementSeqId();
        return new Promise<Array<core.OrgStructure>>((resolve, reject): void => {
    ...
    public createOrUpdateOrgStructure(token: string, orgStructure: core.OrgStructure): Promise<core.OrgStructure> {
        const requestId: number = this.incrementSeqId();
        return new Promise<core.OrgStructure>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
                if (error != null) {
                    reject(error);
    ...
    public getAllDepartments(token: string, filter: core.KazFilter): Promise<Array<core.Department>> {
        const requestId: number = this.incrementSeqId();
        return new Promise<Array<core.Department>>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
                if (error != null) {
                    reject(error);
    ...
    public getUsersByDepartment(token: string, departmentId: string, filter: core.KazFilter): Promise<Array<core.UserOrGroup>> {
        const requestId: number = this.incrementSeqId();
    ...
    public getCountUsersByDepartment(token: string, departmentId: string, filter: core.KazFilter): Promise<Int64> {
        const requestId: number = this.incrementSeqId();
    ...
    public createOrUpdateDepartment(token: string, department: core.Department): Promise<core.Department> {
        const requestId: number = this.incrementSeqId();
        return new Promise<core.Department>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
                if (error != null) {
                    reject(error);
    ...
    public removeDepartment(token: string, departmentId: string, removeType: core.RemoveActionType): Promise<boolean> {
        const requestId: number = this.incrementSeqId();
        return new Promise<boolean>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
    ...
    public getAllDepartmentsForUser(token: string, userId: string, withParent: boolean, filter: core.KazFilter): Promise<Array<core.Department>> {
        const requestId: number = this.incrementSeqId();
        return new Promise<Array<core.Department>>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
    ...
    public changeUserDepartments(token: string, userId: string, toAdd: Array<core.Department>, toRemove: Array<string>): Promise<Array<core.Department>> {
        const requestId: number = this.incrementSeqId();
        return new Promise<Array<core.Department>>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
    ...
    public send_getAllOrgStructure(token: string, filter: core.KazFilter, requestId: number): void {
    ...
    public send_createOrUpdateOrgStructure(token: string, orgStructure: core.OrgStructure, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_getAllDepartments(token: string, filter: core.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_getUsersByDepartment(token: string, departmentId: string, filter: core.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_getCountUsersByDepartment(token: string, departmentId: string, filter: core.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_createOrUpdateDepartment(token: string, department: core.Department, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_removeDepartment(token: string, departmentId: string, removeType: core.RemoveActionType, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_getAllDepartmentsForUser(token: string, userId: string, withParent: boolean, filter: core.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_changeUserDepartments(token: string, userId: string, toAdd: Array<core.Department>, toRemove: Array<string>, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
...
export interface IHandler {
    getAllOrgStructure(token: string, filter: core.KazFilter): Array<core.OrgStructure> | Promise<Array<core.OrgStructure>>;
    createOrUpdateOrgStructure(token: string, orgStructure: core.OrgStructure): core.OrgStructure | Promise<core.OrgStructure>;
    removeOrgStructure(token: string, orgStructureId: string): boolean | Promise<boolean>;
    getAllDepartments(token: string, filter: core.KazFilter): Array<core.Department> | Promise<Array<core.Department>>;
    getUsersByDepartment(token: string, departmentId: string, filter: core.KazFilter): Array<core.UserOrGroup> | Promise<Array<core.UserOrGroup>>;
    getCountUsersByDepartment(token: string, departmentId: string, filter: core.KazFilter): Int64 | Promise<Int64>;
    createOrUpdateDepartment(token: string, department: core.Department): core.Department | Promise<core.Department>;
    removeDepartment(token: string, departmentId: string, removeType: core.RemoveActionType): boolean | Promise<boolean>;
    getAllDepartmentsForUser(token: string, userId: string, withParent: boolean, filter: core.KazFilter): Array<core.Department> | Promise<Array<core.Department>>;
    changeUserDepartments(token: string, userId: string, toAdd: Array<core.Department>, toRemove: Array<string>): Array<core.Department> | Promise<Array<core.Department>>;
...
export class Processor {
    ...
    public process_getAllOrgStructure(requestId: number, input: thrift.TProtocol, output: thrift.TProtocol): void {
        new Promise<Array<core.OrgStructure>>((resolve, reject): void => {
            try {
        ...
        }).then((data: Array<core.OrgStructure>): void => {
    ...
    public process_createOrUpdateOrgStructure(requestId: number, input: thrift.TProtocol, output: thrift.TProtocol): void {
        new Promise<core.OrgStructure>((resolve, reject): void => {
            try {
        ...
        }).then((data: core.OrgStructure): void => {
    ...
    public process_getAllDepartments(requestId: number, input: thrift.TProtocol, output: thrift.TProtocol): void {
        new Promise<Array<core.Department>>((resolve, reject): void => {
            try {
        ...
        }).then((data: Array<core.Department>): void => {
    ...
    public process_createOrUpdateDepartment(requestId: number, input: thrift.TProtocol, output: thrift.TProtocol): void {
        new Promise<core.Department>((resolve, reject): void => {
            try {
        ...
        }).then((data: core.Department): void => {
