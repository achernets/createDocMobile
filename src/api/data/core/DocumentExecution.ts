...
export class DocumentExecution {
    ...
    public userOGroup?: core.UserOrGroup;
    ...
    public handoverUser?: core.UserOrGroup;
    ...
    public static read(input: thrift.TProtocol): DocumentExecution {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 33:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_37: core.UserOrGroup = core.UserOrGroup.read(input);
