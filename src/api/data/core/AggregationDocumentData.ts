...
export interface IAggregationDocumentDataArgs {
    ...
    comments?: Array<core.DocumentComment>;
    relations?: Array<core.DocumentRelation>;
    securityClassifications?: Array<core.SecurityClassification>;
    deadlineHistories?: Array<core.DeadlineHistory>;
    attachments?: Array<core.Attachment>;
    reportTemplates?: Array<core.ReportTemplate>;
    permissions?: core.DocPermissions;
    errors?: Map<string, string>;
    matchingUserGroup?: Array<MatchingUserGroup.MatchingUserGroup>;
    contentHolders?: Array<core.ContentHolderShowPlace>;
    policy?: core.DocumentAccessPolicy;
    exceptionMap?: Map<core.AggregationRequiredType, core.PreconditionException>;
    docSubStasuses?: Array<DocSubStatus.DocSubStatus>;
}
export class AggregationDocumentData {
    public document?: core.Document;
    public comments?: Array<core.DocumentComment>;
    public relations?: Array<core.DocumentRelation>;
    public securityClassifications?: Array<core.SecurityClassification>;
    public deadlineHistories?: Array<core.DeadlineHistory>;
    public attachments?: Array<core.Attachment>;
    public reportTemplates?: Array<core.ReportTemplate>;
    ...
    public contentHolders?: Array<core.ContentHolderShowPlace>;
    public policy?: core.DocumentAccessPolicy;
    public exceptionMap?: Map<core.AggregationRequiredType, core.PreconditionException>;
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.comments != null) {
            ...
            this.comments.forEach((value_1: core.DocumentComment): void => {
        ...
        if (this.relations != null) {
            ...
            this.relations.forEach((value_2: core.DocumentRelation): void => {
        ...
        if (this.securityClassifications != null) {
            ...
            this.securityClassifications.forEach((value_3: core.SecurityClassification): void => {
        ...
        if (this.deadlineHistories != null) {
            ...
            this.deadlineHistories.forEach((value_4: core.DeadlineHistory): void => {
        ...
        if (this.attachments != null) {
            ...
            this.attachments.forEach((value_5: core.Attachment): void => {
        ...
        if (this.reportTemplates != null) {
            ...
            this.reportTemplates.forEach((value_6: core.ReportTemplate): void => {
        ...
        if (this.contentHolders != null) {
            ...
            this.contentHolders.forEach((value_9: core.ContentHolderShowPlace): void => {
        ...
        if (this.exceptionMap != null) {
            ...
            this.exceptionMap.forEach((value_10: core.PreconditionException, key_2: core.AggregationRequiredType): void => {
            ...
            switch (fieldId) {
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_12: core.Document = core.Document.read(input);
                ...
                case 4:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_13: Array<core.DocumentComment> = new Array<core.DocumentComment>();
                        const metadata_1: thrift.TList = input.readListBegin();
                        const size_1: number = metadata_1.size;
                        for (let i_1: number = 0; i_1 < size_1; i_1++) {
                            const value_14: core.DocumentComment = core.DocumentComment.read(input);
                ...
                case 5:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_15: Array<core.DocumentRelation> = new Array<core.DocumentRelation>();
                        const metadata_2: thrift.TList = input.readListBegin();
                        const size_2: number = metadata_2.size;
                        for (let i_2: number = 0; i_2 < size_2; i_2++) {
                            const value_16: core.DocumentRelation = core.DocumentRelation.read(input);
                ...
                case 7:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_17: Array<core.SecurityClassification> = new Array<core.SecurityClassification>();
                        const metadata_3: thrift.TList = input.readListBegin();
                        const size_3: number = metadata_3.size;
                        for (let i_3: number = 0; i_3 < size_3; i_3++) {
                            const value_18: core.SecurityClassification = core.SecurityClassification.read(input);
                ...
                case 8:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_19: Array<core.DeadlineHistory> = new Array<core.DeadlineHistory>();
                        const metadata_4: thrift.TList = input.readListBegin();
                        const size_4: number = metadata_4.size;
                        for (let i_4: number = 0; i_4 < size_4; i_4++) {
                            const value_20: core.DeadlineHistory = core.DeadlineHistory.read(input);
                ...
                case 9:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_21: Array<core.Attachment> = new Array<core.Attachment>();
                        const metadata_5: thrift.TList = input.readListBegin();
                        const size_5: number = metadata_5.size;
                        for (let i_5: number = 0; i_5 < size_5; i_5++) {
                            const value_22: core.Attachment = core.Attachment.read(input);
                ...
                case 10:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_23: Array<core.ReportTemplate> = new Array<core.ReportTemplate>();
                        const metadata_6: thrift.TList = input.readListBegin();
                        const size_6: number = metadata_6.size;
                        for (let i_6: number = 0; i_6 < size_6; i_6++) {
                            const value_24: core.ReportTemplate = core.ReportTemplate.read(input);
                ...
                case 11:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_25: core.DocPermissions = core.DocPermissions.read(input);
                ...
                case 14:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_30: Array<core.ContentHolderShowPlace> = new Array<core.ContentHolderShowPlace>();
                        const metadata_9: thrift.TList = input.readListBegin();
                        const size_9: number = metadata_9.size;
                        for (let i_9: number = 0; i_9 < size_9; i_9++) {
                            const value_31: core.ContentHolderShowPlace = core.ContentHolderShowPlace.read(input);
                ...
                case 15:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_32: core.DocumentAccessPolicy = core.DocumentAccessPolicy.read(input);
                ...
                case 16:
                    if (fieldType === thrift.Thrift.Type.MAP) {
                        const value_33: Map<core.AggregationRequiredType, core.PreconditionException> = new Map<core.AggregationRequiredType, core.PreconditionException>();
                        ...
                        for (let i_10: number = 0; i_10 < size_10; i_10++) {
                            const key_4: core.AggregationRequiredType = input.readI32();
