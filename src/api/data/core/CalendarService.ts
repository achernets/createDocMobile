...
export class GetAllDeadlinesArgs {
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.usersOrGroups != null) {
            ...
            this.usersOrGroups.forEach((value_1: core.UserOrGroup): void => {
...
export class GetCountAllDeadlinesArgs {
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.usersOrGroups != null) {
            output.writeFieldBegin("usersOrGroups", thrift.Thrift.Type.LIST, 4);
            output.writeListBegin(thrift.Thrift.Type.STRUCT, this.usersOrGroups.length);
            this.usersOrGroups.forEach((value_8: core.UserOrGroup): void => {
...
export class GetAllGroupedDeadlinesArgs {
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.usersOrGroups != null) {
            output.writeFieldBegin("usersOrGroups", thrift.Thrift.Type.LIST, 4);
            output.writeListBegin(thrift.Thrift.Type.STRUCT, this.usersOrGroups.length);
            this.usersOrGroups.forEach((value_15: core.UserOrGroup): void => {
    ...
    public static read(input: thrift.TProtocol): GetAllGroupedDeadlinesArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 4:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_19: Array<core.UserOrGroup> = new Array<core.UserOrGroup>();
                        const metadata_3: thrift.TList = input.readListBegin();
                        const size_3: number = metadata_3.size;
                        for (let i_3: number = 0; i_3 < size_3; i_3++) {
                            const value_20: core.UserOrGroup = core.UserOrGroup.read(input);
    ...
    public static read(input: thrift.TProtocol): GetAllWeekendDictionariesArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_27: core.KazFilter = core.KazFilter.read(input);
    ...
    public static read(input: thrift.TProtocol): PopulateWeekendsArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 4:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_39: core.KazFilter = core.KazFilter.read(input);
    ...
    public static read(input: thrift.TProtocol): GetAllGroupedDeadlinesResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_54: core.PreconditionException = core.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_55: core.ServerException = core.ServerException.read(input);
...
export interface IGetAllReassignmentsResultArgs {
    success?: Array<core.DocumentReassign>;
    validError?: core.PreconditionException;
    error?: core.ServerException;
}
export class GetAllReassignmentsResult {
    public success?: Array<core.DocumentReassign>;
    public validError?: core.PreconditionException;
    public error?: core.ServerException;
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.success != null) {
            output.writeFieldBegin("success", thrift.Thrift.Type.LIST, 0);
            output.writeListBegin(thrift.Thrift.Type.STRUCT, this.success.length);
            this.success.forEach((value_56: core.DocumentReassign): void => {
    ...
    public static read(input: thrift.TProtocol): GetAllReassignmentsResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_57: Array<core.DocumentReassign> = new Array<core.DocumentReassign>();
                        const metadata_8: thrift.TList = input.readListBegin();
                        const size_8: number = metadata_8.size;
                        for (let i_8: number = 0; i_8 < size_8; i_8++) {
                            const value_58: core.DocumentReassign = core.DocumentReassign.read(input);
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_59: core.PreconditionException = core.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_60: core.ServerException = core.ServerException.read(input);
...
export class Client {
    ...
    public getAllDeadlines(token: string, beginDate: Int64, endDate: Int64, usersOrGroups: Array<core.UserOrGroup>, filter: core.KazFilter): Promise<Array<Deadline.Deadline>> {
    ...
    public getCountAllDeadlines(token: string, beginDate: Int64, endDate: Int64, usersOrGroups: Array<core.UserOrGroup>, filter: core.KazFilter): Promise<number> {
        const requestId: number = this.incrementSeqId();
    ...
    public getAllGroupedDeadlines(token: string, beginDate: Int64, endDate: Int64, usersOrGroups: Array<core.UserOrGroup>, filter: core.KazFilter): Promise<Map<Int64, Int64>> {
        const requestId: number = this.incrementSeqId();
    ...
    public getAllReassignments(token: string, beginDate: Int64, endDate: Int64, filter: core.KazFilter): Promise<Array<core.DocumentReassign>> {
        const requestId: number = this.incrementSeqId();
        return new Promise<Array<core.DocumentReassign>>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
                if (error != null) {
                    reject(error);
    ...
    public getAllWeekendDictionaries(token: string, filter: core.KazFilter): Promise<Array<WeekendDictionary.WeekendDictionary>> {
        const requestId: number = this.incrementSeqId();
    ...
    public changeWeekendDictionaries(token: string, toUpdate: Array<WeekendDictionary.WeekendDictionary>, toRemove: Array<string>, filter: core.KazFilter): Promise<Array<WeekendDictionary.WeekendDictionary>> {
        const requestId: number = this.incrementSeqId();
        return new Promise<Array<WeekendDictionary.WeekendDictionary>>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
    ...
    public populateWeekends(token: string, dateFrom: Int64, dateTo: Int64, filter: core.KazFilter): Promise<Array<WeekendDictionary.WeekendDictionary>> {
        const requestId: number = this.incrementSeqId();
        return new Promise<Array<WeekendDictionary.WeekendDictionary>>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
    ...
    public send_getAllDeadlines(token: string, beginDate: Int64, endDate: Int64, usersOrGroups: Array<core.UserOrGroup>, filter: core.KazFilter, requestId: number): void {
    ...
    public send_getCountAllDeadlines(token: string, beginDate: Int64, endDate: Int64, usersOrGroups: Array<core.UserOrGroup>, filter: core.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_getAllGroupedDeadlines(token: string, beginDate: Int64, endDate: Int64, usersOrGroups: Array<core.UserOrGroup>, filter: core.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_getAllReassignments(token: string, beginDate: Int64, endDate: Int64, filter: core.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_getAllWeekendDictionaries(token: string, filter: core.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_changeWeekendDictionaries(token: string, toUpdate: Array<WeekendDictionary.WeekendDictionary>, toRemove: Array<string>, filter: core.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_populateWeekends(token: string, dateFrom: Int64, dateTo: Int64, filter: core.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
...
export interface IHandler {
    getAllDeadlines(token: string, beginDate: Int64, endDate: Int64, usersOrGroups: Array<core.UserOrGroup>, filter: core.KazFilter): Array<Deadline.Deadline> | Promise<Array<Deadline.Deadline>>;
    getCountAllDeadlines(token: string, beginDate: Int64, endDate: Int64, usersOrGroups: Array<core.UserOrGroup>, filter: core.KazFilter): number | Promise<number>;
    getAllGroupedDeadlines(token: string, beginDate: Int64, endDate: Int64, usersOrGroups: Array<core.UserOrGroup>, filter: core.KazFilter): Map<Int64, Int64> | Promise<Map<Int64, Int64>>;
    getAllReassignments(token: string, beginDate: Int64, endDate: Int64, filter: core.KazFilter): Array<core.DocumentReassign> | Promise<Array<core.DocumentReassign>>;
    getAllWeekendDictionaries(token: string, filter: core.KazFilter): Array<WeekendDictionary.WeekendDictionary> | Promise<Array<WeekendDictionary.WeekendDictionary>>;
    changeWeekendDictionaries(token: string, toUpdate: Array<WeekendDictionary.WeekendDictionary>, toRemove: Array<string>, filter: core.KazFilter): Array<WeekendDictionary.WeekendDictionary> | Promise<Array<WeekendDictionary.WeekendDictionary>>;
    populateWeekends(token: string, dateFrom: Int64, dateTo: Int64, filter: core.KazFilter): Array<WeekendDictionary.WeekendDictionary> | Promise<Array<WeekendDictionary.WeekendDictionary>>;
...
export class Processor {
    ...
    public process_getAllReassignments(requestId: number, input: thrift.TProtocol, output: thrift.TProtocol): void {
        new Promise<Array<core.DocumentReassign>>((resolve, reject): void => {
            try {
        ...
        }).then((data: Array<core.DocumentReassign>): void => {
