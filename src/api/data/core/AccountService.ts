            ...
            switch (fieldId) {
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_2: core.Account = core.Account.read(input);
...
export interface ICreateOrUpdateAccountExtendedArgsArgs {
    ...
    securityKey: string;
    password: string;
    usersToAdd: Array<core.UserOrGroup>;
    delegates: core.AccountUserDelegates;
}
export class CreateOrUpdateAccountExtendedArgs {
    ...
    public securityKey: string;
    public password: string;
    public usersToAdd: Array<core.UserOrGroup>;
    public delegates: core.AccountUserDelegates;
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.usersToAdd != null) {
            ...
            this.usersToAdd.forEach((value_11: core.UserOrGroup): void => {
    ...
    public static read(input: thrift.TProtocol): CreateOrUpdateAccountExtendedArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 6:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_18: core.AccountUserDelegates = core.AccountUserDelegates.read(input);
    ...
    public static read(input: thrift.TProtocol): CreateOrUpdateAccountResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_19: core.Account = core.Account.read(input);
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_20: core.PreconditionException = core.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_21: core.ServerException = core.ServerException.read(input);
    ...
    public static read(input: thrift.TProtocol): GetAccountResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_22: core.Account = core.Account.read(input);
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_23: core.PreconditionException = core.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_24: core.ServerException = core.ServerException.read(input);
...
export class GetAllAccountsResult {
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.success != null) {
            ...
            this.success.forEach((value_25: core.Account): void => {
    ...
    public static read(input: thrift.TProtocol): GetAllAccountsResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_26: Array<core.Account> = new Array<core.Account>();
                        const metadata_2: thrift.TList = input.readListBegin();
                        const size_2: number = metadata_2.size;
                        for (let i_2: number = 0; i_2 < size_2; i_2++) {
                            const value_27: core.Account = core.Account.read(input);
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_28: core.PreconditionException = core.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_29: core.ServerException = core.ServerException.read(input);
    ...
    public static read(input: thrift.TProtocol): GetCountAllAccountsResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_31: core.PreconditionException = core.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_32: core.ServerException = core.ServerException.read(input);
    ...
    public static read(input: thrift.TProtocol): CreateOrUpdateAccountExtendedResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_33: core.Account = core.Account.read(input);
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_34: core.PreconditionException = core.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_35: core.ServerException = core.ServerException.read(input);
...
export class Client {
    ...
    public createOrUpdateAccount(token: string, account: core.Account, securityKey: string, password: string): Promise<core.Account> {
        const requestId: number = this.incrementSeqId();
        return new Promise<core.Account>((resolve, reject): void => {
    ...
    public getAccount(token: string, accountId: string): Promise<core.Account> {
        const requestId: number = this.incrementSeqId();
        return new Promise<core.Account>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
    ...
    public getAllAccounts(token: string, filter: core.KazFilter): Promise<Array<core.Account>> {
        const requestId: number = this.incrementSeqId();
    ...
    public getCountAllAccounts(token: string, filter: core.KazFilter): Promise<number> {
        const requestId: number = this.incrementSeqId();
    ...
    public createOrUpdateAccountExtended(token: string, account: core.Account, securityKey: string, password: string, usersToAdd: Array<core.UserOrGroup>, delegates: core.AccountUserDelegates): Promise<core.Account> {
        const requestId: number = this.incrementSeqId();
        return new Promise<core.Account>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
    ...
    public send_createOrUpdateAccount(token: string, account: core.Account, securityKey: string, password: string, requestId: number): void {
    ...
    public send_getAllAccounts(token: string, filter: core.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_getCountAllAccounts(token: string, filter: core.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_createOrUpdateAccountExtended(token: string, account: core.Account, securityKey: string, password: string, usersToAdd: Array<core.UserOrGroup>, delegates: core.AccountUserDelegates, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
...
export interface IHandler {
    createOrUpdateAccount(token: string, account: core.Account, securityKey: string, password: string): core.Account | Promise<core.Account>;
    getAccount(token: string, accountId: string): core.Account | Promise<core.Account>;
    getAllAccounts(token: string, filter: core.KazFilter): Array<core.Account> | Promise<Array<core.Account>>;
    getCountAllAccounts(token: string, filter: core.KazFilter): number | Promise<number>;
    createOrUpdateAccountExtended(token: string, account: core.Account, securityKey: string, password: string, usersToAdd: Array<core.UserOrGroup>, delegates: core.AccountUserDelegates): core.Account | Promise<core.Account>;
}
export class Processor {
    ...
    public process_createOrUpdateAccount(requestId: number, input: thrift.TProtocol, output: thrift.TProtocol): void {
        new Promise<core.Account>((resolve, reject): void => {
            try {
