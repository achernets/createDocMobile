...
export class GetAllDeadlineHistoriesResult {
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.success != null) {
            ...
            this.success.forEach((value_14: core.DeadlineHistory): void => {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_15: Array<core.DeadlineHistory> = new Array<core.DeadlineHistory>();
                        const metadata_1: thrift.TList = input.readListBegin();
                        const size_1: number = metadata_1.size;
                        for (let i_1: number = 0; i_1 < size_1; i_1++) {
                            const value_16: core.DeadlineHistory = core.DeadlineHistory.read(input);
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_17: core.PreconditionException = core.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_18: core.ServerException = core.ServerException.read(input);
...
export interface IGetHistoryPageResultArgs {
    success?: core.HistoryPage;
    validError?: core.PreconditionException;
    error?: core.ServerException;
}
export class GetHistoryPageResult {
    public success?: core.HistoryPage;
    public validError?: core.PreconditionException;
    public error?: core.ServerException;
    ...
    public static read(input: thrift.TProtocol): GetHistoryPageResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_19: core.HistoryPage = core.HistoryPage.read(input);
    ...
    public static read(input: thrift.TProtocol): GetUserHistoryPageResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_27: core.HistoryPage = core.HistoryPage.read(input);
    ...
    public static read(input: thrift.TProtocol): GetGroupHistoryPageResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_30: core.HistoryPage = core.HistoryPage.read(input);
...
export class Client {
    ...
    public getAllDeadlineHistories(token: string, filter: core.KazFilter): Promise<Array<core.DeadlineHistory>> {
        const requestId: number = this.incrementSeqId();
        return new Promise<Array<core.DeadlineHistory>>((resolve, reject): void => {
    ...
    public getHistoryPage(token: string, filter: core.KazFilter, useAdmin: boolean): Promise<core.HistoryPage> {
        const requestId: number = this.incrementSeqId();
        return new Promise<core.HistoryPage>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
                if (error != null) {
                    reject(error);
    ...
    public getUserHistoryPage(token: string, userId: string, filter: core.KazFilter): Promise<core.HistoryPage> {
        const requestId: number = this.incrementSeqId();
        return new Promise<core.HistoryPage>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
    ...
    public getGroupHistoryPage(token: string, groupId: string, filter: core.KazFilter): Promise<core.HistoryPage> {
        const requestId: number = this.incrementSeqId();
        return new Promise<core.HistoryPage>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
    ...
    public send_getAllDeadlineHistories(token: string, filter: core.KazFilter, requestId: number): void {
    ...
    public send_getHistoryPage(token: string, filter: core.KazFilter, useAdmin: boolean, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_getUserHistoryPage(token: string, userId: string, filter: core.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_getGroupHistoryPage(token: string, groupId: string, filter: core.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
...
export interface IHandler {
    getAllDeadlineHistories(token: string, filter: core.KazFilter): Array<core.DeadlineHistory> | Promise<Array<core.DeadlineHistory>>;
    getHistoryPage(token: string, filter: core.KazFilter, useAdmin: boolean): core.HistoryPage | Promise<core.HistoryPage>;
    getChangeLogByHistory(token: string, historyId: string): Array<ChangeLog.ChangeLog> | Promise<Array<ChangeLog.ChangeLog>>;
    getUserHistoryPage(token: string, userId: string, filter: core.KazFilter): core.HistoryPage | Promise<core.HistoryPage>;
    getGroupHistoryPage(token: string, groupId: string, filter: core.KazFilter): core.HistoryPage | Promise<core.HistoryPage>;
}
export class Processor {
    ...
    public process_getAllDeadlineHistories(requestId: number, input: thrift.TProtocol, output: thrift.TProtocol): void {
        new Promise<Array<core.DeadlineHistory>>((resolve, reject): void => {
            try {
        ...
        }).then((data: Array<core.DeadlineHistory>): void => {
    ...
    public process_getHistoryPage(requestId: number, input: thrift.TProtocol, output: thrift.TProtocol): void {
        new Promise<core.HistoryPage>((resolve, reject): void => {
            try {
        ...
        }).then((data: core.HistoryPage): void => {
