...
export class ExtSignOperation {
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.dataToSignList != null) {
            ...
            this.dataToSignList.forEach((value_1: core.SignData): void => {
            ...
            switch (fieldId) {
                ...
                case 4:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_5: Array<core.SignData> = new Array<core.SignData>();
                        const metadata_1: thrift.TList = input.readListBegin();
                        const size_1: number = metadata_1.size;
                        for (let i_1: number = 0; i_1 < size_1; i_1++) {
                            const value_6: core.SignData = core.SignData.read(input);
