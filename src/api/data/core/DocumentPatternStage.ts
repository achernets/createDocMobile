...
export interface IDocumentPatternStageArgs {
    ...
    postFunctionId?: core.CompositeId;
    ...
    setDecisionFunctionId?: core.CompositeId;
...
export class DocumentPatternStage {
    ...
    public postFunctionId?: core.CompositeId;
    ...
    public setDecisionFunctionId?: core.CompositeId;
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.userOrGroups != null) {
            ...
            this.userOrGroups.forEach((value_1: core.UserOrGroup): void => {
            ...
            switch (fieldId) {
                ...
                case 17:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_24: Array<core.UserOrGroup> = new Array<core.UserOrGroup>();
                        const metadata_1: thrift.TList = input.readListBegin();
                        const size_1: number = metadata_1.size;
                        for (let i_1: number = 0; i_1 < size_1; i_1++) {
                            const value_25: core.UserOrGroup = core.UserOrGroup.read(input);
                ...
                case 43:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_53: core.CompositeId = core.CompositeId.read(input);
                ...
                case 44:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_54: core.CompositeId = core.CompositeId.read(input);
                ...
                case 75:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_88: core.CompositeId = core.CompositeId.read(input);
