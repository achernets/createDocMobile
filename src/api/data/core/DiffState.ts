...
export interface IDiffStateArgs {
    ...
    group?: core.UserOrGroup;
    availableStage?: core.AvailablePatternStage;
    contentItem?: core.ContentItem;
    nomenclatureNumber?: core.NomenclatureNumber;
    hbSettings?: HBSettings.HBSettings;
}
export class DiffState {
    public user?: core.UserOrGroup;
    public group?: core.UserOrGroup;
    public availableStage?: core.AvailablePatternStage;
    public contentItem?: core.ContentItem;
    ...
    public static read(input: thrift.TProtocol): DiffState {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 3:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_3: core.AvailablePatternStage = core.AvailablePatternStage.read(input);
                ...
                case 4:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_4: core.ContentItem = core.ContentItem.read(input);
                ...
                case 5:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_5: core.NomenclatureNumber = core.NomenclatureNumber.read(input);
