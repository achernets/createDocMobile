...
export class CustomFilterItem {
    public id?: string;
    public field?: string;
    public fType?: core.FilterFieldType;
            ...
            switch (fieldId) {
                ...
                case 3:
                    if (fieldType === thrift.Thrift.Type.I32) {
                        const value_3: core.FilterFieldType = input.readI32();
                        _args.fType = value_3;
                    }
                    else {
                        input.skip(fieldType);
                ...
                case 4:
                    if (fieldType === thrift.Thrift.Type.I32) {
                        const value_4: core.FilterCondition = input.readI32();
