            ...
            switch (fieldId) {
                ...
                case 6:
                    if (fieldType === thrift.Thrift.Type.I32) {
                        const value_6: core.KeyState = input.readI32();
                ...
                case 7:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_7: core.CertificateInfo = core.CertificateInfo.read(input);
