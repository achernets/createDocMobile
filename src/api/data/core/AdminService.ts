...
export interface ICreateOrUpdateFileStorageArgsArgs {
    ...
    password: string;
    accountsToAdd: Array<core.Account>;
    accountsToRemove: Array<core.Account>;
}
export class CreateOrUpdateFileStorageArgs {
    public token: string;
    public fileStorage: core.FileStorage;
    public password: string;
    public accountsToAdd: Array<core.Account>;
    public accountsToRemove: Array<core.Account>;
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.accountsToAdd != null) {
            ...
            this.accountsToAdd.forEach((value_3: core.Account): void => {
        ...
        if (this.accountsToRemove != null) {
            ...
            this.accountsToRemove.forEach((value_4: core.Account): void => {
    ...
    public static read(input: thrift.TProtocol): CreateOrUpdateFileStorageArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_6: core.FileStorage = core.FileStorage.read(input);
                ...
                case 4:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_8: Array<core.Account> = new Array<core.Account>();
                        const metadata_1: thrift.TList = input.readListBegin();
                        const size_1: number = metadata_1.size;
                        for (let i_1: number = 0; i_1 < size_1; i_1++) {
                            const value_9: core.Account = core.Account.read(input);
                ...
                case 5:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_10: Array<core.Account> = new Array<core.Account>();
                        const metadata_2: thrift.TList = input.readListBegin();
                        const size_2: number = metadata_2.size;
                        for (let i_2: number = 0; i_2 < size_2; i_2++) {
                            const value_11: core.Account = core.Account.read(input);
    ...
    public static read(input: thrift.TProtocol): GetAllFileStoragesArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_13: core.KazFilter = core.KazFilter.read(input);
    ...
    public static read(input: thrift.TProtocol): CreateOrUpdateNewsArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_28: core.News = core.News.read(input);
                        _args.news = value_28;
                    }
                    else {
                        input.skip(fieldType);
    ...
    public static read(input: thrift.TProtocol): GetAllExternalModulesArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_36: core.KazFilter = core.KazFilter.read(input);
    ...
    public static read(input: thrift.TProtocol): GetCountAllExternalModulesArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_38: core.KazFilter = core.KazFilter.read(input);
...
export class CreateOrUpdateExternalModuleArgs {
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.addAccountIds != null) {
            ...
            this.addAccountIds.forEach((value_41: string): void => {
        ...
        if (this.deleteAccountIds != null) {
            ...
            this.deleteAccountIds.forEach((value_42: string): void => {
    ...
    public static read(input: thrift.TProtocol): CreateOrUpdateExternalModuleArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_44: ExternalModule.ExternalModule = ExternalModule.ExternalModule.read(input);
                        _args.externalModule = value_44;
                    }
                    else {
                        input.skip(fieldType);
                    }
                ...
                case 3:
                    if (fieldType === thrift.Thrift.Type.STRING) {
                        ...
                        _args.userLoginForNewRegistration = value_45;
                    }
                    else {
                        input.skip(fieldType);
                    }
                ...
                case 6:
                    if (fieldType === thrift.Thrift.Type.SET) {
                        ...
                        input.readSetEnd();
                        _args.deleteAccountIds = value_49;
                    }
                    else {
                        input.skip(fieldType);
                    }
            ...
            switch (fieldId) {
                ...
                case 3:
                    if (fieldType === thrift.Thrift.Type.BOOL) {
                        ...
                        _args.removeDeletedStages = value_53;
                    }
                    else {
                        input.skip(fieldType);
                    }
            ...
            switch (fieldId) {
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRING) {
                        ...
                        _args.extModuleCheckValue = value_60;
                    }
                    else {
                        input.skip(fieldType);
                    }
    ...
    public static read(input: thrift.TProtocol): GetAllDocumentAttachmentsArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_62: core.KazFilter = core.KazFilter.read(input);
            ...
            switch (fieldId) {
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRING) {
                        ...
                        _args.fillDocPatternId = value_64;
                    }
                    else {
                        input.skip(fieldType);
                    }
...
export class ChangeExecutorForPatternStagesArgs {
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.patternIds != null) {
            ...
            this.patternIds.forEach((value_68: string): void => {
        ...
        if (this.usersOrGroups != null) {
            ...
            this.usersOrGroups.forEach((value_69: core.UserOrGroup): void => {
                value_69.write(output);
            });
            output.writeListEnd();
            output.writeFieldEnd();
        }
    ...
    public static read(input: thrift.TProtocol): ChangeExecutorForPatternStagesArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_71: Array<string> = new Array<string>();
                ...
                case 3:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_73: core.UserOrGroup = core.UserOrGroup.read(input);
                        _args.userOrGroup = value_73;
                    }
                    else {
                        input.skip(fieldType);
                    }
                ...
                case 4:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_74: Array<core.UserOrGroup> = new Array<core.UserOrGroup>();
                        const metadata_9: thrift.TList = input.readListBegin();
                        const size_9: number = metadata_9.size;
                        for (let i_9: number = 0; i_9 < size_9; i_9++) {
                            const value_75: core.UserOrGroup = core.UserOrGroup.read(input);
                            value_74.push(value_75);
                        }
                        input.readListEnd();
                        _args.usersOrGroups = value_74;
                    }
                    else {
                        input.skip(fieldType);
                    }
    ...
    public static read(input: thrift.TProtocol): GetAllUsersRelativeToAccountArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_84: core.KazFilter = core.KazFilter.read(input);
    ...
    public static read(input: thrift.TProtocol): GetCountAllUsersRelativeToAccountArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_86: core.KazFilter = core.KazFilter.read(input);
                        _args.filter = value_86;
                    }
                    else {
                        input.skip(fieldType);
                    }
...
export class ChangeUserAccountsArgs {
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.accountIdsToAdd != null) {
            output.writeFieldBegin("accountIdsToAdd", thrift.Thrift.Type.SET, 3);
            output.writeSetBegin(thrift.Thrift.Type.STRING, this.accountIdsToAdd.size);
            this.accountIdsToAdd.forEach((value_87: string): void => {
                output.writeString(value_87);
            });
            output.writeSetEnd();
            output.writeFieldEnd();
        }
        if (this.accountIdsToRemove != null) {
            output.writeFieldBegin("accountIdsToRemove", thrift.Thrift.Type.SET, 4);
            output.writeSetBegin(thrift.Thrift.Type.STRING, this.accountIdsToRemove.size);
            this.accountIdsToRemove.forEach((value_88: string): void => {
                output.writeString(value_88);
            });
            output.writeSetEnd();
            output.writeFieldEnd();
        }
            ...
            switch (fieldId) {
                ...
                case 3:
                    if (fieldType === thrift.Thrift.Type.SET) {
                        ...
                        input.readSetEnd();
                        _args.accountIdsToAdd = value_91;
                    }
                    else {
                        input.skip(fieldType);
                    }
                ...
                case 4:
                    if (fieldType === thrift.Thrift.Type.SET) {
                        const value_93: Set<string> = new Set<string>();
                        ...
                        for (let i_11: number = 0; i_11 < size_11; i_11++) {
                            ...
                            value_93.add(value_94);
                        }
                        input.readSetEnd();
                        _args.accountIdsToRemove = value_93;
                    }
                    else {
                        input.skip(fieldType);
                    }
    ...
    public static read(input: thrift.TProtocol): RunSchedulerArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 3:
                    if (fieldType === thrift.Thrift.Type.BOOL) {
                        const value_98: boolean = input.readBool();
                        _args.wait = value_98;
                    }
                    else {
                        input.skip(fieldType);
    ...
    public static read(input: thrift.TProtocol): GetAllUsersExtArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_104: core.KazFilter = core.KazFilter.read(input);
    ...
    public static read(input: thrift.TProtocol): GetCountAllUsersExtArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_106: core.KazFilter = core.KazFilter.read(input);
    ...
    public static read(input: thrift.TProtocol): GetAllUserNotificationsArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 4:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_110: core.KazFilter = core.KazFilter.read(input);
    ...
    public static read(input: thrift.TProtocol): GetAllNotificationsArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_112: core.KazFilter = core.KazFilter.read(input);
                        _args.filter = value_112;
                    }
                    else {
                        input.skip(fieldType);
                    }
            ...
            switch (fieldId) {
                ...
                case 4:
                    if (fieldType === thrift.Thrift.Type.BOOL) {
                        ...
                        _args.resetMoveError = value_116;
                    }
                    else {
                        input.skip(fieldType);
                    }
    ...
    public static read(input: thrift.TProtocol): ResendDocumentToExternalModuleArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 3:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_119: core.DocumentAccessPolicy = core.DocumentAccessPolicy.read(input);
                        _args.accessPolicy = value_119;
                    }
                    else {
                        input.skip(fieldType);
                    }
    ...
    public static read(input: thrift.TProtocol): GetAllSessionsArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_121: core.KazFilter = core.KazFilter.read(input);
    ...
    public static read(input: thrift.TProtocol): GetCountAllSessionsArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_123: core.KazFilter = core.KazFilter.read(input);
                        _args.filter = value_123;
                    }
                    else {
                        input.skip(fieldType);
                    }
    ...
    public static read(input: thrift.TProtocol): ConfirmUserPublicKeyArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 3:
                    if (fieldType === thrift.Thrift.Type.BOOL) {
                        const value_126: boolean = input.readBool();
                        _args.confirm = value_126;
                    }
                    else {
                        input.skip(fieldType);
                    }
    ...
    public static read(input: thrift.TProtocol): CloseSessionArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRING) {
                        const value_128: string = input.readString();
                        _args.sessionId = value_128;
                    }
                    else {
                        input.skip(fieldType);
                    }
    ...
    public static read(input: thrift.TProtocol): CopyPersonalAccessArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_130: CopyPersonalAccessSettings.CopyPersonalAccessSettings = CopyPersonalAccessSettings.CopyPersonalAccessSettings.read(input);
                        _args.copyPersonalAccessSettings = value_130;
                    }
                    else {
                        input.skip(fieldType);
                    }
    ...
    public static read(input: thrift.TProtocol): GetAllLicensesArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_132: core.KazFilter = core.KazFilter.read(input);
    ...
    public static read(input: thrift.TProtocol): GetCountAllLicensesArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_134: core.KazFilter = core.KazFilter.read(input);
                        _args.filter = value_134;
                    }
                    else {
                        input.skip(fieldType);
                    }
    ...
    public static read(input: thrift.TProtocol): UploadLicensesArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRING) {
                        const value_135: string = input.readString();
                        _args.token = value_135;
                    }
                    else {
                        input.skip(fieldType);
                    }
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRING) {
                        const value_136: Buffer = input.readBinary();
                        _args.fileContentBytes = value_136;
                    }
                    else {
                        input.skip(fieldType);
                    }
                ...
                case 3:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_137: core.AccountGroup = core.AccountGroup.read(input);
                        _args.accountGroup = value_137;
                    }
                    else {
                        input.skip(fieldType);
                    }
                ...
                case 4:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_138: core.Account = core.Account.read(input);
                        _args.account = value_138;
                    }
                    else {
                        input.skip(fieldType);
                    }
                ...
                case 5:
                    if (fieldType === thrift.Thrift.Type.BOOL) {
                        const value_139: boolean = input.readBool();
                        _args.autoAssignment = value_139;
                    }
                    else {
                        input.skip(fieldType);
                    }
                ...
                case 6:
                    if (fieldType === thrift.Thrift.Type.I32) {
                        const value_140: number = input.readI32();
                        _args.autoAssignmentOrder = value_140;
                    }
                    else {
                        input.skip(fieldType);
                    }
...
export class RemoveLicensesArgs {
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.lkeys != null) {
            ...
            this.lkeys.forEach((value_141: string): void => {
                output.writeString(value_141);
            });
            output.writeListEnd();
            output.writeFieldEnd();
        }
    ...
    public static read(input: thrift.TProtocol): RemoveLicensesArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_143: Array<string> = new Array<string>();
    ...
    public static read(input: thrift.TProtocol): UpdateLicenseArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_146: License.License = License.License.read(input);
                        _args.license = value_146;
                    }
                    else {
                        input.skip(fieldType);
                    }
    ...
    public static read(input: thrift.TProtocol): ReleaseLicenceArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 3:
                    if (fieldType === thrift.Thrift.Type.BOOL) {
                        const value_149: boolean = input.readBool();
                        _args.cancelAutoAssignment = value_149;
                    }
                    else {
                        input.skip(fieldType);
                    }
    ...
    public static read(input: thrift.TProtocol): GetLicenseModulePageArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_151: core.KazFilter = core.KazFilter.read(input);
                        _args.filter = value_151;
                    }
                    else {
                        input.skip(fieldType);
                    }
    ...
    public static read(input: thrift.TProtocol): UploadLicenseModuleArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRING) {
                        const value_153: Buffer = input.readBinary();
                        _args.fileContentBytes = value_153;
                    }
                    else {
                        input.skip(fieldType);
                    }
    ...
    public static read(input: thrift.TProtocol): CreateOrUpdateArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_157: CharMatchingDictionary.CharMatchingDictionary = CharMatchingDictionary.CharMatchingDictionary.read(input);
                        _args.dictionary = value_157;
                    }
                    else {
                        input.skip(fieldType);
                    }
    ...
    public static read(input: thrift.TProtocol): GetAllCharMatchingDictionariesArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_159: core.KazFilter = core.KazFilter.read(input);
                        _args.filter = value_159;
                    }
                    else {
                        input.skip(fieldType);
                    }
    ...
    public static read(input: thrift.TProtocol): SetTranslationsArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 3:
                    if (fieldType === thrift.Thrift.Type.STRING) {
                        const value_166: Buffer = input.readBinary();
                        _args.langFile = value_166;
                    }
                    else {
                        input.skip(fieldType);
                    }
    ...
    public static read(input: thrift.TProtocol): GetDroolLogFileArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 3:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_169: core.DocumentAccessPolicy = core.DocumentAccessPolicy.read(input);
                        _args.policy = value_169;
                    }
                    else {
                        input.skip(fieldType);
                    }
    ...
    public static read(input: thrift.TProtocol): GetAllJobTasksArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_173: core.KazFilter = core.KazFilter.read(input);
    ...
    public static read(input: thrift.TProtocol): GetCountAllJobTasksArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_175: core.KazFilter = core.KazFilter.read(input);
    ...
    public static read(input: thrift.TProtocol): GetAllUserContentItemsArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_181: core.KazFilter = core.KazFilter.read(input);
...
export class ChangeUserContentItemsArgs {
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.contentItems != null) {
            ...
            this.contentItems.forEach((value_182: core.ContentItem): void => {
    ...
    public static read(input: thrift.TProtocol): ChangeUserContentItemsArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_184: Array<core.ContentItem> = new Array<core.ContentItem>();
                        ...
                        for (let i_13: number = 0; i_13 < size_13; i_13++) {
                            const value_185: core.ContentItem = core.ContentItem.read(input);
                            value_184.push(value_185);
                        }
                        input.readListEnd();
                        _args.contentItems = value_184;
                    }
                    else {
                        input.skip(fieldType);
                    }
    ...
    public static read(input: thrift.TProtocol): GetAllUserContentHoldersArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_187: core.KazFilter = core.KazFilter.read(input);
                        _args.filter = value_187;
                    }
                    else {
                        input.skip(fieldType);
                    }
...
export class ChangeUserContentHoldersArgs {
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.toUpdate != null) {
            ...
            this.toUpdate.forEach((value_188: core.ContentHolder): void => {
        ...
        if (this.toRemoveIds != null) {
            ...
            this.toRemoveIds.forEach((value_189: string): void => {
    ...
    public static read(input: thrift.TProtocol): ChangeUserContentHoldersArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_191: Array<core.ContentHolder> = new Array<core.ContentHolder>();
                        ...
                        for (let i_14: number = 0; i_14 < size_14; i_14++) {
                            const value_192: core.ContentHolder = core.ContentHolder.read(input);
                            value_191.push(value_192);
                        }
                        input.readListEnd();
                        _args.toUpdate = value_191;
                    }
                    else {
                        input.skip(fieldType);
                    }
                ...
                case 3:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_193: Array<string> = new Array<string>();
            ...
            switch (fieldId) {
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRING) {
                        ...
                        _args.accountGroupId = value_196;
                    }
                    else {
                        input.skip(fieldType);
                    }
                ...
                case 4:
                    if (fieldType === thrift.Thrift.Type.I64) {
                        const value_198: Int64 = input.readI64();
                        _args.dateFrom = value_198;
                    }
                    else {
                        input.skip(fieldType);
                    }
                ...
                case 5:
                    if (fieldType === thrift.Thrift.Type.I64) {
                        const value_199: Int64 = input.readI64();
                        _args.dateTo = value_199;
                    }
                    else {
                        input.skip(fieldType);
                    }
...
export class CreateOrUpdateUsersArgs {
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.users != null) {
            ...
            this.users.forEach((value_209: core.UserOrGroup): void => {
                value_209.write(output);
            });
            output.writeListEnd();
            output.writeFieldEnd();
        }
    ...
    public static read(input: thrift.TProtocol): CreateOrUpdateUsersArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_211: Array<core.UserOrGroup> = new Array<core.UserOrGroup>();
                        ...
                        for (let i_16: number = 0; i_16 < size_16; i_16++) {
                            const value_212: core.UserOrGroup = core.UserOrGroup.read(input);
                            value_211.push(value_212);
                        }
                        input.readListEnd();
                        _args.users = value_211;
                    }
                    else {
                        input.skip(fieldType);
                    }
                ...
                case 3:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_213: UserOptions.UserOptions = UserOptions.UserOptions.read(input);
                        _args.options = value_213;
                    }
                    else {
                        input.skip(fieldType);
                    }
...
export class GetAvailableFileStorageListResult {
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.success != null) {
            ...
            this.success.forEach((value_214: core.AvailableFileStorage): void => {
    ...
    public static read(input: thrift.TProtocol): GetAvailableFileStorageListResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_215: Array<core.AvailableFileStorage> = new Array<core.AvailableFileStorage>();
                        ...
                        for (let i_17: number = 0; i_17 < size_17; i_17++) {
                            const value_216: core.AvailableFileStorage = core.AvailableFileStorage.read(input);
                            value_215.push(value_216);
                        }
                        input.readListEnd();
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_217: core.PreconditionException = core.PreconditionException.read(input);
                        _args.validError = value_217;
                    }
                    else {
                        input.skip(fieldType);
                    }
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_218: core.ServerException = core.ServerException.read(input);
                        _args.error = value_218;
                    }
                    else {
                        input.skip(fieldType);
                    }
...
export interface ICreateOrUpdateFileStorageResultArgs {
    success?: core.FileStorage;
    validError?: core.PreconditionException;
    error?: core.ServerException;
}
export class CreateOrUpdateFileStorageResult {
    public success?: core.FileStorage;
    public validError?: core.PreconditionException;
    public error?: core.ServerException;
    ...
    public static read(input: thrift.TProtocol): CreateOrUpdateFileStorageResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_219: core.FileStorage = core.FileStorage.read(input);
                        _args.success = value_219;
                    }
                    else {
                        input.skip(fieldType);
                    }
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_220: core.PreconditionException = core.PreconditionException.read(input);
                        _args.validError = value_220;
                    }
                    else {
                        input.skip(fieldType);
                    }
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_221: core.ServerException = core.ServerException.read(input);
                        _args.error = value_221;
                    }
                    else {
                        input.skip(fieldType);
                    }
...
export interface IGetAllFileStoragesResultArgs {
    success?: Array<core.FileStorage>;
    validError?: core.PreconditionException;
    error?: core.ServerException;
}
export class GetAllFileStoragesResult {
    public success?: Array<core.FileStorage>;
    public validError?: core.PreconditionException;
    public error?: core.ServerException;
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.success != null) {
            output.writeFieldBegin("success", thrift.Thrift.Type.LIST, 0);
            output.writeListBegin(thrift.Thrift.Type.STRUCT, this.success.length);
            this.success.forEach((value_222: core.FileStorage): void => {
                value_222.write(output);
            });
            output.writeListEnd();
            output.writeFieldEnd();
        }
    ...
    public static read(input: thrift.TProtocol): GetAllFileStoragesResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_223: Array<core.FileStorage> = new Array<core.FileStorage>();
                        ...
                        for (let i_18: number = 0; i_18 < size_18; i_18++) {
                            const value_224: core.FileStorage = core.FileStorage.read(input);
                            value_223.push(value_224);
                        }
                        input.readListEnd();
                        _args.success = value_223;
                    }
                    else {
                        input.skip(fieldType);
                    }
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_225: core.PreconditionException = core.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_226: core.ServerException = core.ServerException.read(input);
    ...
    public static read(input: thrift.TProtocol): GetCountAllFileStoragesResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.I32) {
                        const value_227: number = input.readI32();
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_228: core.PreconditionException = core.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_229: core.ServerException = core.ServerException.read(input);
    ...
    public static read(input: thrift.TProtocol): RemoveFileStoragesResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.BOOL) {
                        const value_230: boolean = input.readBool();
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_231: core.PreconditionException = core.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_232: core.ServerException = core.ServerException.read(input);
    ...
    public static read(input: thrift.TProtocol): MoveAttachmentResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_234: core.PreconditionException = core.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_235: core.ServerException = core.ServerException.read(input);
    ...
    public static read(input: thrift.TProtocol): CreateOrUpdateNewsResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_236: core.News = core.News.read(input);
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_237: core.PreconditionException = core.PreconditionException.read(input);
                        _args.validError = value_237;
                    }
                    else {
                        input.skip(fieldType);
                    }
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_238: core.ServerException = core.ServerException.read(input);
                        _args.error = value_238;
                    }
                    else {
                        input.skip(fieldType);
                    }
    ...
    public static read(input: thrift.TProtocol): RemoveNewsResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.BOOL) {
                        const value_239: boolean = input.readBool();
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_240: core.PreconditionException = core.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_241: core.ServerException = core.ServerException.read(input);
...
export class GetAllExternalModulesResult {
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.success != null) {
            output.writeFieldBegin("success", thrift.Thrift.Type.LIST, 0);
            output.writeListBegin(thrift.Thrift.Type.STRUCT, this.success.length);
            this.success.forEach((value_242: ExternalModule.ExternalModule): void => {
    ...
    public static read(input: thrift.TProtocol): GetAllExternalModulesResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_243: Array<ExternalModule.ExternalModule> = new Array<ExternalModule.ExternalModule>();
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_245: core.PreconditionException = core.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_246: core.ServerException = core.ServerException.read(input);
    ...
    public static read(input: thrift.TProtocol): GetCountAllExternalModulesResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_248: core.PreconditionException = core.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_249: core.ServerException = core.ServerException.read(input);
    ...
    public static read(input: thrift.TProtocol): GetExternalModuleByIdResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_251: core.PreconditionException = core.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_252: core.ServerException = core.ServerException.read(input);
    ...
    public static read(input: thrift.TProtocol): CreateOrUpdateExternalModuleResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_253: ExternalModule.ExternalModule = ExternalModule.ExternalModule.read(input);
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_254: core.PreconditionException = core.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_255: core.ServerException = core.ServerException.read(input);
    ...
    public static read(input: thrift.TProtocol): RefreshExternalModuleResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_256: ExternalModule.ExternalModule = ExternalModule.ExternalModule.read(input);
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_257: core.PreconditionException = core.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_258: core.ServerException = core.ServerException.read(input);
    ...
    public static read(input: thrift.TProtocol): RemoveExternalModuleResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_260: core.PreconditionException = core.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_261: core.ServerException = core.ServerException.read(input);
    ...
    public static read(input: thrift.TProtocol): PingExternalModuleResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.BOOL) {
                        const value_262: boolean = input.readBool();
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_263: core.PreconditionException = core.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_264: core.ServerException = core.ServerException.read(input);
    ...
    public static read(input: thrift.TProtocol): PongExternalModuleResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.BOOL) {
                        const value_265: boolean = input.readBool();
                        _args.success = value_265;
                    }
                    else {
                        input.skip(fieldType);
                    }
...
export interface IGetAllDocumentAttachmentsResultArgs {
    success?: Array<core.Attachment>;
    validError?: core.PreconditionException;
    error?: core.ServerException;
}
export class GetAllDocumentAttachmentsResult {
    public success?: Array<core.Attachment>;
    public validError?: core.PreconditionException;
    public error?: core.ServerException;
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.success != null) {
            output.writeFieldBegin("success", thrift.Thrift.Type.LIST, 0);
            output.writeListBegin(thrift.Thrift.Type.STRUCT, this.success.length);
            this.success.forEach((value_268: core.Attachment): void => {
    ...
    public static read(input: thrift.TProtocol): GetAllDocumentAttachmentsResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_269: Array<core.Attachment> = new Array<core.Attachment>();
                        ...
                        for (let i_20: number = 0; i_20 < size_20; i_20++) {
                            const value_270: core.Attachment = core.Attachment.read(input);
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_271: core.PreconditionException = core.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_272: core.ServerException = core.ServerException.read(input);
...
export class GetAllFilledDocumentPatternStagesResult {
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.success != null) {
            output.writeFieldBegin("success", thrift.Thrift.Type.LIST, 0);
            output.writeListBegin(thrift.Thrift.Type.STRUCT, this.success.length);
            this.success.forEach((value_273: core.DocumentPatternStage): void => {
                value_273.write(output);
            });
            output.writeListEnd();
            output.writeFieldEnd();
        }
    ...
    public static read(input: thrift.TProtocol): GetAllFilledDocumentPatternStagesResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_274: Array<core.DocumentPatternStage> = new Array<core.DocumentPatternStage>();
                        ...
                        for (let i_21: number = 0; i_21 < size_21; i_21++) {
                            const value_275: core.DocumentPatternStage = core.DocumentPatternStage.read(input);
                            value_274.push(value_275);
                        }
                        input.readListEnd();
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_276: core.PreconditionException = core.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_277: core.ServerException = core.ServerException.read(input);
    ...
    public static read(input: thrift.TProtocol): ResetDocumentForceMoveErrorResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.I32) {
                        const value_278: number = input.readI32();
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_279: core.PreconditionException = core.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_280: core.ServerException = core.ServerException.read(input);
    ...
    public static read(input: thrift.TProtocol): ChangeExecutorForPatternStagesResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_282: core.PreconditionException = core.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_283: core.ServerException = core.ServerException.read(input);
    ...
    public static read(input: thrift.TProtocol): SetUserPublicKeyResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_285: core.PreconditionException = core.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_286: core.ServerException = core.ServerException.read(input);
    ...
    public static read(input: thrift.TProtocol): RemoveUserPublicKeyResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.BOOL) {
                        const value_287: boolean = input.readBool();
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_288: core.PreconditionException = core.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_289: core.ServerException = core.ServerException.read(input);
...
export class GetAllUsersRelativeToAccountResult {
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.success != null) {
            output.writeFieldBegin("success", thrift.Thrift.Type.LIST, 0);
            output.writeListBegin(thrift.Thrift.Type.STRUCT, this.success.length);
            this.success.forEach((value_290: UserAcc.UserAcc): void => {
                value_290.write(output);
            });
            output.writeListEnd();
            output.writeFieldEnd();
        }
    ...
    public static read(input: thrift.TProtocol): GetAllUsersRelativeToAccountResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_291: Array<UserAcc.UserAcc> = new Array<UserAcc.UserAcc>();
                        ...
                        for (let i_22: number = 0; i_22 < size_22; i_22++) {
                            const value_292: UserAcc.UserAcc = UserAcc.UserAcc.read(input);
                            value_291.push(value_292);
                        }
                        input.readListEnd();
                        _args.success = value_291;
                    }
                    else {
                        input.skip(fieldType);
                    }
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_293: core.PreconditionException = core.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_294: core.ServerException = core.ServerException.read(input);
    ...
    public static read(input: thrift.TProtocol): GetCountAllUsersRelativeToAccountResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.I32) {
                        const value_295: number = input.readI32();
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_296: core.PreconditionException = core.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_297: core.ServerException = core.ServerException.read(input);
    ...
    public static read(input: thrift.TProtocol): ChangeUserAccountsResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_299: core.PreconditionException = core.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_300: core.ServerException = core.ServerException.read(input);
    ...
    public static read(input: thrift.TProtocol): RunSchedulerResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_302: core.PreconditionException = core.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_303: core.ServerException = core.ServerException.read(input);
    ...
    public static read(input: thrift.TProtocol): ChangeEncryptKeyResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.BOOL) {
                        const value_304: boolean = input.readBool();
                        _args.success = value_304;
                    }
                    else {
                        input.skip(fieldType);
                    }
...
export class GetAllUsersExtResult {
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.success != null) {
            output.writeFieldBegin("success", thrift.Thrift.Type.LIST, 0);
            output.writeListBegin(thrift.Thrift.Type.STRUCT, this.success.length);
            this.success.forEach((value_307: UserExt.UserExt): void => {
    ...
    public static read(input: thrift.TProtocol): GetAllUsersExtResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_308: Array<UserExt.UserExt> = new Array<UserExt.UserExt>();
                        ...
                        for (let i_23: number = 0; i_23 < size_23; i_23++) {
                            const value_309: UserExt.UserExt = UserExt.UserExt.read(input);
    ...
    public static read(input: thrift.TProtocol): GetCountAllUsersExtResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.I32) {
                        const value_312: number = input.readI32();
                        _args.success = value_312;
                    }
                    else {
                        input.skip(fieldType);
                    }
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_313: core.PreconditionException = core.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_314: core.ServerException = core.ServerException.read(input);
...
export interface IGetAllUserNotificationsResultArgs {
    success?: Array<core.NotificationQueue>;
    validError?: core.PreconditionException;
    error?: core.ServerException;
}
export class GetAllUserNotificationsResult {
    public success?: Array<core.NotificationQueue>;
    public validError?: core.PreconditionException;
    public error?: core.ServerException;
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.success != null) {
            output.writeFieldBegin("success", thrift.Thrift.Type.LIST, 0);
            output.writeListBegin(thrift.Thrift.Type.STRUCT, this.success.length);
            this.success.forEach((value_315: core.NotificationQueue): void => {
    ...
    public static read(input: thrift.TProtocol): GetAllUserNotificationsResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_316: Array<core.NotificationQueue> = new Array<core.NotificationQueue>();
                        ...
                        for (let i_24: number = 0; i_24 < size_24; i_24++) {
                            const value_317: core.NotificationQueue = core.NotificationQueue.read(input);
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_318: core.PreconditionException = core.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_319: core.ServerException = core.ServerException.read(input);
...
export class GetAllNotificationsResult {
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.success != null) {
            output.writeFieldBegin("success", thrift.Thrift.Type.LIST, 0);
            output.writeListBegin(thrift.Thrift.Type.STRUCT, this.success.length);
            this.success.forEach((value_320: core.NotificationQueue): void => {
                value_320.write(output);
            });
            output.writeListEnd();
            output.writeFieldEnd();
        }
    ...
    public static read(input: thrift.TProtocol): GetAllNotificationsResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_321: Array<core.NotificationQueue> = new Array<core.NotificationQueue>();
                        ...
                        for (let i_25: number = 0; i_25 < size_25; i_25++) {
                            const value_322: core.NotificationQueue = core.NotificationQueue.read(input);
                            value_321.push(value_322);
                        }
                        input.readListEnd();
                        _args.success = value_321;
                    }
                    else {
                        input.skip(fieldType);
                    }
    ...
    public static read(input: thrift.TProtocol): ResendDocumentToExternalModuleResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.BOOL) {
                        const value_328: boolean = input.readBool();
                        _args.success = value_328;
                    }
                    else {
                        input.skip(fieldType);
                    }
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_329: core.PreconditionException = core.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_330: core.ServerException = core.ServerException.read(input);
...
export interface IGetAllSessionsResultArgs {
    success?: Array<core.AuthSession>;
    validError?: core.PreconditionException;
    error?: core.ServerException;
}
export class GetAllSessionsResult {
    public success?: Array<core.AuthSession>;
    public validError?: core.PreconditionException;
    public error?: core.ServerException;
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.success != null) {
            output.writeFieldBegin("success", thrift.Thrift.Type.LIST, 0);
            output.writeListBegin(thrift.Thrift.Type.STRUCT, this.success.length);
            this.success.forEach((value_331: core.AuthSession): void => {
                value_331.write(output);
            });
            output.writeListEnd();
            output.writeFieldEnd();
        }
    ...
    public static read(input: thrift.TProtocol): GetAllSessionsResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_332: Array<core.AuthSession> = new Array<core.AuthSession>();
                        ...
                        for (let i_26: number = 0; i_26 < size_26; i_26++) {
                            const value_333: core.AuthSession = core.AuthSession.read(input);
                            value_332.push(value_333);
                        }
                        input.readListEnd();
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_334: core.PreconditionException = core.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_335: core.ServerException = core.ServerException.read(input);
    ...
    public static read(input: thrift.TProtocol): GetCountAllSessionsResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.I32) {
                        const value_336: number = input.readI32();
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_337: core.PreconditionException = core.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_338: core.ServerException = core.ServerException.read(input);
    ...
    public static read(input: thrift.TProtocol): ConfirmUserPublicKeyResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_340: core.PreconditionException = core.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_341: core.ServerException = core.ServerException.read(input);
    ...
    public static read(input: thrift.TProtocol): CloseSessionResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.BOOL) {
                        const value_342: boolean = input.readBool();
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_343: core.PreconditionException = core.PreconditionException.read(input);
                        _args.validError = value_343;
                    }
                    else {
                        input.skip(fieldType);
                    }
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_344: core.ServerException = core.ServerException.read(input);
                        _args.error = value_344;
                    }
                    else {
                        input.skip(fieldType);
                    }
    ...
    public static read(input: thrift.TProtocol): CopyPersonalAccessResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.BOOL) {
                        const value_345: boolean = input.readBool();
                        _args.success = value_345;
                    }
                    else {
                        input.skip(fieldType);
                    }
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_346: core.PreconditionException = core.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_347: core.ServerException = core.ServerException.read(input);
...
export class GetAllLicensesResult {
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.success != null) {
            output.writeFieldBegin("success", thrift.Thrift.Type.LIST, 0);
            output.writeListBegin(thrift.Thrift.Type.STRUCT, this.success.length);
            this.success.forEach((value_348: License.License): void => {
                value_348.write(output);
            });
            output.writeListEnd();
            output.writeFieldEnd();
        }
    ...
    public static read(input: thrift.TProtocol): GetAllLicensesResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_349: Array<License.License> = new Array<License.License>();
                        ...
                        for (let i_27: number = 0; i_27 < size_27; i_27++) {
                            const value_350: License.License = License.License.read(input);
                            value_349.push(value_350);
                        }
                        input.readListEnd();
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_351: core.PreconditionException = core.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_352: core.ServerException = core.ServerException.read(input);
    ...
    public static read(input: thrift.TProtocol): GetCountAllLicensesResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.I32) {
                        const value_353: number = input.readI32();
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_354: core.PreconditionException = core.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_355: core.ServerException = core.ServerException.read(input);
...
export class UploadLicensesResult {
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.success != null) {
            output.writeFieldBegin("success", thrift.Thrift.Type.LIST, 0);
            output.writeListBegin(thrift.Thrift.Type.STRUCT, this.success.length);
            this.success.forEach((value_356: License.License): void => {
    ...
    public static read(input: thrift.TProtocol): UploadLicensesResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_357: Array<License.License> = new Array<License.License>();
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_359: core.PreconditionException = core.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_360: core.ServerException = core.ServerException.read(input);
    ...
    public static read(input: thrift.TProtocol): RemoveLicensesResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_362: core.PreconditionException = core.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_363: core.ServerException = core.ServerException.read(input);
    ...
    public static read(input: thrift.TProtocol): UpdateLicenseResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_364: License.License = License.License.read(input);
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_365: core.PreconditionException = core.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_366: core.ServerException = core.ServerException.read(input);
    ...
    public static read(input: thrift.TProtocol): ReleaseLicenceResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.BOOL) {
                        const value_367: boolean = input.readBool();
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_368: core.PreconditionException = core.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_369: core.ServerException = core.ServerException.read(input);
    ...
    public static read(input: thrift.TProtocol): GetLicenseModulePageResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_370: LicenseModulePage.LicenseModulePage = LicenseModulePage.LicenseModulePage.read(input);
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_371: core.PreconditionException = core.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_372: core.ServerException = core.ServerException.read(input);
    ...
    public static read(input: thrift.TProtocol): UploadLicenseModuleResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_373: LicenseModule.LicenseModule = LicenseModule.LicenseModule.read(input);
    ...
    public static read(input: thrift.TProtocol): RemoveLicenseModuleResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.BOOL) {
                        const value_376: boolean = input.readBool();
                        _args.success = value_376;
                    }
                    else {
                        input.skip(fieldType);
                    }
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_377: core.PreconditionException = core.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_378: core.ServerException = core.ServerException.read(input);
    ...
    public static read(input: thrift.TProtocol): CreateOrUpdateResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_380: core.PreconditionException = core.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_381: core.ServerException = core.ServerException.read(input);
...
export class GetAllCharMatchingDictionariesResult {
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.success != null) {
            output.writeFieldBegin("success", thrift.Thrift.Type.LIST, 0);
            output.writeListBegin(thrift.Thrift.Type.STRUCT, this.success.length);
            this.success.forEach((value_382: CharMatchingDictionary.CharMatchingDictionary): void => {
                value_382.write(output);
            });
            output.writeListEnd();
            output.writeFieldEnd();
        }
    ...
    public static read(input: thrift.TProtocol): GetAllCharMatchingDictionariesResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_383: Array<CharMatchingDictionary.CharMatchingDictionary> = new Array<CharMatchingDictionary.CharMatchingDictionary>();
                        ...
                        for (let i_29: number = 0; i_29 < size_29; i_29++) {
                            const value_384: CharMatchingDictionary.CharMatchingDictionary = CharMatchingDictionary.CharMatchingDictionary.read(input);
                            value_383.push(value_384);
                        }
                        input.readListEnd();
                        _args.success = value_383;
                    }
                    else {
                        input.skip(fieldType);
                    }
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_385: core.PreconditionException = core.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_386: core.ServerException = core.ServerException.read(input);
    ...
    public static read(input: thrift.TProtocol): DeleteCharMatchingDictionaryResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_388: core.PreconditionException = core.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_389: core.ServerException = core.ServerException.read(input);
    ...
    public static read(input: thrift.TProtocol): GetTranslationsResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_391: core.PreconditionException = core.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_392: core.ServerException = core.ServerException.read(input);
    ...
    public static read(input: thrift.TProtocol): SetTranslationsResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.BOOL) {
                        const value_393: boolean = input.readBool();
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_394: core.PreconditionException = core.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_395: core.ServerException = core.ServerException.read(input);
    ...
    public static read(input: thrift.TProtocol): GetDroolLogFileResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.STRING) {
                        const value_396: Buffer = input.readBinary();
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_397: core.PreconditionException = core.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_398: core.ServerException = core.ServerException.read(input);
    ...
    public static read(input: thrift.TProtocol): CryptValueResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_400: core.PreconditionException = core.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_401: core.ServerException = core.ServerException.read(input);
...
export class GetAllJobTasksResult {
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.success != null) {
            output.writeFieldBegin("success", thrift.Thrift.Type.LIST, 0);
            output.writeListBegin(thrift.Thrift.Type.STRUCT, this.success.length);
            this.success.forEach((value_402: JobTask.JobTask): void => {
                value_402.write(output);
            });
            output.writeListEnd();
            output.writeFieldEnd();
        }
    ...
    public static read(input: thrift.TProtocol): GetAllJobTasksResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_403: Array<JobTask.JobTask> = new Array<JobTask.JobTask>();
                        ...
                        for (let i_30: number = 0; i_30 < size_30; i_30++) {
                            const value_404: JobTask.JobTask = JobTask.JobTask.read(input);
                            value_403.push(value_404);
                        }
                        input.readListEnd();
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_405: core.PreconditionException = core.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_406: core.ServerException = core.ServerException.read(input);
    ...
    public static read(input: thrift.TProtocol): GetCountAllJobTasksResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.I32) {
                        const value_407: number = input.readI32();
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_408: core.PreconditionException = core.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_409: core.ServerException = core.ServerException.read(input);
    ...
    public static read(input: thrift.TProtocol): DeleteJobTaskResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.BOOL) {
                        const value_410: boolean = input.readBool();
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_411: core.PreconditionException = core.PreconditionException.read(input);
                        _args.validError = value_411;
                    }
                    else {
                        input.skip(fieldType);
                    }
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_412: core.ServerException = core.ServerException.read(input);
                        _args.error = value_412;
                    }
                    else {
                        input.skip(fieldType);
                    }
    ...
    public static read(input: thrift.TProtocol): RebuildAttachmentResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.BOOL) {
                        const value_413: boolean = input.readBool();
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_414: core.PreconditionException = core.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_415: core.ServerException = core.ServerException.read(input);
...
export class GetAllUserContentItemsResult {
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.success != null) {
            output.writeFieldBegin("success", thrift.Thrift.Type.LIST, 0);
            output.writeListBegin(thrift.Thrift.Type.STRUCT, this.success.length);
            this.success.forEach((value_416: core.ContentItem): void => {
    ...
    public static read(input: thrift.TProtocol): GetAllUserContentItemsResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_417: Array<core.ContentItem> = new Array<core.ContentItem>();
                        ...
                        for (let i_31: number = 0; i_31 < size_31; i_31++) {
                            const value_418: core.ContentItem = core.ContentItem.read(input);
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_419: core.PreconditionException = core.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_420: core.ServerException = core.ServerException.read(input);
...
export class ChangeUserContentItemsResult {
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.success != null) {
            output.writeFieldBegin("success", thrift.Thrift.Type.LIST, 0);
            output.writeListBegin(thrift.Thrift.Type.STRUCT, this.success.length);
            this.success.forEach((value_421: core.ContentItem): void => {
    ...
    public static read(input: thrift.TProtocol): ChangeUserContentItemsResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_422: Array<core.ContentItem> = new Array<core.ContentItem>();
                        ...
                        for (let i_32: number = 0; i_32 < size_32; i_32++) {
                            const value_423: core.ContentItem = core.ContentItem.read(input);
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_424: core.PreconditionException = core.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_425: core.ServerException = core.ServerException.read(input);
...
export class GetAllUserContentHoldersResult {
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.success != null) {
            output.writeFieldBegin("success", thrift.Thrift.Type.LIST, 0);
            output.writeListBegin(thrift.Thrift.Type.STRUCT, this.success.length);
            this.success.forEach((value_426: core.ContentHolder): void => {
    ...
    public static read(input: thrift.TProtocol): GetAllUserContentHoldersResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_427: Array<core.ContentHolder> = new Array<core.ContentHolder>();
                        ...
                        for (let i_33: number = 0; i_33 < size_33; i_33++) {
                            const value_428: core.ContentHolder = core.ContentHolder.read(input);
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_429: core.PreconditionException = core.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_430: core.ServerException = core.ServerException.read(input);
...
export class ChangeUserContentHoldersResult {
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.success != null) {
            output.writeFieldBegin("success", thrift.Thrift.Type.LIST, 0);
            output.writeListBegin(thrift.Thrift.Type.STRUCT, this.success.length);
            this.success.forEach((value_431: core.ContentHolder): void => {
                value_431.write(output);
            });
            output.writeListEnd();
            output.writeFieldEnd();
        }
    ...
    public static read(input: thrift.TProtocol): ChangeUserContentHoldersResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_432: Array<core.ContentHolder> = new Array<core.ContentHolder>();
                        ...
                        for (let i_34: number = 0; i_34 < size_34; i_34++) {
                            const value_433: core.ContentHolder = core.ContentHolder.read(input);
                            value_432.push(value_433);
                        }
                        input.readListEnd();
    ...
    public static read(input: thrift.TProtocol): GetLicenseForUserResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_439: License.License = License.License.read(input);
...
export class GetAllowedRolesForLicenseResult {
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.success != null) {
            ...
            this.success.forEach((value_442: string): void => {
                output.writeString(value_442);
            });
            output.writeSetEnd();
            output.writeFieldEnd();
        }
    ...
    public static read(input: thrift.TProtocol): GetAllowedRolesForLicenseResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.SET) {
                        const value_443: Set<string> = new Set<string>();
                        ...
                        for (let i_35: number = 0; i_35 < size_35; i_35++) {
                            const value_444: string = input.readString();
                            value_443.add(value_444);
                        }
                        input.readSetEnd();
    ...
    public static read(input: thrift.TProtocol): AssignLicenseToUserResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_447: License.License = License.License.read(input);
...
export class ExecuteCustomQueryResult {
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.success != null) {
            ...
            this.success.forEach((value_450: string, key_1: string): void => {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.MAP) {
                        const value_451: Map<string, string> = new Map<string, string>();
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_453: core.PreconditionException = core.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_454: core.ServerException = core.ServerException.read(input);
...
export class CreateOrUpdateUsersResult {
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.success != null) {
            ...
            this.success.forEach((value_455: string): void => {
                output.writeString(value_455);
            });
            output.writeListEnd();
            output.writeFieldEnd();
        }
    ...
    public static read(input: thrift.TProtocol): CreateOrUpdateUsersResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_456: Array<string> = new Array<string>();
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_458: core.PreconditionException = core.PreconditionException.read(input);
                        _args.validError = value_458;
                    }
                    else {
                        input.skip(fieldType);
                    }
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_459: core.ServerException = core.ServerException.read(input);
                        _args.error = value_459;
                    }
                    else {
                        input.skip(fieldType);
                    }
...
export class Client {
    ...
    public getAvailableFileStorageList(token: string, filter: core.KazFilter): Promise<Array<core.AvailableFileStorage>> {
        const requestId: number = this.incrementSeqId();
        return new Promise<Array<core.AvailableFileStorage>>((resolve, reject): void => {
    ...
    public createOrUpdateFileStorage(token: string, fileStorage: core.FileStorage, password: string, accountsToAdd: Array<core.Account>, accountsToRemove: Array<core.Account>): Promise<core.FileStorage> {
        const requestId: number = this.incrementSeqId();
        return new Promise<core.FileStorage>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
                if (error != null) {
                    reject(error);
    ...
    public getAllFileStorages(token: string, filter: core.KazFilter): Promise<Array<core.FileStorage>> {
        const requestId: number = this.incrementSeqId();
        return new Promise<Array<core.FileStorage>>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
                if (error != null) {
                    reject(error);
    ...
    public getCountAllFileStorages(token: string, filter: core.KazFilter): Promise<number> {
        const requestId: number = this.incrementSeqId();
    ...
    public createOrUpdateNews(token: string, news: core.News, accountIDsToAdd: Set<string>, accountIDsToRemove: Set<string>): Promise<core.News> {
        const requestId: number = this.incrementSeqId();
        return new Promise<core.News>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
                if (error != null) {
                    reject(error);
    ...
    public getAllExternalModules(token: string, filter: core.KazFilter): Promise<Array<ExternalModule.ExternalModule>> {
        const requestId: number = this.incrementSeqId();
    ...
    public getCountAllExternalModules(token: string, filter: core.KazFilter): Promise<number> {
        const requestId: number = this.incrementSeqId();
        return new Promise<number>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
    ...
    public getAllDocumentAttachments(token: string, filter: core.KazFilter): Promise<Array<core.Attachment>> {
        const requestId: number = this.incrementSeqId();
        return new Promise<Array<core.Attachment>>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
                if (error != null) {
                    reject(error);
    ...
    public getAllFilledDocumentPatternStages(token: string, fillDocPatternId: string, filter: core.KazFilter): Promise<Array<core.DocumentPatternStage>> {
        const requestId: number = this.incrementSeqId();
    ...
    public changeExecutorForPatternStages(token: string, patternIds: Array<string>, userOrGroup: core.UserOrGroup, usersOrGroups: Array<core.UserOrGroup>): Promise<boolean> {
        const requestId: number = this.incrementSeqId();
        return new Promise<boolean>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
    ...
    public getAllUsersRelativeToAccount(token: string, filter: core.KazFilter): Promise<Array<UserAcc.UserAcc>> {
        const requestId: number = this.incrementSeqId();
    ...
    public getCountAllUsersRelativeToAccount(token: string, filter: core.KazFilter): Promise<number> {
        const requestId: number = this.incrementSeqId();
        return new Promise<number>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
    ...
    public getAllUsersExt(token: string, filter: core.KazFilter): Promise<Array<UserExt.UserExt>> {
        const requestId: number = this.incrementSeqId();
    ...
    public getCountAllUsersExt(token: string, filter: core.KazFilter): Promise<number> {
        const requestId: number = this.incrementSeqId();
        return new Promise<number>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
    ...
    public getAllUserNotifications(token: string, userId: string, unreadOnly: boolean, filter: core.KazFilter): Promise<Array<core.NotificationQueue>> {
        const requestId: number = this.incrementSeqId();
        return new Promise<Array<core.NotificationQueue>>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
                if (error != null) {
                    reject(error);
    ...
    public getAllNotifications(token: string, filter: core.KazFilter): Promise<Array<core.NotificationQueue>> {
        const requestId: number = this.incrementSeqId();
        return new Promise<Array<core.NotificationQueue>>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
    ...
    public resendDocumentToExternalModule(token: string, documentId: string, accessPolicy: core.DocumentAccessPolicy): Promise<boolean> {
        const requestId: number = this.incrementSeqId();
        return new Promise<boolean>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
    ...
    public getAllSessions(token: string, filter: core.KazFilter): Promise<Array<core.AuthSession>> {
        const requestId: number = this.incrementSeqId();
        return new Promise<Array<core.AuthSession>>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
                if (error != null) {
                    reject(error);
    ...
    public getCountAllSessions(token: string, filter: core.KazFilter): Promise<number> {
        const requestId: number = this.incrementSeqId();
        return new Promise<number>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
    ...
    public getAllLicenses(token: string, filter: core.KazFilter): Promise<Array<License.License>> {
        const requestId: number = this.incrementSeqId();
    ...
    public getCountAllLicenses(token: string, filter: core.KazFilter): Promise<number> {
        const requestId: number = this.incrementSeqId();
        return new Promise<number>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
    ...
    public uploadLicenses(token: string, fileContentBytes: Buffer, accountGroup: core.AccountGroup, account: core.Account, autoAssignment: boolean, autoAssignmentOrder: number): Promise<Array<License.License>> {
        const requestId: number = this.incrementSeqId();
        return new Promise<Array<License.License>>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
    ...
    public getLicenseModulePage(token: string, filter: core.KazFilter): Promise<LicenseModulePage.LicenseModulePage> {
        const requestId: number = this.incrementSeqId();
    ...
    public getAllCharMatchingDictionaries(token: string, filter: core.KazFilter): Promise<Array<CharMatchingDictionary.CharMatchingDictionary>> {
        const requestId: number = this.incrementSeqId();
    ...
    public getDroolLogFile(token: string, docId: string, policy: core.DocumentAccessPolicy): Promise<Buffer> {
        const requestId: number = this.incrementSeqId();
        return new Promise<Buffer>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
    ...
    public getAllJobTasks(token: string, filter: core.KazFilter): Promise<Array<JobTask.JobTask>> {
        const requestId: number = this.incrementSeqId();
    ...
    public getCountAllJobTasks(token: string, filter: core.KazFilter): Promise<number> {
        const requestId: number = this.incrementSeqId();
        return new Promise<number>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
    ...
    public getAllUserContentItems(token: string, filter: core.KazFilter): Promise<Array<core.ContentItem>> {
        const requestId: number = this.incrementSeqId();
    ...
    public changeUserContentItems(token: string, contentItems: Array<core.ContentItem>): Promise<Array<core.ContentItem>> {
        const requestId: number = this.incrementSeqId();
        return new Promise<Array<core.ContentItem>>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
    ...
    public getAllUserContentHolders(token: string, filter: core.KazFilter): Promise<Array<core.ContentHolder>> {
        const requestId: number = this.incrementSeqId();
    ...
    public changeUserContentHolders(token: string, toUpdate: Array<core.ContentHolder>, toRemoveIds: Array<string>): Promise<Array<core.ContentHolder>> {
        const requestId: number = this.incrementSeqId();
        return new Promise<Array<core.ContentHolder>>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
    ...
    public createOrUpdateUsers(token: string, users: Array<core.UserOrGroup>, options: UserOptions.UserOptions): Promise<Array<string>> {
        const requestId: number = this.incrementSeqId();
    ...
    public send_getAvailableFileStorageList(token: string, filter: core.KazFilter, requestId: number): void {
    ...
    public send_createOrUpdateFileStorage(token: string, fileStorage: core.FileStorage, password: string, accountsToAdd: Array<core.Account>, accountsToRemove: Array<core.Account>, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_getAllFileStorages(token: string, filter: core.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_getCountAllFileStorages(token: string, filter: core.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_createOrUpdateNews(token: string, news: core.News, accountIDsToAdd: Set<string>, accountIDsToRemove: Set<string>, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_getAllExternalModules(token: string, filter: core.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_getCountAllExternalModules(token: string, filter: core.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_getAllDocumentAttachments(token: string, filter: core.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_getAllFilledDocumentPatternStages(token: string, fillDocPatternId: string, filter: core.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_changeExecutorForPatternStages(token: string, patternIds: Array<string>, userOrGroup: core.UserOrGroup, usersOrGroups: Array<core.UserOrGroup>, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_getAllUsersRelativeToAccount(token: string, filter: core.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_getCountAllUsersRelativeToAccount(token: string, filter: core.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_getAllUsersExt(token: string, filter: core.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_getCountAllUsersExt(token: string, filter: core.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_getAllUserNotifications(token: string, userId: string, unreadOnly: boolean, filter: core.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_getAllNotifications(token: string, filter: core.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_resendDocumentToExternalModule(token: string, documentId: string, accessPolicy: core.DocumentAccessPolicy, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_getAllSessions(token: string, filter: core.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_getCountAllSessions(token: string, filter: core.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_getAllLicenses(token: string, filter: core.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_getCountAllLicenses(token: string, filter: core.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_uploadLicenses(token: string, fileContentBytes: Buffer, accountGroup: core.AccountGroup, account: core.Account, autoAssignment: boolean, autoAssignmentOrder: number, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_getLicenseModulePage(token: string, filter: core.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_getAllCharMatchingDictionaries(token: string, filter: core.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_getDroolLogFile(token: string, docId: string, policy: core.DocumentAccessPolicy, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_getAllJobTasks(token: string, filter: core.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_getCountAllJobTasks(token: string, filter: core.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_getAllUserContentItems(token: string, filter: core.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_changeUserContentItems(token: string, contentItems: Array<core.ContentItem>, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_getAllUserContentHolders(token: string, filter: core.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_changeUserContentHolders(token: string, toUpdate: Array<core.ContentHolder>, toRemoveIds: Array<string>, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_createOrUpdateUsers(token: string, users: Array<core.UserOrGroup>, options: UserOptions.UserOptions, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
...
export interface IHandler {
    getAvailableFileStorageList(token: string, filter: core.KazFilter): Array<core.AvailableFileStorage> | Promise<Array<core.AvailableFileStorage>>;
    createOrUpdateFileStorage(token: string, fileStorage: core.FileStorage, password: string, accountsToAdd: Array<core.Account>, accountsToRemove: Array<core.Account>): core.FileStorage | Promise<core.FileStorage>;
    getAllFileStorages(token: string, filter: core.KazFilter): Array<core.FileStorage> | Promise<Array<core.FileStorage>>;
    getCountAllFileStorages(token: string, filter: core.KazFilter): number | Promise<number>;
    ...
    createOrUpdateNews(token: string, news: core.News, accountIDsToAdd: Set<string>, accountIDsToRemove: Set<string>): core.News | Promise<core.News>;
    removeNews(token: string, newsId: string): boolean | Promise<boolean>;
    getAllExternalModules(token: string, filter: core.KazFilter): Array<ExternalModule.ExternalModule> | Promise<Array<ExternalModule.ExternalModule>>;
    getCountAllExternalModules(token: string, filter: core.KazFilter): number | Promise<number>;
    ...
    getAllDocumentAttachments(token: string, filter: core.KazFilter): Array<core.Attachment> | Promise<Array<core.Attachment>>;
    getAllFilledDocumentPatternStages(token: string, fillDocPatternId: string, filter: core.KazFilter): Array<core.DocumentPatternStage> | Promise<Array<core.DocumentPatternStage>>;
    resetDocumentForceMoveError(token: string, documentId: string): number | Promise<number>;
    changeExecutorForPatternStages(token: string, patternIds: Array<string>, userOrGroup: core.UserOrGroup, usersOrGroups: Array<core.UserOrGroup>): boolean | Promise<boolean>;
    ...
    getAllUsersRelativeToAccount(token: string, filter: core.KazFilter): Array<UserAcc.UserAcc> | Promise<Array<UserAcc.UserAcc>>;
    getCountAllUsersRelativeToAccount(token: string, filter: core.KazFilter): number | Promise<number>;
    ...
    getAllUsersExt(token: string, filter: core.KazFilter): Array<UserExt.UserExt> | Promise<Array<UserExt.UserExt>>;
    getCountAllUsersExt(token: string, filter: core.KazFilter): number | Promise<number>;
    getAllUserNotifications(token: string, userId: string, unreadOnly: boolean, filter: core.KazFilter): Array<core.NotificationQueue> | Promise<Array<core.NotificationQueue>>;
    getAllNotifications(token: string, filter: core.KazFilter): Array<core.NotificationQueue> | Promise<Array<core.NotificationQueue>>;
    ...
    resendDocumentToExternalModule(token: string, documentId: string, accessPolicy: core.DocumentAccessPolicy): boolean | Promise<boolean>;
    getAllSessions(token: string, filter: core.KazFilter): Array<core.AuthSession> | Promise<Array<core.AuthSession>>;
    getCountAllSessions(token: string, filter: core.KazFilter): number | Promise<number>;
    ...
    getAllLicenses(token: string, filter: core.KazFilter): Array<License.License> | Promise<Array<License.License>>;
    getCountAllLicenses(token: string, filter: core.KazFilter): number | Promise<number>;
    uploadLicenses(token: string, fileContentBytes: Buffer, accountGroup: core.AccountGroup, account: core.Account, autoAssignment: boolean, autoAssignmentOrder: number): Array<License.License> | Promise<Array<License.License>>;
    ...
    getLicenseModulePage(token: string, filter: core.KazFilter): LicenseModulePage.LicenseModulePage | Promise<LicenseModulePage.LicenseModulePage>;
    ...
    getAllCharMatchingDictionaries(token: string, filter: core.KazFilter): Array<CharMatchingDictionary.CharMatchingDictionary> | Promise<Array<CharMatchingDictionary.CharMatchingDictionary>>;
    ...
    getDroolLogFile(token: string, docId: string, policy: core.DocumentAccessPolicy): Buffer | Promise<Buffer>;
    cryptValue(token: string, value: string): string | Promise<string>;
    getAllJobTasks(token: string, filter: core.KazFilter): Array<JobTask.JobTask> | Promise<Array<JobTask.JobTask>>;
    getCountAllJobTasks(token: string, filter: core.KazFilter): number | Promise<number>;
    ...
    getAllUserContentItems(token: string, filter: core.KazFilter): Array<core.ContentItem> | Promise<Array<core.ContentItem>>;
    changeUserContentItems(token: string, contentItems: Array<core.ContentItem>): Array<core.ContentItem> | Promise<Array<core.ContentItem>>;
    getAllUserContentHolders(token: string, filter: core.KazFilter): Array<core.ContentHolder> | Promise<Array<core.ContentHolder>>;
    changeUserContentHolders(token: string, toUpdate: Array<core.ContentHolder>, toRemoveIds: Array<string>): Array<core.ContentHolder> | Promise<Array<core.ContentHolder>>;
    ...
    createOrUpdateUsers(token: string, users: Array<core.UserOrGroup>, options: UserOptions.UserOptions): Array<string> | Promise<Array<string>>;
}
export class Processor {
    ...
    public process_getAvailableFileStorageList(requestId: number, input: thrift.TProtocol, output: thrift.TProtocol): void {
        new Promise<Array<core.AvailableFileStorage>>((resolve, reject): void => {
            try {
        ...
        }).then((data: Array<core.AvailableFileStorage>): void => {
    ...
    public process_createOrUpdateFileStorage(requestId: number, input: thrift.TProtocol, output: thrift.TProtocol): void {
        new Promise<core.FileStorage>((resolve, reject): void => {
            try {
        ...
        }).then((data: core.FileStorage): void => {
    ...
    public process_getAllFileStorages(requestId: number, input: thrift.TProtocol, output: thrift.TProtocol): void {
        new Promise<Array<core.FileStorage>>((resolve, reject): void => {
            try {
        ...
        }).then((data: Array<core.FileStorage>): void => {
    ...
    public process_createOrUpdateNews(requestId: number, input: thrift.TProtocol, output: thrift.TProtocol): void {
        new Promise<core.News>((resolve, reject): void => {
            try {
    ...
    public process_getAllDocumentAttachments(requestId: number, input: thrift.TProtocol, output: thrift.TProtocol): void {
        new Promise<Array<core.Attachment>>((resolve, reject): void => {
            try {
        ...
        }).then((data: Array<core.Attachment>): void => {
    ...
    public process_getAllUserNotifications(requestId: number, input: thrift.TProtocol, output: thrift.TProtocol): void {
        new Promise<Array<core.NotificationQueue>>((resolve, reject): void => {
            try {
        ...
        }).then((data: Array<core.NotificationQueue>): void => {
    ...
    public process_getAllSessions(requestId: number, input: thrift.TProtocol, output: thrift.TProtocol): void {
        new Promise<Array<core.AuthSession>>((resolve, reject): void => {
            try {
        ...
        }).then((data: Array<core.AuthSession>): void => {
