...
export interface ICreateOrUpdateSecurityClassificationArgsArgs {
    token: string;
    securityClassification: core.SecurityClassification;
}
export class CreateOrUpdateSecurityClassificationArgs {
    public token: string;
    public securityClassification: core.SecurityClassification;
    ...
    public static read(input: thrift.TProtocol): CreateOrUpdateSecurityClassificationArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_6: core.SecurityClassification = core.SecurityClassification.read(input);
...
export class AddSecurityClassificationsToUserGroupsArgs {
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.userOrGroups != null) {
            ...
            this.userOrGroups.forEach((value_10: core.UserOrGroup): void => {
...
export class RemoveSecurityClassificationsFromUserGroupsArgs {
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.userOrGroups != null) {
            output.writeFieldBegin("userOrGroups", thrift.Thrift.Type.LIST, 3);
            output.writeListBegin(thrift.Thrift.Type.STRUCT, this.userOrGroups.length);
            this.userOrGroups.forEach((value_17: core.UserOrGroup): void => {
    ...
    public static read(input: thrift.TProtocol): RemoveSecurityClassificationsFromUserGroupsArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 3:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_21: Array<core.UserOrGroup> = new Array<core.UserOrGroup>();
                        const metadata_4: thrift.TList = input.readListBegin();
                        const size_4: number = metadata_4.size;
                        for (let i_4: number = 0; i_4 < size_4; i_4++) {
                            const value_22: core.UserOrGroup = core.UserOrGroup.read(input);
            ...
            switch (fieldId) {
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.I32) {
                        const value_24: core.UserOrGroupType = input.readI32();
                        _args.type = value_24;
                    }
                    else {
                        input.skip(fieldType);
                ...
                case 4:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_26: core.KazFilter = core.KazFilter.read(input);
    ...
    public static read(input: thrift.TProtocol): GetAllSecurityClassificationByPatternIdArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 3:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_29: core.KazFilter = core.KazFilter.read(input);
    ...
    public static read(input: thrift.TProtocol): AddSecurityClassificationsToDocumentArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 4:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_48: core.DocumentAccessPolicy = core.DocumentAccessPolicy.read(input);
    ...
    public static read(input: thrift.TProtocol): ChangeSecurityClassificationsForDocumentArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 5:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_57: core.DocumentAccessPolicy = core.DocumentAccessPolicy.read(input);
    ...
    public static read(input: thrift.TProtocol): RemoveSecurityClassificationsFromDocumentArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 4:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_63: core.DocumentAccessPolicy = core.DocumentAccessPolicy.read(input);
...
export class GetAllSecurityClassificationResult {
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.success != null) {
            ...
            this.success.forEach((value_77: core.SecurityClassification): void => {
    ...
    public static read(input: thrift.TProtocol): GetAllSecurityClassificationResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_78: Array<core.SecurityClassification> = new Array<core.SecurityClassification>();
                        ...
                        for (let i_13: number = 0; i_13 < size_13; i_13++) {
                            const value_79: core.SecurityClassification = core.SecurityClassification.read(input);
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_80: core.PreconditionException = core.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_81: core.ServerException = core.ServerException.read(input);
    ...
    public static read(input: thrift.TProtocol): GetCountAllSecurityClassificationResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_83: core.PreconditionException = core.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_84: core.ServerException = core.ServerException.read(input);
...
export interface ICreateOrUpdateSecurityClassificationResultArgs {
    success?: core.SecurityClassification;
    validError?: core.PreconditionException;
    error?: core.ServerException;
}
export class CreateOrUpdateSecurityClassificationResult {
    public success?: core.SecurityClassification;
    public validError?: core.PreconditionException;
    public error?: core.ServerException;
    ...
    public static read(input: thrift.TProtocol): CreateOrUpdateSecurityClassificationResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_85: core.SecurityClassification = core.SecurityClassification.read(input);
...
export class GetAllSecurityClassificationsByUserOrGroupResult {
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.success != null) {
            output.writeFieldBegin("success", thrift.Thrift.Type.LIST, 0);
            output.writeListBegin(thrift.Thrift.Type.STRUCT, this.success.length);
            this.success.forEach((value_97: core.SecurityClassification): void => {
    ...
    public static read(input: thrift.TProtocol): GetAllSecurityClassificationsByUserOrGroupResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_98: Array<core.SecurityClassification> = new Array<core.SecurityClassification>();
                        ...
                        for (let i_14: number = 0; i_14 < size_14; i_14++) {
                            const value_99: core.SecurityClassification = core.SecurityClassification.read(input);
...
export class GetAllSecurityClassificationByPatternIdResult {
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.success != null) {
            output.writeFieldBegin("success", thrift.Thrift.Type.LIST, 0);
            output.writeListBegin(thrift.Thrift.Type.STRUCT, this.success.length);
            this.success.forEach((value_102: core.SecurityClassification): void => {
    ...
    public static read(input: thrift.TProtocol): GetAllSecurityClassificationByPatternIdResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_103: Array<core.SecurityClassification> = new Array<core.SecurityClassification>();
                        ...
                        for (let i_15: number = 0; i_15 < size_15; i_15++) {
                            const value_104: core.SecurityClassification = core.SecurityClassification.read(input);
...
export class GetAllSecurityClassificationByDocumentIdResult {
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.success != null) {
            output.writeFieldBegin("success", thrift.Thrift.Type.LIST, 0);
            output.writeListBegin(thrift.Thrift.Type.STRUCT, this.success.length);
            this.success.forEach((value_107: core.SecurityClassification): void => {
    ...
    public static read(input: thrift.TProtocol): GetAllSecurityClassificationByDocumentIdResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_108: Array<core.SecurityClassification> = new Array<core.SecurityClassification>();
                        ...
                        for (let i_16: number = 0; i_16 < size_16; i_16++) {
                            const value_109: core.SecurityClassification = core.SecurityClassification.read(input);
    ...
    public static read(input: thrift.TProtocol): ChangeSecurityClassificationsForDocumentResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_122: core.PreconditionException = core.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_123: core.ServerException = core.ServerException.read(input);
    ...
    public static read(input: thrift.TProtocol): RemoveSecurityClassificationsFromDocumentResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_125: core.PreconditionException = core.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_126: core.ServerException = core.ServerException.read(input);
...
export class GetAllSecurityClassificationDependenciesResult {
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.success != null) {
            output.writeFieldBegin("success", thrift.Thrift.Type.LIST, 0);
            output.writeListBegin(thrift.Thrift.Type.STRUCT, this.success.length);
            this.success.forEach((value_127: core.SecurityClassification): void => {
    ...
    public static read(input: thrift.TProtocol): GetAllSecurityClassificationDependenciesResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_128: Array<core.SecurityClassification> = new Array<core.SecurityClassification>();
                        ...
                        for (let i_17: number = 0; i_17 < size_17; i_17++) {
                            const value_129: core.SecurityClassification = core.SecurityClassification.read(input);
...
export class Client {
    ...
    public getAllSecurityClassification(token: string, filter: core.KazFilter): Promise<Array<core.SecurityClassification>> {
        const requestId: number = this.incrementSeqId();
        return new Promise<Array<core.SecurityClassification>>((resolve, reject): void => {
    ...
    public getCountAllSecurityClassification(token: string, filter: core.KazFilter): Promise<number> {
        const requestId: number = this.incrementSeqId();
    ...
    public createOrUpdateSecurityClassification(token: string, securityClassification: core.SecurityClassification): Promise<core.SecurityClassification> {
        const requestId: number = this.incrementSeqId();
        return new Promise<core.SecurityClassification>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
                if (error != null) {
                    reject(error);
    ...
    public addSecurityClassificationsToUserGroups(token: string, securityClassificationIds: Array<string>, userOrGroups: Array<core.UserOrGroup>): Promise<boolean> {
        const requestId: number = this.incrementSeqId();
        return new Promise<boolean>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
    ...
    public removeSecurityClassificationsFromUserGroups(token: string, securityClassificationIds: Array<string>, userOrGroups: Array<core.UserOrGroup>): Promise<boolean> {
        const requestId: number = this.incrementSeqId();
        return new Promise<boolean>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
    ...
    public getAllSecurityClassificationsByUserOrGroup(token: string, type: core.UserOrGroupType, userOrGroupId: string, filter: core.KazFilter): Promise<Array<core.SecurityClassification>> {
        const requestId: number = this.incrementSeqId();
        return new Promise<Array<core.SecurityClassification>>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
    ...
    public getAllSecurityClassificationByPatternId(token: string, patternId: string, filter: core.KazFilter): Promise<Array<core.SecurityClassification>> {
        const requestId: number = this.incrementSeqId();
        return new Promise<Array<core.SecurityClassification>>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
    ...
    public getAllSecurityClassificationByDocumentId(token: string, documentId: string, filter: core.KazFilter): Promise<Array<core.SecurityClassification>> {
        const requestId: number = this.incrementSeqId();
        return new Promise<Array<core.SecurityClassification>>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
    ...
    public addSecurityClassificationsToDocument(token: string, securityClassificationsId: Array<string>, documentId: string, accessPolicy: core.DocumentAccessPolicy): Promise<boolean> {
        const requestId: number = this.incrementSeqId();
        return new Promise<boolean>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
    ...
    public changeSecurityClassificationsForDocument(token: string, addedSecurityClassificationsId: Array<string>, removedSecurityClassificationsId: Array<string>, documentId: string, accessPolicy: core.DocumentAccessPolicy): Promise<boolean> {
        const requestId: number = this.incrementSeqId();
        return new Promise<boolean>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
    ...
    public removeSecurityClassificationsFromDocument(token: string, securityClassificationsId: Array<string>, documentId: string, accessPolicy: core.DocumentAccessPolicy): Promise<boolean> {
        const requestId: number = this.incrementSeqId();
        return new Promise<boolean>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
    ...
    public getAllSecurityClassificationDependencies(token: string, securityClassificationId: string, filter: core.KazFilter): Promise<Array<core.SecurityClassification>> {
        const requestId: number = this.incrementSeqId();
        return new Promise<Array<core.SecurityClassification>>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
    ...
    public send_getAllSecurityClassification(token: string, filter: core.KazFilter, requestId: number): void {
    ...
    public send_getCountAllSecurityClassification(token: string, filter: core.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_createOrUpdateSecurityClassification(token: string, securityClassification: core.SecurityClassification, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_addSecurityClassificationsToUserGroups(token: string, securityClassificationIds: Array<string>, userOrGroups: Array<core.UserOrGroup>, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_removeSecurityClassificationsFromUserGroups(token: string, securityClassificationIds: Array<string>, userOrGroups: Array<core.UserOrGroup>, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_getAllSecurityClassificationsByUserOrGroup(token: string, type: core.UserOrGroupType, userOrGroupId: string, filter: core.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_getAllSecurityClassificationByPatternId(token: string, patternId: string, filter: core.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_getAllSecurityClassificationByDocumentId(token: string, documentId: string, filter: core.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_addSecurityClassificationsToDocument(token: string, securityClassificationsId: Array<string>, documentId: string, accessPolicy: core.DocumentAccessPolicy, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_changeSecurityClassificationsForDocument(token: string, addedSecurityClassificationsId: Array<string>, removedSecurityClassificationsId: Array<string>, documentId: string, accessPolicy: core.DocumentAccessPolicy, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_removeSecurityClassificationsFromDocument(token: string, securityClassificationsId: Array<string>, documentId: string, accessPolicy: core.DocumentAccessPolicy, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_getAllSecurityClassificationDependencies(token: string, securityClassificationId: string, filter: core.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
...
export interface IHandler {
    getAllSecurityClassification(token: string, filter: core.KazFilter): Array<core.SecurityClassification> | Promise<Array<core.SecurityClassification>>;
    getCountAllSecurityClassification(token: string, filter: core.KazFilter): number | Promise<number>;
    createOrUpdateSecurityClassification(token: string, securityClassification: core.SecurityClassification): core.SecurityClassification | Promise<core.SecurityClassification>;
    removeSecurityClassification(token: string, securityClassificationId: string): boolean | Promise<boolean>;
    addSecurityClassificationsToUserGroups(token: string, securityClassificationIds: Array<string>, userOrGroups: Array<core.UserOrGroup>): boolean | Promise<boolean>;
    removeSecurityClassificationsFromUserGroups(token: string, securityClassificationIds: Array<string>, userOrGroups: Array<core.UserOrGroup>): boolean | Promise<boolean>;
    getAllSecurityClassificationsByUserOrGroup(token: string, type: core.UserOrGroupType, userOrGroupId: string, filter: core.KazFilter): Array<core.SecurityClassification> | Promise<Array<core.SecurityClassification>>;
    getAllSecurityClassificationByPatternId(token: string, patternId: string, filter: core.KazFilter): Array<core.SecurityClassification> | Promise<Array<core.SecurityClassification>>;
    getAllSecurityClassificationByDocumentId(token: string, documentId: string, filter: core.KazFilter): Array<core.SecurityClassification> | Promise<Array<core.SecurityClassification>>;
    ...
    addSecurityClassificationsToDocument(token: string, securityClassificationsId: Array<string>, documentId: string, accessPolicy: core.DocumentAccessPolicy): boolean | Promise<boolean>;
    changeSecurityClassificationsForDocument(token: string, addedSecurityClassificationsId: Array<string>, removedSecurityClassificationsId: Array<string>, documentId: string, accessPolicy: core.DocumentAccessPolicy): boolean | Promise<boolean>;
    removeSecurityClassificationsFromDocument(token: string, securityClassificationsId: Array<string>, documentId: string, accessPolicy: core.DocumentAccessPolicy): boolean | Promise<boolean>;
    getAllSecurityClassificationDependencies(token: string, securityClassificationId: string, filter: core.KazFilter): Array<core.SecurityClassification> | Promise<Array<core.SecurityClassification>>;
...
export class Processor {
    ...
    public process_getAllSecurityClassification(requestId: number, input: thrift.TProtocol, output: thrift.TProtocol): void {
        new Promise<Array<core.SecurityClassification>>((resolve, reject): void => {
            try {
        ...
        }).then((data: Array<core.SecurityClassification>): void => {
    ...
    public process_createOrUpdateSecurityClassification(requestId: number, input: thrift.TProtocol, output: thrift.TProtocol): void {
        new Promise<core.SecurityClassification>((resolve, reject): void => {
            try {
        ...
        }).then((data: core.SecurityClassification): void => {
