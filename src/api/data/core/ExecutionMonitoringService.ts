...
export interface IUpdateObservedUsersArgsArgs {
    token: string;
    userId: string;
    toAdd: Array<core.UserOrGroup>;
    toRemove: Array<core.UserOrGroup>;
}
export class UpdateObservedUsersArgs {
    public token: string;
    public userId: string;
    public toAdd: Array<core.UserOrGroup>;
    public toRemove: Array<core.UserOrGroup>;
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.toAdd != null) {
            ...
            this.toAdd.forEach((value_1: core.UserOrGroup): void => {
        ...
        if (this.toRemove != null) {
            ...
            this.toRemove.forEach((value_2: core.UserOrGroup): void => {
    ...
    public static read(input: thrift.TProtocol): UpdateObservedUsersArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 4:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_7: Array<core.UserOrGroup> = new Array<core.UserOrGroup>();
                        const metadata_2: thrift.TList = input.readListBegin();
                        const size_2: number = metadata_2.size;
                        for (let i_2: number = 0; i_2 < size_2; i_2++) {
                            const value_8: core.UserOrGroup = core.UserOrGroup.read(input);
    ...
    public static read(input: thrift.TProtocol): GetAllObservedDocumentsArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 3:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_17: core.KazFilter = core.KazFilter.read(input);
    ...
    public static read(input: thrift.TProtocol): GetCountObservedDocumentsArgs {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 3:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_20: core.KazFilter = core.KazFilter.read(input);
    ...
    public static read(input: thrift.TProtocol): UpdateObservedUsersResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_53: core.PreconditionException = core.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_54: core.ServerException = core.ServerException.read(input);
...
export class GetAllObservedUsersResult {
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.success != null) {
            ...
            this.success.forEach((value_55: core.UserOrGroup): void => {
    ...
    public static read(input: thrift.TProtocol): GetAllObservedUsersResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_56: Array<core.UserOrGroup> = new Array<core.UserOrGroup>();
                        const metadata_3: thrift.TList = input.readListBegin();
                        const size_3: number = metadata_3.size;
                        for (let i_3: number = 0; i_3 < size_3; i_3++) {
                            const value_57: core.UserOrGroup = core.UserOrGroup.read(input);
    ...
    public static read(input: thrift.TProtocol): GetAllObservedDocumentsResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_66: core.PreconditionException = core.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_67: core.ServerException = core.ServerException.read(input);
...
export interface IGetObservedDocumentAccessPolicyResultArgs {
    success?: core.DocumentAccessPolicy;
    validError?: core.PreconditionException;
    error?: core.ServerException;
}
export class GetObservedDocumentAccessPolicyResult {
    public success?: core.DocumentAccessPolicy;
    public validError?: core.PreconditionException;
    public error?: core.ServerException;
    ...
    public static read(input: thrift.TProtocol): GetObservedDocumentAccessPolicyResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                case 0:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_79: core.DocumentAccessPolicy = core.DocumentAccessPolicy.read(input);
...
export class Client {
    ...
    public updateObservedUsers(token: string, userId: string, toAdd: Array<core.UserOrGroup>, toRemove: Array<core.UserOrGroup>): Promise<boolean> {
    ...
    public getAllObservedUsers(token: string, userId: string, filter: core.KazFilter): Promise<Array<core.UserOrGroup>> {
        const requestId: number = this.incrementSeqId();
    ...
    public getCountObservedUsers(token: string, userId: string, filter: core.KazFilter): Promise<number> {
        const requestId: number = this.incrementSeqId();
    ...
    public getAllObservedDocuments(token: string, userId: string, filter: core.KazFilter): Promise<Array<ObserverDocument.ObserverDocument>> {
        const requestId: number = this.incrementSeqId();
    ...
    public getCountObservedDocuments(token: string, userId: string, filter: core.KazFilter): Promise<number> {
        const requestId: number = this.incrementSeqId();
        return new Promise<number>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
    ...
    public getAllObservedCards(token: string, userId: string, filter: core.KazFilter): Promise<Array<ObserverCard.ObserverCard>> {
        const requestId: number = this.incrementSeqId();
    ...
    public getCountObservedCards(token: string, userId: string, filter: core.KazFilter): Promise<number> {
        const requestId: number = this.incrementSeqId();
        return new Promise<number>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
    ...
    public getObservedDocumentAccessPolicy(token: string, userId: string, documentId: string): Promise<core.DocumentAccessPolicy> {
        const requestId: number = this.incrementSeqId();
        return new Promise<core.DocumentAccessPolicy>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
                if (error != null) {
                    reject(error);
    ...
    public exportDocumentsListToExcel(token: string, userId: string, filter: core.KazFilter): Promise<Buffer> {
        const requestId: number = this.incrementSeqId();
    ...
    public exportCardsListToExcel(token: string, userId: string, filter: core.KazFilter): Promise<Buffer> {
        const requestId: number = this.incrementSeqId();
        return new Promise<Buffer>((resolve, reject): void => {
            this._reqs[requestId] = (error, result) => {
                delete this._reqs[requestId];
    ...
    public send_updateObservedUsers(token: string, userId: string, toAdd: Array<core.UserOrGroup>, toRemove: Array<core.UserOrGroup>, requestId: number): void {
    ...
    public send_getAllObservedUsers(token: string, userId: string, filter: core.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_getCountObservedUsers(token: string, userId: string, filter: core.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_getAllObservedDocuments(token: string, userId: string, filter: core.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_getCountObservedDocuments(token: string, userId: string, filter: core.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_getAllObservedCards(token: string, userId: string, filter: core.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_getCountObservedCards(token: string, userId: string, filter: core.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_exportDocumentsListToExcel(token: string, userId: string, filter: core.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_exportCardsListToExcel(token: string, userId: string, filter: core.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
...
export interface IHandler {
    updateObservedUsers(token: string, userId: string, toAdd: Array<core.UserOrGroup>, toRemove: Array<core.UserOrGroup>): boolean | Promise<boolean>;
    getAllObservedUsers(token: string, userId: string, filter: core.KazFilter): Array<core.UserOrGroup> | Promise<Array<core.UserOrGroup>>;
    getCountObservedUsers(token: string, userId: string, filter: core.KazFilter): number | Promise<number>;
    getAllObservedDocuments(token: string, userId: string, filter: core.KazFilter): Array<ObserverDocument.ObserverDocument> | Promise<Array<ObserverDocument.ObserverDocument>>;
    getCountObservedDocuments(token: string, userId: string, filter: core.KazFilter): number | Promise<number>;
    getAllObservedCards(token: string, userId: string, filter: core.KazFilter): Array<ObserverCard.ObserverCard> | Promise<Array<ObserverCard.ObserverCard>>;
    getCountObservedCards(token: string, userId: string, filter: core.KazFilter): number | Promise<number>;
    getObservedDocumentAccessPolicy(token: string, userId: string, documentId: string): core.DocumentAccessPolicy | Promise<core.DocumentAccessPolicy>;
    ...
    exportDocumentsListToExcel(token: string, userId: string, filter: core.KazFilter): Buffer | Promise<Buffer>;
    exportCardsListToExcel(token: string, userId: string, filter: core.KazFilter): Buffer | Promise<Buffer>;
...
export class Processor {
    ...
    public process_getObservedDocumentAccessPolicy(requestId: number, input: thrift.TProtocol, output: thrift.TProtocol): void {
        new Promise<core.DocumentAccessPolicy>((resolve, reject): void => {
            try {
        ...
        }).then((data: core.DocumentAccessPolicy): void => {
