...
export interface IContentItemArgs {
    ...
    availableUsers?: Array<core.UserOrGroup>;
    tMask?: string;
    listView?: boolean;
    visible?: boolean;
...
export class ContentItem {
    ...
    public availableUsers?: Array<core.UserOrGroup>;
    public tMask?: string;
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.users != null) {
            ...
            this.users.forEach((value_1: core.UserOrGroup): void => {
        ...
        if (this.availableUsers != null) {
            ...
            this.availableUsers.forEach((value_3: core.UserOrGroup): void => {
            ...
            switch (fieldId) {
                ...
                case 15:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_23: Array<core.UserOrGroup> = new Array<core.UserOrGroup>();
                ...
                case 31:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_43: core.Department = core.Department.read(input);
                ...
                case 39:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_50: core.HandBook = core.HandBook.read(input);
