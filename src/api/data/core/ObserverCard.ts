...
export interface IObserverCardArgs {
    id?: string;
    cardType?: core.DocumentExecutionOwnerType;
    cardReassignType?: core.ExecutionReassignType;
    cardTaskComment?: string;
    cardUser?: core.UserOrGroup;
...
export class ObserverCard {
    public id?: string;
    public cardType?: core.DocumentExecutionOwnerType;
    public cardReassignType?: core.ExecutionReassignType;
    public cardTaskComment?: string;
    public cardUser?: core.UserOrGroup;
            ...
            switch (fieldId) {
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.I32) {
                        const value_4: core.DocumentExecutionOwnerType = input.readI32();
                ...
                case 3:
                    if (fieldType === thrift.Thrift.Type.I32) {
                        const value_5: core.ExecutionReassignType = input.readI32();
                ...
                case 5:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_7: core.UserOrGroup = core.UserOrGroup.read(input);
