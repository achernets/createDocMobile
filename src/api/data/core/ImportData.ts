...
export interface IImportDataArgs {
    id?: string;
    name?: string;
    stageList?: Array<core.DocumentPatternStage>;
    linkList?: Array<core.DocumentPatternStagesLink>;
    diffCounts?: Map<DiffType.DiffType, number>;
}
export class ImportData {
    public id?: string;
    public name?: string;
    public stageList?: Array<core.DocumentPatternStage>;
    public linkList?: Array<core.DocumentPatternStagesLink>;
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.stageList != null) {
            ...
            this.stageList.forEach((value_1: core.DocumentPatternStage): void => {
        ...
        if (this.linkList != null) {
            ...
            this.linkList.forEach((value_2: core.DocumentPatternStagesLink): void => {
            ...
            switch (fieldId) {
                ...
                case 3:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_6: Array<core.DocumentPatternStage> = new Array<core.DocumentPatternStage>();
                        const metadata_1: thrift.TList = input.readListBegin();
                        const size_1: number = metadata_1.size;
                        for (let i_1: number = 0; i_1 < size_1; i_1++) {
                            const value_7: core.DocumentPatternStage = core.DocumentPatternStage.read(input);
                ...
                case 4:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_8: Array<core.DocumentPatternStagesLink> = new Array<core.DocumentPatternStagesLink>();
                        const metadata_2: thrift.TList = input.readListBegin();
                        const size_2: number = metadata_2.size;
                        for (let i_2: number = 0; i_2 < size_2; i_2++) {
                            const value_9: core.DocumentPatternStagesLink = core.DocumentPatternStagesLink.read(input);
