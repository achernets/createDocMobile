...
export interface IAvailablePatternStageArgs {
    ...
    status?: core.DocPatternStageStatus;
    adParams?: Array<core.StageParam>;
...
export class AvailablePatternStage {
    ...
    public status?: core.DocPatternStageStatus;
    public adParams?: Array<core.StageParam>;
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.adParams != null) {
            ...
            this.adParams.forEach((value_1: core.StageParam): void => {
    ...
    public static read(input: thrift.TProtocol): AvailablePatternStage {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 6:
                    if (fieldType === thrift.Thrift.Type.I32) {
                        const value_7: core.DocPatternStageStatus = input.readI32();
                ...
                case 7:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_8: Array<core.StageParam> = new Array<core.StageParam>();
                        const metadata_1: thrift.TList = input.readListBegin();
                        const size_1: number = metadata_1.size;
                        for (let i_1: number = 0; i_1 < size_1; i_1++) {
                            const value_9: core.StageParam = core.StageParam.read(input);
                ...
                case 14:
                    if (fieldType === thrift.Thrift.Type.I32) {
                        const value_15: core.PatternType = input.readI32();
