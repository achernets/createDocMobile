...
export interface IKnowledgeDocumentArgs {
    ...
    contentHolders?: Array<__ROOT_NAMESPACE__.ContentHolder>;
    ...
    regNumber?: string;
    sysNumber?: string;
    docAuthor?: __ROOT_NAMESPACE__.UserOrGroup;
...
export class KnowledgeDocument {
    ...
    public contentHolders?: Array<__ROOT_NAMESPACE__.ContentHolder>;
    ...
    public docAuthor?: __ROOT_NAMESPACE__.UserOrGroup;
    ...
    public write(output: thrift.TProtocol): void {
        ...
        if (this.attachments != null) {
            ...
            this.attachments.forEach((value_2: __ROOT_NAMESPACE__.Attachment): void => {
        ...
        if (this.contentHolders != null) {
            ...
            this.contentHolders.forEach((value_3: __ROOT_NAMESPACE__.ContentHolder): void => {
            ...
            switch (fieldId) {
                ...
                case 8:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_13: Array<__ROOT_NAMESPACE__.Attachment> = new Array<__ROOT_NAMESPACE__.Attachment>();
                        const metadata_2: thrift.TList = input.readListBegin();
                        const size_2: number = metadata_2.size;
                        for (let i_2: number = 0; i_2 < size_2; i_2++) {
                            const value_14: __ROOT_NAMESPACE__.Attachment = __ROOT_NAMESPACE__.Attachment.read(input);
                ...
                case 9:
                    if (fieldType === thrift.Thrift.Type.LIST) {
                        const value_15: Array<__ROOT_NAMESPACE__.ContentHolder> = new Array<__ROOT_NAMESPACE__.ContentHolder>();
                        const metadata_3: thrift.TList = input.readListBegin();
                        const size_3: number = metadata_3.size;
                        for (let i_3: number = 0; i_3 < size_3; i_3++) {
                            const value_16: __ROOT_NAMESPACE__.ContentHolder = __ROOT_NAMESPACE__.ContentHolder.read(input);
                ...
                case 10:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_17: __ROOT_NAMESPACE__.DocumentAccessPolicy = __ROOT_NAMESPACE__.DocumentAccessPolicy.read(input);
                ...
                case 16:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_23: __ROOT_NAMESPACE__.UserOrGroup = __ROOT_NAMESPACE__.UserOrGroup.read(input);
