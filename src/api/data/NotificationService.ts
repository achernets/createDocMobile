            ...
            switch (fieldId) {
                ...
                case 3:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_3: __ROOT_NAMESPACE__.KazFilter = __ROOT_NAMESPACE__.KazFilter.read(input);
    ...
    public static read(input: thrift.TProtocol): GetAllNotificationsResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_19: __ROOT_NAMESPACE__.PreconditionException = __ROOT_NAMESPACE__.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_20: __ROOT_NAMESPACE__.ServerException = __ROOT_NAMESPACE__.ServerException.read(input);
    ...
    public static read(input: thrift.TProtocol): MarkNotificationAsReadResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_23: __ROOT_NAMESPACE__.ServerException = __ROOT_NAMESPACE__.ServerException.read(input);
    ...
    public static read(input: thrift.TProtocol): UpdateNotificationConfigResult {
        ...
        while (true) {
            ...
            switch (fieldId) {
                ...
                case 1:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_37: __ROOT_NAMESPACE__.PreconditionException = __ROOT_NAMESPACE__.PreconditionException.read(input);
                ...
                case 2:
                    if (fieldType === thrift.Thrift.Type.STRUCT) {
                        const value_38: __ROOT_NAMESPACE__.ServerException = __ROOT_NAMESPACE__.ServerException.read(input);
...
export class Client {
    ...
    public getAllNotifications(token: string, unreadOnly: boolean, filter: __ROOT_NAMESPACE__.KazFilter): Promise<Array<NotificationQueue.NotificationQueue>> {
    ...
    public getAllNotificationTransportTypes(token: string, filter: __ROOT_NAMESPACE__.KazFilter): Promise<Array<NotificationTransportType.NotificationTransportType>> {
        const requestId: number = this.incrementSeqId();
    ...
    public getNotificationConfig(token: string, userId: string, filter: __ROOT_NAMESPACE__.KazFilter): Promise<Array<NotificationConfig.NotificationConfig>> {
        const requestId: number = this.incrementSeqId();
    ...
    public send_getAllNotifications(token: string, unreadOnly: boolean, filter: __ROOT_NAMESPACE__.KazFilter, requestId: number): void {
    ...
    public send_getAllNotificationTransportTypes(token: string, filter: __ROOT_NAMESPACE__.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
    ...
    public send_getNotificationConfig(token: string, userId: string, filter: __ROOT_NAMESPACE__.KazFilter, requestId: number): void {
        const output: thrift.TProtocol = new this.protocol(this.output);
...
export interface IHandler {
    getAllNotifications(token: string, unreadOnly: boolean, filter: __ROOT_NAMESPACE__.KazFilter): Array<NotificationQueue.NotificationQueue> | Promise<Array<NotificationQueue.NotificationQueue>>;
    markNotificationAsRead(token: string, notificationId: string): boolean | Promise<boolean>;
    getAllNotificationTransportTypes(token: string, filter: __ROOT_NAMESPACE__.KazFilter): Array<NotificationTransportType.NotificationTransportType> | Promise<Array<NotificationTransportType.NotificationTransportType>>;
    getNotificationConfig(token: string, userId: string, filter: __ROOT_NAMESPACE__.KazFilter): Array<NotificationConfig.NotificationConfig> | Promise<Array<NotificationConfig.NotificationConfig>>;
